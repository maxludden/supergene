# Chapter 1210: - Trapped {.hidden-title}

<section id="chapter-1210" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1210-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1210</p>
</section>
...
<section class="element chapter-text" id="chapter-1210-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hat emerged from the white ball was a creature, one that was as small as a snowball. It was a furry little thing, and it wasn’t too different from a Pomeranian puppy, in terms of its appearance.</p>
...
Han Sen leapt forward to grab it with all his strength.
...
Suddenly, the ball began to spin again. Han Sen tried to use the tumbler theory to help stabilise the ball’s motion, but it seemed the snowball was aware of what Han Sen was trying to do. The blighter kept on pushing the ball.
