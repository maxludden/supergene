# Chapter 1212: - Killing Big Snake {.hidden-title}

<section id="chapter-1212" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1212-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1212</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Killing Big Snake</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1212-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen and Bao’er saw the snowball approach them, but before they could react, the snake was right there along with it.</p>
