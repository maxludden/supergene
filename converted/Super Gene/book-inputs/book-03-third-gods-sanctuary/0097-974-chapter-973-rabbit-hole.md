# Chapter 974: - Rabbit Hole {.hidden-title}

<section id="chapter-974" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-974-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">974</p>
</section>
...
<section class="element chapter-text" id="chapter-974-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he rabbit was no longer poisoned. After he moved away from it, the rabbit ran around in what appeared to be happiness. It was not afraid of Han Sen, and it didn’t behave like any creature of prey he had seen before.</p>
...
The rabbit wasn’t aggressive, and Han Sen realised he may have overestimated its willingness to steal. It wouldn’t attempt to take anything Han Sen was handling.
...
And that was when Han Sen realised the rabbit king had taken the plunge off a waterfall.
...
Strangely, there was fruit upon its branches, but no blossoming flowers. The fruits were about the size of an egg, and they were purple and red in colour.
</section>
