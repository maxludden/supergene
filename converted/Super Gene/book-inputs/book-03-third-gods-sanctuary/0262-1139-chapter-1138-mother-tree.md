# Chapter 1139: - Mother Tree {.hidden-title}

<section id="chapter-1139" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1139-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1139</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Mother Tree</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1139-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">U</span>ncle Liu, can you provide us passage to this tree?”** Han Sen asked, thinking to himself, **“If the treasure is going to mature, I need to see it!”**</p>
