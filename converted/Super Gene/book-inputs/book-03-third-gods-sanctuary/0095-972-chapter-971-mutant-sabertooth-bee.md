# Chapter 972: - Mutant Sabertooth Bee {.hidden-title}

<section id="chapter-972" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-972-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">972</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Mutant Sabertooth Bee</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-972-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">H</span>mm, so it is an ordinary creature.”** Han Sen frowned even more.</p>
...
Ordinary creatures were now useless to Han Sen, so he didn’t harm any others in the valley and simply kept on travelling.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Mutant Creature Sabertooth Bee killed. The beast soul has been acquired. Consume its flesh to gain zero to ten mutant geno points randomly.”</em></p></section>
...
The taste of the Sabertooth Bees was different than the taste of the Tank Ants. The flavours were very wild and unappetizing, so Han Sen had to spruce the taste up himself.

Han Sen added a variety of his favourite spices to the insects he roasted, and after sinking his teeth into their meat, his tongue was met with a smorgasbord of delicious tastes. It was exquisite.

<section class="world-voice-card" role="note"><p class="world-voice"><em>“Mutant Class Sabertooth Bee Consumed: Mutant Geno Points +1.”</em></p></section>
