# Chapter 1261: - Fish King’s Reappearance {.hidden-title}

<section id="chapter-1261" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1261-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1261</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Fish King’s Reappearance</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1261-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>bove the water of the river, a million flying fish had appeared. They were all following its winding course upstream.</p>
...
Golden Growler, by this point, had seven of its gene locks opened. Han Sen had fed it much super flesh and many water-drops to nurture its growth over time. But the speed at which it had developed was surprising, even to Han Sen— And the size it could grow to, if it so chose, was rather shocking to witness.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Super Creature Abyssal Beast killed. Beast soul gained. The flesh of this creature is inedible, but you may harvest its Super Geno Essence. Consume its Super Geno Essence to gain zero to ten super geno points randomly.”</em></p></section>
