# Chapter 1165: - Breaking Shield {.hidden-title}

<section id="chapter-1165" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1165-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1165</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Breaking Shield</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1165-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hen Han Sen left Zhang Yuchen’s house, he went straight to the testing area.</p>
...
Zhang Yuchen told him, **“You are only given one chance to break the shield and level up that way. If you fail, trying to reach the second floor will be far more difficult in the future, as you’ll be subject to a crueller challenge.”**
...
The walnuts were purple in colour, so they had to be from that tree. There were creatures in a chain-gang, pushing a stone mill, grinding them into dust.
