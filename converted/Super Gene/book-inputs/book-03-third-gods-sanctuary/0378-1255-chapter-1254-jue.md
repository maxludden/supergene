# Chapter 1255: - Jue {.hidden-title}

<section id="chapter-1255" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1255-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1255</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Jue</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1255-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>nside the pot, amidst the broken shell, was a bronze goblet: a jue.</p>
