# Chapter 1019: - Crazy {.hidden-title}

<section id="chapter-1019" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1019-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1019</p>
</section>
...
<section class="element chapter-text" id="chapter-1019-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>hat is it, Brother Han?”** Liu Yuxuan asked, looking back at Han Sen—</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Sacred-Blood Creature Armoured Turtle killed. Beast soul gained. Consume its flesh to gain zero to ten sacred geno points randomly.”</em></p></section>
