# Chapter 1214: - Blood Contract {.hidden-title}

<section id="chapter-1214" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1214-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1214</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Blood Contract</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1214-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">D</span>ragon King, are there any better ways to control a super creature?”** Han Sen asked.</p>
