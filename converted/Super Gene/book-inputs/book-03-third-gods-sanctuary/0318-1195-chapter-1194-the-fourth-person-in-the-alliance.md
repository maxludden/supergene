# Chapter 1195: - The Fourth Person in the Alliance {.hidden-title}

<section id="chapter-1195" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1195-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1195</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Fourth Person in the Alliance</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1195-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>ime King Spirit Geno Point +1; Time King Spirit Geno Point +1; Time King Spirit Geno Point +1.”**</p>
...
Han Sen filled out the application form, then Bai Yishan helped him fast-track the registration process. It was then that Han Sen realised Professor Long was the creator of Hyperspace: a tidbit of knowledge that greatly amped up his excitement.
...
It was a great distance away from Roca Planet, so to pass the time on the journey, Han Sen decided to practise combat in the virtual community.

**“Are you Han Sen?”** Someone recognised him.
...
Han Sen entered the holographic machine to practise combat and pass the time.
