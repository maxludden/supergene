# Chapter 1129: - Uncle Bug {.hidden-title}

<section id="chapter-1129" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1129-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1129</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Uncle Bug</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1129-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he man tried his hardest to kill himself, repeatedly. But each and every time, the shadow stopped him. Uncle Bug was crying again, with a face that was full of regret and pain.</p>
...
Han Sen could feel Uncle Bug’s life-force, and he could tell the man was the greatest and most powerful surpasser he had ever known.
