# Chapter 961: Father, Don\u2019t Cry {.hidden-title}

<section id="chapter-961" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-961-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">961</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Father, Don\u2019t Cry</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-961-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen took out the gourd and placed it in his hand. It was previously gold, but now it was dim and dirty-looking. Cracks had manifested across its surface, giving it the appearance of dried, distressed mud.</p>
...
It was a thumb-sized female doll. Its eyes were big and black, the same colour as the doll’s hair. It was a chubby little thing, but most curious of all was what the doll was holding. The doll was holding another gourd.
