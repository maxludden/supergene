# Chapter 960: Thorned History {.hidden-title}

<section id="chapter-960" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-960-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">960</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Thorned History</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-960-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">A</span>re you done staring?”** Han Sen asked.</p>
...
**“Then the answer is yes.”** Han Sen knew that she had already realised this and only wanted confirmation.
...
Thorn Baron saw Han Sen transform into her much fantasised-about King. She could not help but stare at the attractive face, that indeed looked like the most handsome male spirit one could ever expect to see. She had never before felt so conflicted.
