# Chapter 1293: - Moving Star Emperor {.hidden-title}

<section id="chapter-1293" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1293-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1293</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Moving Star Emperor</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1293-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>ortunately, the jue was only shaking. Nothing else happened.</p>
...
Asura might have been related to the shura, and the shura were related to the Luo family. Zero could practise the Asura Sutra and the Falsified-Sky Sutra, and on her back, she possessed a Nine-Life Cat tattoo. Furthermore, there was a connection between Blood Legion and Han Jinzhi.
