# Chapter 968: - Cocky Little Bear {.hidden-title}

<section id="chapter-968" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-968-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">968</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Cocky Little Bear</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-968-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen’s fitness level was just over a thousand. Compared to sacred-blood creatures, which had fitness levels of over two thousand, it was not difficult to understand why slaying such beasts was a trying task.</p>
...
Han Sen just thought it was fortunate that the scorpion lacked Area of Effect skills. Had it learnt such attacks, the only thing he could have done was run away.
...
Han Sen grabbed the white bear like a hunter grabbing a dead squirrel. With another evasive manoeuvre around the attacks of the scorpion, Han Sen took off flying into the air.
