# Chapter 1200: - Shura {.hidden-title}

<section id="chapter-1200" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1200-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1200</p>
</section>
...
<section class="element chapter-text" id="chapter-1200-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he shura that boarded the ship were all wearing the same armour. Aspects that often revealed their level, such as horns and faces, had been hidden.</p>
