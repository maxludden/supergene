# Chapter 1281: - Dollar {.hidden-title}

<section id="chapter-1281" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1281-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1281</p>
</section>
...
<section class="element chapter-text" id="chapter-1281-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he Serpent Throne became a physical manifestation of light, and then it entered the slot that used to contain the spirit stone. When the blinding light dimmed, the statue’s forehead was revealed to now contain a brand-new spirit stone. This one possessed the image of a snake.</p>
...
After a while, a copper light was cast into the hall right before Han Sen— The image was materialising.
...
It was a female spirit; one with horns and draconic wings. She had armour scaled like the hide of a dragon, and she looked like a Valkyrie.
