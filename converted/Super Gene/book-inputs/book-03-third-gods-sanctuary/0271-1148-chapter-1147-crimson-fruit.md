# Chapter 1148: - Crimson Fruit {.hidden-title}

<section id="chapter-1148" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1148-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1148</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Crimson Fruit</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1148-text" markdown="1">
<p class="first2"><span class="first-letter">E</span>ven more creatures were joining the fray; a dozen insects, each a meter long, began to rise from the lake.</p>
...
Even if Han Sen did stay and fight, Yaksha would be free to fly towards that door while the super creatures kept his foe occupied. Remaining there would be a pointless endeavour, and stopping Yaksha any further would be silly.
...
The jellylike fruit would vaporise shortly after becoming ripe, so she couldn’t eat it anywhere else at any other time.
...
Yaksha saw it happen, and he realised that someone had just claimed his fruit.
