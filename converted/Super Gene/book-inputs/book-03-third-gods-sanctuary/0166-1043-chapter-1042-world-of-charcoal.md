# Chapter 1043: - World of Charcoal {.hidden-title}

<section id="chapter-1043" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1043-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1043</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- World of Charcoal</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1043-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>his cannot be incorrect. This is indeed the Phoenix Eye,”** Brother Seven reaffirmed.</p>
...
Brother Seven could only say, **“I have no idea, but if we encounter whatever has done this, we are sure to meet a swift end. Rather than cooked, I’d wager we’d be vaporised.”**
...
He didn’t want to incite the ire and fury of the rams. To survive a stampede by those woolly fiends, he’d have to use super king spirit mode. But it was a draining talent, and he only sought to use it during the times where he absolutely had to. Not knowing what lay further ahead on this journey, too, he favoured not making use of it now.
...
It was clear to see their speed and power had increased, following their change in colour. But suddenly, Han Sen heard another sheep bawl.
