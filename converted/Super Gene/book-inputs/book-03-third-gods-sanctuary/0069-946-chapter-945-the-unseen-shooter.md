# Chapter 946: The Unseen Shooter {.hidden-title}

<section id="chapter-946" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-946-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">946</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">The Unseen Shooter</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-946-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">S</span>he is Thorn Baron! Hmph, I suppose that rules out my use of the red dagger. If she sees that, she’ll recognise me.”** Han Sen was glad he had decided to bring a bow.</p>
...
A gold-winged hawk was one of them, and it flew high above the rest, as if in airborne defence. Its eyes flickered with gold lightning, as its body glistened in the warm rays of the sun.

It was a powerful thunder class mutant creature, in terms of the damage it could deal out. Han Sen, however, could gauge the strength of its defence and tell that it had a weak body. It was like a glass cannon.
...
When they arrived in the area where they suspected the arrow had come from, there was no one there. No sense or life-force revealed the presence of an enemy in that place.

<section class="world-voice-card" role="note"><p class="world-voice"><em>“Mutant Creature Gold Thunder-Hawk killed. No beast soul gained. Consume its flesh to gain zero to ten mutant geno points randomly.”</em></p></section>

Before Han Sen could even hear the announcement chime, he had already vanished from the area.

He was not afraid that others could find him, as he was able to erase any indication of his life-force and even the precise trail of the arrow. Unless they could see the arrow, no one could detect where he might have attacked from.
...
And the creatures that were naturally talented in detecting scents and life-forces were unable to detect Han Sen due to his dongxuan aura.
...
But when she reached there, as reported by others in the first location, there was no one to be seen. No life-force could be detected, and it was as if her team was being assassinated by a ghost, one by one.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Mutant Creature Gold-Talon Wolf killed. Beast soul gained. Consume its flesh to gain zero to ten mutant geno points randomly.”</em></p></section>
