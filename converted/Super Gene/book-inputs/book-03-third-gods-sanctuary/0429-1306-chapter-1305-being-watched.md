# Chapter 1306: - Being Watched {.hidden-title}

<section id="chapter-1306" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1306-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1306</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Being Watched</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1306-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>n great haste, a swarm of Endless Swordfish was headed in Han Sen’s direction. They didn’t come for him, but simply sped past him as if they were attempting to get away from something that lay in the direction Han Sen was travelling.</p>

Han Sen understood their behaviour, acknowledging that they were fleeing some unseen menace on the horizon. They weren’t there to cause trouble.
...
**“Another super creature?”** Han Sen was delighted. He didn’t need Super Geno Essences anymore, but he’d never shy away from the possibility of earning another beast soul.
...
Lotus Empress paused for a moment, as if in thought, and then she went on to say, **“But it is supposed to appear in the deeper regions of the Endless Sea. We haven’t travelled that far, and what’s more, we are headed for an island. It shouldn’t be here at all.”**
