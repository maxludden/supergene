# Chapter 1151: - Blacklist {.hidden-title}

<section id="chapter-1151" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1151-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1151</p>
</section>
...
<section class="element chapter-text" id="chapter-1151-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen believed there to be many super creatures residing in that underground realm, and he believed he’d have an easy time venturing in to slay them whenever he desired. It’d be an efficient way for him to become stronger.</p>
...
Han Sen thought he could easily nab some Super Geno Essences and super beast souls by venturing down there, but like usual, events didn’t quite turn out as planned.
