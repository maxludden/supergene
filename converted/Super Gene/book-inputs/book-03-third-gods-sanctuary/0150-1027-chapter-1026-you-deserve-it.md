# Chapter 1027: - You Deserve It {.hidden-title}

<section id="chapter-1027" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1027-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1027</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- You Deserve It</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1027-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hen the shadow arrived, it felt as if the entire expanse had been veiled with a cloak of darkness.</p>
...
The ghost fox was irritated by Little Silver’s behaviour, and it let out a horrid shriek. After it was over, its tail sprang outwards to attack Han Sen—
...
**“You deserve it. Haha!”** Han Sen squeezed his own neck with tremendous strength, wheezing out a cackle whenever he could. He had gone psychotic.
