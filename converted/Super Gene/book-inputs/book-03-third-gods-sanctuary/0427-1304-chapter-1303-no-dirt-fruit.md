# Chapter 1304: - No Dirt Fruit {.hidden-title}

<section id="chapter-1304" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1304-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1304</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- No Dirt Fruit</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1304-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter opening ten gene locks, Han Sen wanted to take down Cup Demon Shelter, but Lotus Empress needed his help before he could do that.</p>
...
Empty Witch had thought Bao’er was some powerful Third God’s Sanctuary seed during their initial encounter. But when she came to the Third God’s Sanctuary, it was only then that she realised Bao’er was far stronger and far greater than she had imagined.
