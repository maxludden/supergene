# Chapter 1140: - Surprising Fruit {.hidden-title}

<section id="chapter-1140" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1140-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1140</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Surprising Fruit</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1140-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>hings began smoothly enough. No hassle was posed by other creatures, as they all seemed to avoid the Blue Dinosaur. Furthermore, Han Sen could hide his life-force.</p>
...
The rock rats were very similar to ordinary rats. They were a little bigger than the average rat, with a dishevelled grey look. They moved with a singular, focused purpose as they raced towards the scent, uncaring for their friends and brethren that were being killed unceremoniously by the dozen.
...
The tree’s actual colour was dark and yellowish, and the leaves were of a similar colour. It looked fairly ordinary, as such.

But the life-force the tree had was what immediately told Han Sen how special it actually was, and when his eyes first caught sight of the fruit that adorned those thick boughs, he was more than surprised.
...
The Blue Dinosaur began to drool, adding to the number of waterfalls that chequered the cavern. It was eager to get moving and visit the tree.
...
But that couldn’t have been all. Han Sen could detect the presence of many stronger life-forces observing the fruit, waiting for their opportunity to snag a prize.
