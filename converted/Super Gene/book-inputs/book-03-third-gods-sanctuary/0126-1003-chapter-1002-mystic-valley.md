# Chapter 1003: - Mystic Valley {.hidden-title}

<section id="chapter-1003" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1003-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1003</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Mystic Valley</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1003-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>ao’er sat upon a branch of the tree with a fruit in her hands. Then, she took a big bite. A lot of juice flowed out of the fruit, and it emitted a pleasant fragrance.</p>
...
But the monkey king jumped and tried to attack Han Sen— Fortunately for Han Sen, he was adept with airborne manoeuvres, and he was able to sidestep in the air to evade the monkey’s fist. As he did so, he called out to the monkey, **“Haha, Chunky Kong! I can fly; I bet you can’t do that.”**
