# Chapter 1241: - Three-Life Tree {.hidden-title}

<section id="chapter-1241" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1241-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1241</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Three-Life Tree</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1241-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>aint Fan’s holy light continued to expand, and the light that had previously suppressed him was dwarfed and had to pull away.</p>
...
The silver fox heard Han Sen’s command, and then suddenly its size shrank. It leapt onto Han Sen’s shoulder, taking back its rightful spot where his master had severely missed him.
