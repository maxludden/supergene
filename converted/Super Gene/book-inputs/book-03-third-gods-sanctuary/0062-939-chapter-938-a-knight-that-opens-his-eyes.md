# Chapter 939: A Knight That Opens His Eyes {.hidden-title}

<section id="chapter-939" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-939-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">939</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">A Knight That Opens His Eyes</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-939-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">H</span>ow do you reckon I can claim it?”** Han Sen asked.</p>
...
With the water-drops Han Sen possessed, the thousand years could be reduced to a mere three. And Han Sen was willing to wait that long.
...
One Loyal Knight disconnected and hit the ground. One after another, so did the others. They did not collapse onto the ground, but instead, they landed on their feet like armour-garbed mannequins in a museum.

Han Sen took a step back, not sure what to expect, and allowed Little Wind and his number one Dragon-Blood Snake to protect him from the front. He also made sure to summon his armour, just in-case.
