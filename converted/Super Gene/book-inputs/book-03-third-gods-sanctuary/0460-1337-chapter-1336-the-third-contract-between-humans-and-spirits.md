# Chapter 1337: - The Third Contract Between Humans and Spirits {.hidden-title}

<section id="chapter-1337" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1337-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1337</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Third Contract Between Humans and Spirits</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1337-text" markdown="1">
<p class="first2"><span class="first-letter">U</span>ndead Emperor was given a lot of information about Han Sen by the other spirits, so his expectations had already been realistically set. The spirits called upon Undead Emperor to help slay Han Sen due to his undying body, but just like always, the results shocked them.</p>
...
Han Sen gave the pair a bunch of Super Geno Essences to give them a headstart.
