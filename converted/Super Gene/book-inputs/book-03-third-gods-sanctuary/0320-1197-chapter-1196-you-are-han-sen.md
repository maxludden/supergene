# Chapter 1197: - You Are Han Sen? {.hidden-title}

<section id="chapter-1197" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1197-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1197</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- You Are Han Sen?</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1197-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>s the march of time went on, so did Han Sen’s ravenous barrage of attacks.</p>

His opponent was like a tumbler doll, refusing to fall over no matter how hard or how quickly Han Sen struck. Even while channelling all his powers of prediction, he simply couldn’t find a way to knock him down. Han Sen was actually shocked by what was going on.
...
Amidst the dizzying array of skills consistently being cast, Fang Mingquan was only able to recognise around one in ten. And before he could finish blinking to acknowledge a skill, another flurry of attacks and defensive skills had been flung.
...
One attack, followed by one defence; whoever made a mistake first would be the loser.
