# Chapter 1045: - Nirvana Lake {.hidden-title}

<section id="chapter-1045" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1045-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1045</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Nirvana Lake</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1045-text" markdown="1">
<p class="first2"><span class="first-letter">D</span>evil-horn King: Polluted Beast Soul Weapon Type.</p>
...
**“This painting is Phoenix Emperor’s treasure; he must have drawn it after seeing all the birds laid out before him in the hall,”** Han Sen theorised.

Han Sen thought about the palace, and now, looking at the picture presented, he realised it was the complete set.
...
Xie Qing King flew at an obscene speed, and it seemed as if they travelled thousands of miles in no time at all. They came to a stop near a lake.
