# Chapter 987: - Third Tier of the Dongxuan Sutra {.hidden-title}

<section id="chapter-987" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-987-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">987</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Third Tier of the Dongxuan Sutra</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-987-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen had now learned more about Taia and Qin Huaizhen. While this may have helped elucidate a few things—like how the sword had been brought to the sanctuaries—the real burning questions were still left unanswered.</p>

When the Qin family asked the Lan Te family where they found the sword, they said it was purchased from an interstellar traveller.

They had only seen the traveller once. They did not know where he came from, and they had since been unable to identify him.
...
The second tier allowed him to mask his life-force to elude the notice of others. After opening his third gene lock, he could now obscure the seventh sense of others.
