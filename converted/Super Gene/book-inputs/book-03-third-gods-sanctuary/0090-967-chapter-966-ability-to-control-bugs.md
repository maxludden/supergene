# Chapter 967: Ability to Control Bugs {.hidden-title}

<section id="chapter-967" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-967-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">967</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Ability to Control Bugs</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-967-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">O</span>h my God! What is this monster?”** Li Yutian was shocked.</p>

A giant bug, as big as a bus, shout out from beneath the earth. Its tentacles looked like discoloured versions of the vines of the forest, laden with lethal thorns. After Han Sen sliced one of its lecherous appendages, the foe was enraged. It charged at Han Sen in a frenzy.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Mutant Creature Thorn Bug killed. No beast soul gained. Consume its flesh to gain zero to ten mutant geno points randomly.”</em></p></section>
...
After a brief moment, the colour of black faded to a blue, almost aquatic glow. If you were to suffer a sting from one of its wretched tails, you would assuredly not survive.
