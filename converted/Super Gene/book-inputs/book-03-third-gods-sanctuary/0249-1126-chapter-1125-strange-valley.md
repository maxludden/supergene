# Chapter 1126: - Strange Valley {.hidden-title}

<section id="chapter-1126" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1126-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1126</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Strange Valley</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1126-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">U</span>ncle Bug, where are you off to?”** Han Sen asked, looking at Uncle Bug.</p>
