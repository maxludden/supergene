# Chapter 1171: - Man’s Ocean {.hidden-title}

<section id="chapter-1171" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1171-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1171</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Man’s Ocean</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1171-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>eeing Han Sen walk towards the fourth floor, Qiu Ping chose to follow.</p>
...
Qiu Ping’s life-force was like an ocean, deep and unpredictable.
...
It wasn’t perfect. One had to be well-versed in its teachings and practise with it a lot to become proficient, but even still, it could not predict everything. After all, the man who created the Dongxuan Sutra was unable to predict he’d die in the First God’s Sanctuary.
