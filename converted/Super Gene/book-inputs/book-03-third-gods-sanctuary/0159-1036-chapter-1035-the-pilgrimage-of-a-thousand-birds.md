# Chapter 1036: - The Pilgrimage of a Thousand Birds {.hidden-title}

<section id="chapter-1036" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1036-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1036</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Pilgrimage of a Thousand Birds</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1036-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he platform lowered. It descended slowly, until it came to a stop before a stone door.</p>
