# Chapter 1191: - Asura Betrayal {.hidden-title}

<section id="chapter-1191" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1191-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1191</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Asura Betrayal</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1191-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hile Han Sen was flying back, someone called out his name. When he turned around to take a look, he saw an eight-year-old child squirming and writhing around on the ground as if in pain.</p>
...
He used to have the face of a child, but now he was a child completely. The head was still frighteningly large, however. His life-force was weak, almost as weak as a newly-spawned Golden Growler.
...
Han Sen rested there for two days, and after that, he started refining the Super Geno Essence of the Sky Peacock.
...
Han Sen was delighted, hearing the announcement chime more than once. In total, the Super Geno Essence provided him four points in total.
...
When Han Sen’s condition and health improved, he didn’t jump back to start hunting super creatures again. He realised he still needed a lot more strength to fight an emperor, though; he had to be careful where he next ventured.
...
**“If you practise the Asura Sutra, you can fix them. Back then—”** Dragon King realised he had said something he should not have mentioned.
