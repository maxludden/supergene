# Chapter 910: A Big Tree in the Forest {.hidden-title}

<section id="chapter-910" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-910-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">910</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">A Big Tree in the Forest</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-910-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>eeing this tall, lonely tree from afar, Han Sen frowned. The tree possessed a grand life-force, but there was nothing else alive in its proximity.</p>
