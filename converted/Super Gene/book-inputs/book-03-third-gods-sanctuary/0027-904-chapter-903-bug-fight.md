# Chapter 904: Bug Fight {.hidden-title}

<section id="chapter-904" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-904-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">904</p>
</section>
...
<section class="element chapter-text" id="chapter-904-text" markdown="1">
<p class="first2"><span class="first-letter">A</span> blonde, purple-eyed woman emerged from beneath the green bushes that cradled the red roses.</p>
...
The woman was not wearing any clothes. When she stood up, the fine curve of her booty, and how it led all the way down her long legs, was a sudden, tantalising sight. It was all on full display.
...
When she emerged from the bushes, she looked cold. And the moment she stepped out, the flowers writhed their way around her to form an armour.
...
After this, Han Sen realised that it was the stalks of the flowers that were serving as candles.
...
Not long after, many more bugs arrived. They were of varying shapes and colours; some were black, some were red, and some were green.
...
Coloured dots peppered its all-black shell, and it seemed to have even obtained the centipede’s flame and spider’s green light.
