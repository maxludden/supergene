# Chapter 965: Ancient Hall {.hidden-title}

<section id="chapter-965" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-965-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">965</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Ancient Hall</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-965-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen returned from Han Lei’s house with a box of items.</p>
...
The datapad was the only thing that might harbour the sort of information he was looking for. Unfortunately, it was password-protected.
...
**“Holy shit! What the hell?!”** Li Xing Lun was frozen at the result.
...
Han Sen opened it to nothing. All that remained was the black, smouldering remains of what it had been.
...
**“Entering Ancient Hall— practise blood— sutra—”**

There were many words missing from the text, but this sentence was the easiest one to read.

**“If I want to enter the Ancient Hall, do I need to practise Blood-Pulse Sutra? Is that what this is implying?”** Han Sen’s confusion was only becoming greater.
