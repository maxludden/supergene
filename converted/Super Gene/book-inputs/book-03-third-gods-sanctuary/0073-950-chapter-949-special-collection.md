# Chapter 950: Special Collection {.hidden-title}

<section id="chapter-950" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-950-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">950</p>
</section>
...
<section class="element chapter-text" id="chapter-950-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he next day, a spacecraft came to pick up Han Sen— Clearly, but perhaps unexpectedly, Annie had revealed herself to be a bit of a scrooge. The spacecraft was only a shuttle that was to bring him and Annie to the spaceport so they could charter public transportation and make their own way to Atlantic Planet.</p>
