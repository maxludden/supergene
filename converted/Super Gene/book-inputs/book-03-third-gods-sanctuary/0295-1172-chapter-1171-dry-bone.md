# Chapter 1172: - Dry Bone {.hidden-title}

<section id="chapter-1172" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1172-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1172</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Dry Bone</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1172-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he news about Han Sen going to the fifth floor had spread. As he approached to take the test, though, the guard asked that Han Sen wait a day.</p>
...
**“This should be decided by Mister Immortal, but he’s practising right now, so we can’t disturb him. Should I make the decision, then?”** The king spirit looked into the eyes of each.
...
A giant skeleton, clad in bone armour, stood inside the arena awaiting his combatant. He was four meters tall and looked frightening. His eyes were like red gemstones that were alive with an evil flame.
...
**“With a fitness level like that, I doubt he’s of the strength Mister Immortal is looking for. I suppose I’ll just have to do Qing Jun a favour,”** Dry Bone King thought to himself.
