# Chapter 1294: - The Light Is Dark {.hidden-title}

<section id="chapter-1294" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1294-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1294</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Light Is Dark</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1294-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen looked at Moving Star Emperor and said, **“Are you saying those that don’t understand are filthy? Why don’t you go ahead and explain what the Luminous Stone is, then?”**</p>
...
Moving Star Emperor addressed that hypothesis with disdain. **“Nonsense! Night Empress practised the path of darkness. It is a geno treasure attuned with the element of dark. Dark is the complete opposite of light. Pah! What a cheap race, only capable of talking crap.”**
...
Han Sen smiled and told the emperor, **“You are ignorant. Light and Dark are two sides of the same coin. They both exist at the expense of each other. Light is dark, and dark is light. She may have practised along a path of darkness, but she could also use the Light element. It’s simple.”**
...
Due to the fact the Luminous Stone was blackened and charred by the fires of Holy Door, and its life-force had been depleted, and it looked to be of Dark.
