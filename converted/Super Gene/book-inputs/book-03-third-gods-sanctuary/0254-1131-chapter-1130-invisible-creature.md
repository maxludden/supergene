# Chapter 1131: - Invisible Creature {.hidden-title}

<section id="chapter-1131" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1131-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1131</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Invisible Creature</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1131-text" markdown="1">
<p class="first2"><span class="first-letter">K</span>illing the super creature he had proposed to slay would not be easy. Uncle Bug told him the shadow of the creature was what possessed his son, but the actual body he would have to defeat was someplace in the valley.</p>
...
But even though Han Sen could see it with his naked eyes, the dongxuan aura still proved ineffective. He still couldn’t get a feel for the life-force of the scorpion.
...
But eventually, Han Sen decided against fighting it. He remained there, watching the invisible scorpion, absorbing the moonlight that had been channelled through the bright reflections of the little scorpions’ chitin.
