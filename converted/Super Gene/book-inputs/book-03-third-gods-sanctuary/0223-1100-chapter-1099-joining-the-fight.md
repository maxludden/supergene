# Chapter 1100: - Joining the Fight {.hidden-title}

<section id="chapter-1100" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1100-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1100</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Joining the Fight</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1100-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">D</span>on’t be so melodramatic. Those things are useless to me, just use them and be happy.”** Han Sen was starting to sweat, as he wasn’t really a cripple.</p>
...
When Divinity’s Bout started, Han Sen donned a suit of armour and went straight to the Martial Hall. Then he proceeded to the battle area.
