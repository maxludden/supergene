# Chapter 1068: - Really Rich {.hidden-title}

<section id="chapter-1068" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1068-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1068</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Really Rich</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1068-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>efore he did anything else, Han Sen wanted to collect as many purple crystal cores as he could. When the operation’s timer ran out, it’d draw suspicion if he was to remain and not leave.</p>
...
It was fifty miles in length, and after a preliminary scan, Han Sen was able to detect the presence of more architectural ruins at its center. This must have been the heart of the entire Crystalliser region they had come to examine.
...
The Crystallisers weren’t known for cheap construction. They built their civilisations to last, and their structures were incredibly hardy. Average buildings of theirs had been known to withstand atomic bombs.
...
What Han Sen was able to detect, though, was the presence of more purple crystal cores. There were lots of them, and Han Sen hypothesised the region they were in now had to be some sort of warehouse for them.
...
For a dozen cores to make the shura incredibly jealous, Han Sen realised the items were more precious and valuable than he initially thought them to be.
