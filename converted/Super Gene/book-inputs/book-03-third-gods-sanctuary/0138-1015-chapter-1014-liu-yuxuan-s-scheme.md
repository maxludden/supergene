# Chapter 1015: - Liu Yuxuan’s Scheme {.hidden-title}

<section id="chapter-1015" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1015-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1015</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Liu Yuxuan’s Scheme</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1015-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">U</span>ncle San and Weiwei, follow me to the shelter,”** Liu Yuxuan said, with surprising passion.</p>
