# Chapter 1035: - The Phoenix Descends and the Emperor Dies {.hidden-title}

<section id="chapter-1035" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1035-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1035</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Phoenix Descends and the Emperor Dies</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1035-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was shocked. He was a strong man, and he could lift even the heaviest of items. This feather, though, would require a heft far beyond his capabilities.</p>
...
Han Sen brought out his Taia sword. Their lengths were different, but they would make a fine duo. With them, he could practise Double Fly.

**“I need to practise Double Fly. If I don’t, it would be a waste of two good swords,”** Han Sen told himself.
...
Han Sen left the tree with a renewed vigour for finding an entrance into Phoenix Shelter.
