# Chapter 1024: - Attacking a Shelter {.hidden-title}

<section id="chapter-1024" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1024-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1024</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Attacking a Shelter</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1024-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>ilver lightning burst out of the silver fox and collided with the golden light.</p>
