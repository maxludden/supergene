# Chapter 1136: - The History of the Nine-Life Cat {.hidden-title}

<section id="chapter-1136" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1136-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1136</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The History of the Nine-Life Cat</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1136-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">H</span>ow did you know that I noticed the pendant?”** Uncle Bug asked with shock.</p>
