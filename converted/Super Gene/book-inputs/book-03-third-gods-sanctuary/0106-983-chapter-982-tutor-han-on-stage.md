# Chapter 983: - Tutor Han on Stage {.hidden-title}

<section id="chapter-983" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-983-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">983</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Tutor Han on Stage</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-983-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>aving dinner with Ji Yanran, Han Sen informed her that he would be teaching students in archery.</p>
...
Han Sen spent most of his days practising the Dongxuan Sutra and taking care of Bao’er and Zero. Such peaceful periods were a rare occurrence for him.
...
**“I wonder if that king tree will be able to grow again? I should return there sometime, dig it up and bring it back here. If the water-drops prove successful in restoring it, I might be able to gain self geno points very quickly.”** Han Sen was getting giddy just thinking about it.
