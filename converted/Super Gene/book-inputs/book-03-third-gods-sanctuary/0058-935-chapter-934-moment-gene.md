# Chapter 935: Moment Gene {.hidden-title}

<section id="chapter-935" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-935-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">935</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Moment Gene</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-935-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">D</span>o you want to be imprisoned in the Sea of Soul from now unto eternity, or would you like to control the shelter?”** Han Sen said, sternly looking at Moment Queen.</p>
...
**“Consume the Super Geno Essence of a super creature that shares the same element as you. Either that, or fruit of the same element,”** Moment Queen answered, surprisingly forthwith.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“King Spirit Time Gene +1.”</em></p></section>
...
He believed each flower would bear him a fruit, but he soon realised he was wrong.
