# Chapter 1269: - Pinecone {.hidden-title}

<section id="chapter-1269" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1269-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1269</p>
</section>
...
<section class="element chapter-text" id="chapter-1269-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>here was a green pinecone in the fish king’s head. It was half-embedded, and it shone an ominous green like a third eye. The light pulsated, and when the pinecone lit up, it caused the fish king’s body to twitch.</p>
...
He landed in the forest and made his life-force replicate that of another plant.
