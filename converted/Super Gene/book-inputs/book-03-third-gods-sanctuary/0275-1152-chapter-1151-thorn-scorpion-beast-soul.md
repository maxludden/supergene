# Chapter 1152: - Thorn Scorpion Beast Soul {.hidden-title}

<section id="chapter-1152" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1152-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1152</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Thorn Scorpion Beast Soul</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1152-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hen Han Sen moved the underground shelter again, there was only Queen, Bao’er, and Zero left.</p>
...
Queen continued to battle the scorpion, listening to Han Sen read the text. Her skill in battle was improving in realtime. After hearing Han Sen speak, Queen realised the true potential of phoenix techniques and how beneficial they could be.
...
Queen had come a long way in a short time. She had levelled up very quickly, but regardless, Han Sen helped her put the creature down for good, after a time of battle.

<section class="world-voice-card" role="note"><p class="world-voice"><em>“Sacred-Blood Creature Thorn Scorpion killed. Beast soul gained. Consume its flesh to gain zero to ten sacred geno points randomly.”</em></p></section>
