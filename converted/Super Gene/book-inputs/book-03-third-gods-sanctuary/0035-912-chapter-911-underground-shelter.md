# Chapter 912: Underground Shelter {.hidden-title}

<section id="chapter-912" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-912-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">912</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Underground Shelter</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-912-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>hat is hidden inside the tree, I wonder? Does it have something to do with that dead fellow? Did he die here, hoping people would find the door?”** Han Sen thought to himself, as he observed the tree door.</p>
...
**“You two wait here; I will scope the place out first.”** Han Sen leapt down and cast his dongxuan aura to observe whether or not there were life-forces as he went.
...
Ji Yanran knew Han Sen was strong, but the Third God’s Sanctuary was an extremely dangerous realm. Receiving the opportunity to live there, and perhaps later thrive, was dependent on luck.
