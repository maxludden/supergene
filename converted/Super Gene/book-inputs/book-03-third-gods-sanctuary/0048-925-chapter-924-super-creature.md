# Chapter 925: Super Creature? {.hidden-title}

<section id="chapter-925" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-925-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">925</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Super Creature?</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-925-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he barbed bushes that encircled the tree shook, until something emerged.</p>
...
Fortunately, the dinosaur only took hold of Han Sen’s armour. The creature did not injure him.

He stood up and fell back a few steps. Then, the dinosaur jumped behind Han Sen and bit the back of his armour again, keeping him close.
