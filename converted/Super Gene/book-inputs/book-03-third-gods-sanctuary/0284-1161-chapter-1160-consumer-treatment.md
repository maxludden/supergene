# Chapter 1161: - Consumer Treatment {.hidden-title}

<section id="chapter-1161" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1161-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1161</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Consumer Treatment</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1161-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter sending the kid off, Han Sen held Ji Yanran and spoke with her for a while.</p>
...
**“Are they famous, then?”** Han Sen truly did not recognise the couple.
