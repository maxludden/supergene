# Chapter 943: Abandon the City? {.hidden-title}

<section id="chapter-943" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-943-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">943</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Abandon the City?</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-943-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>hat are you doing out there? Get in!”** Han Sen witnessed someone calling out to him.</p>
...
But the sudden realisation of this loss was difficult to swallow, and they knew once they departed, they’d have nowhere else to go. There was going to a great deal of hardship for them, beginning the next day.
...
Han Sen observed the life-forces of the people around him, and he noticed many of them were quite skilled and powerful. Thirty such people in a group was quite impressive.
