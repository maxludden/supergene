# Chapter 1067: - Big Plunder {.hidden-title}

<section id="chapter-1067" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1067-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1067</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Big Plunder</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1067-text" markdown="1">
<p class="first2"><span class="first-letter">J</span>i Yanran’s situation was bad. She had not teleported with the others as expected, and she had been left all alone.</p>

She set out in search of Han Sen but had an unfortunate encounter with Crystalliser robots.

Ji Yanran was weak, and only an evolver. For her, dealing with the Crystalliser robots would have been nearly impossible. Therefore, all she could do was run.
...
Ji Yanran did not know why the Crystalliser machine was attacking its own, but it did not matter. She had accepted the fact she was likely to die there, all alone.
...
Han Sen flew around like a jet, blasting any Crystalliser robots he came across along the way. As they went, Ji Yanran had to ask, **“What is this machine?”**

**“I found it in a ruin. I can only suspect it was a Crystalliser war-frame.”** Han Sen then went on to ask, **“Is that a purple crystal core?”**
...
Then, the beetle started flying even faster. It spun around and eliminated a few Crystalliser guards that were ahead. He zipped left, right, and center, collecting a multitude of purple crystal cores.
...
But they were each travelling at a very slow pace, not wishing to be hasty.
...
Han Sen would be able to pin their deaths on the Crystallisers with ease, and killing them would be swift and painless with the beetle, anyway.
</section>
