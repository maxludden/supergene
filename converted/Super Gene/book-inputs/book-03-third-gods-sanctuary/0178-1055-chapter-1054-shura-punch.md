# Chapter 1055: - Shura Punch {.hidden-title}

<section id="chapter-1055" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1055-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1055</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Shura Punch</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1055-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">L</span>ian Chan is streaming! Hmm, but that place doesn’t look remotely shura. There are human artefacts everywhere.”**</p>
...
If Han Sen won, they’d have to go exploring the Crystalliser ruins together. Having an enemy for a companion on such a venture would be pointless.
...
The fist made the air ripple with shockwaves. It travelled at a blistering pace, in a bid to finish Han Sen in a single opening move.
