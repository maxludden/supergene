# Chapter 941: Frightening Glory {.hidden-title}

<section id="chapter-941" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-941-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">941</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Frightening Glory</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-941-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he Disloyal Knight cried out. Its copper armour glistened in the midday sun, as it teleported in front of Han Sen and tried to strike his stomach.</p>
...
His sacred-blood armour was dented, and its metal was cracked.
...
The Disloyal Knight struck the barricade, with the fist landing firmly on the head of one of the snakes. The snake was pulverised immediately, as a squelching noise greeted the knight’s closed fist. The beast soul had been killed just like that.
...
Moment Queen teleported directly behind the Disloyal Knight and tried to punch the bloody, torn place in its armour where it had prematurely ripped itself loose from the tree.

But all of a sudden, the Disloyal Knight’s body shone brightly and blocked her attack. It was close, but no cigar.

Moment Queen’s fist bled after punching the light-imbued protection that now coated the foe’s armour.
