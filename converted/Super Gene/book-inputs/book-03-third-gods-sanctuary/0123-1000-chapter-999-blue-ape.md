# Chapter 1000: - Blue Ape {.hidden-title}

<section id="chapter-1000" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1000-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1000</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Blue Ape</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1000-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">L</span>ittle Han, is it a sacred-blood creature?”** Old Huang asked.</p>
...
His sacred-blood armour was able to repel the fire and toxic smoke, thankfully. All he had to do to remain alive was not breathe in the smoke himself.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Sacred-Blood Creature Black Python killed. No beast soul gained. Consume its flesh to gain zero to ten sacred geno points randomly.”</em></p></section>
...
But a few days later, there were growing reports of a blue-coloured fiend making a habit of stealing kills and even wounding people.
