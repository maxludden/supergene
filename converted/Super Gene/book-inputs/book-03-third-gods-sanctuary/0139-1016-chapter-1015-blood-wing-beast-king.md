# Chapter 1016: - Blood-Wing Beast King {.hidden-title}

<section id="chapter-1016" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1016-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1016</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Blood-Wing Beast King</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1016-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen calmly observed Liu Yuxuan. Han Sen was dexterous in the arts of assassination, and when his Jade-skin had allowed him to open his eighth sense, he gained the ability to detect any hostile feelings towards him.</p>
...
It had blood-coloured wings that were thirty meters wide, and horns decorated the monster’s head like those of a goat.
