# Chapter 1223: - Claiming an Emperor {.hidden-title}

<section id="chapter-1223" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1223-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1223</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Claiming an Emperor</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1223-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he newborn king spirit’s face changed. With two purple swords, he repeatedly tried to slash Han Sen—</p>
...
Travelling with a manipulation of space was not considered actual teleportation, but the effects were similar enough to be almost indistinguishable. The purple sword hit nothing.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Super Creature Ice Wolf God killed. Beast soul gained. The flesh of this creature can be consumed, and you may also harvest its Super Geno Essence. Consume its Super Geno Essence to gain zero to ten super geno points randomly. Will you accept the beast soul?”</em></p></section>
