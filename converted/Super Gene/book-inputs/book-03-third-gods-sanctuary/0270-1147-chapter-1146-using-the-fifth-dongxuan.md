# Chapter 1147: - Using the Fifth Dongxuan {.hidden-title}

<section id="chapter-1147" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1147-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1147</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Using the Fifth Dongxuan</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1147-text" markdown="1">
<p class="first2"><span class="first-letter">A</span> shadow of blood emerged from the floor as Han Sen barred Yaksha’s way once more.</p>
...
Yaksha wanted to eliminate Han Sen with a burning desire. It was a simplistic notion, and it was reflected in the workings of his mind. Han Sen knew exactly what he was thinking in this endeavour.
...
And like before, Han Sen heard exactly what he proposed to do and when he proposed to do it. With effective judgement, he managed to dodge it.
