# Chapter 906: Killing Iron Bug King {.hidden-title}

<section id="chapter-906" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-906-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">906</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Killing Iron Bug King</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-906-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>evered roses danced through the air as the spirit continued trying to deal with the enraged iron bug. But whatever came into contact with the green liquid-fire, geno weapons included, would be corroded and ruined immediately.</p>
...
The spirit used everything in her power but was unable to defeat the sacred-blood class iron bug. Suddenly, the weapon she was bringing down on the iron bug caught on fire. In a flash, the phantom corrosion travelled down her weapon and onto her, setting her body alight.

The spirit’s armour could not withstand the brutal fire. The flowers that clothed her were quickly burning away, and she had no choice but to remove herself from the rose-gown. She was naked once again.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Sacred-Blood Creature Iron Bug King killed. Beast soul gained. Consume its flesh to gain zero to ten sacred geno points randomly.”</em></p></section>
...
From his sudden appearance behind the bug, the subsequent punch, the use of the dagger and the even faster escape, the entire event occurred in the time-frame of about two or three seconds.

Before the spirit could even react, Han Sen had already left the valley. She wouldn’t be able to find him.

As he travelled, Han Sen’s super king spirit soon ran out and his body returned to normal.
...
If Han Sen had revealed his true face when he killed the bug, the spirit would have assuredly remembered the face of her saviour. And if that had happened, it would have spelled nothing pleasant.
...
But when they returned home, they could not find Chu Ming. The yard was in disarray, and in Han Sen’s time away, he had been unable to feed the tree the water-drops he had been giving it. The tree was now yellow, and it was beginning to look like the dead tree it had been.
