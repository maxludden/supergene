# Chapter 1143: - Broken Bone {.hidden-title}

<section id="chapter-1143" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1143-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1143</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Broken Bone</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1143-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he lady’s voice was like music, and just hearing it made Han Sen happy.</p>
