# Chapter 1047: - Fight It {.hidden-title}

<section id="chapter-1047" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1047-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1047</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Fight It</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1047-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">H</span>ide in the lake and only come out when I call you,”** Xie Qing King commanded, as he saw the red inferno that was consuming the sky.</p>
...
Fortunately, Han Sen had maxed out his fire geno points and practised Phoenix Flame. If he had not, he would have been cooked alive for just poking his head above water.
