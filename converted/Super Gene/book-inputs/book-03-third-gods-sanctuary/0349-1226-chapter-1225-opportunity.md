# Chapter 1226: - Opportunity {.hidden-title}

<section id="chapter-1226" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1226-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1226</p>
</section>
...
<section class="element chapter-text" id="chapter-1226-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">O</span>ld Huang, why is the emperor bringing so many king spirits and super creatures with him?”** In a forest, two humans spoke with each other in a hushed volume.</p>
...
Han Sen travelled past the forest and equipped a black cloak. He was sneaking into Thunder Hell Shelter.
