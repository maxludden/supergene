# Chapter 1153: - A Super Creature That Loves Food {.hidden-title}

<section id="chapter-1153" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1153-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1153</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- A Super Creature That Loves Food</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1153-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter an extensive session of testing, Han Sen was able to confirm the Thorn Scorpion glyph imbued his attacks with a lethal venom.</p>
...
If Queen wasn’t out hunting, she was spending her time practising hyper geno arts in the shelter. Han Sen half-believed she was a machine; one that could not turn off, at that.

If she turned out to be a machine, Han Sen wouldn’t be surprised.

Queen’s figure was as voluptuous as ever; perfectly sculpted as if through masterful design. Whenever she exercised, her boobs bounced vigorously and almost unnaturally. Their physics were hypnotising to watch, and it was something Han Sen believed only robots designed for that purpose could achieve.
...
Han Sen immediately regretted he had not taken advantage of that opportunity and leapt forward to slay it. Following it underground was not a good idea.
