# Chapter 1105: - Allure of Money {.hidden-title}

<section id="chapter-1105" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1105-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1105</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Allure of Money</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1105-text" markdown="1">
...
While that may have been considered a significant downside, it wasn’t all that bad, in practise. The coin could be fired whenever, at any cost of power. If it looked likely he was going to be interrupted, he could just fire it then and there.
