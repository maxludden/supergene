# Chapter 1040: - Let Them Fight, Grab the Spoils {.hidden-title}

<section id="chapter-1040" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1040-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1040</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Let Them Fight, Grab the Spoils</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1040-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was shocked, to say the least. He had not expected the two to have known each other. He was hoping Xie Qing King would be freed to eliminate Holy-Sword Emperor, but that wasn’t looking likely now.</p>
