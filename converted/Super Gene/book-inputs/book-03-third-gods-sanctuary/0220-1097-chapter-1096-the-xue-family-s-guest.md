# Chapter 1097: - The Xue Family’s Guest {.hidden-title}

<section id="chapter-1097" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1097-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1097</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Xue Family’s Guest</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1097-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">P</span>iece of cake!”** Wang Lin turned to look at the Frost Sutra again.</p>
...
**“There’s no need to continue. There is no mention of frost being a core component of the sutra, and yet, the beginning of Jade-skin explicitly refers to a combination of yin and frost. It’s an easy mistake to make,”** Han Sen said with a grin.
...
The professionals glanced over the Frost Sutra and Jade-skin again, and they too were now able to acknowledge the error.

**“Mister Han, how do we fix this issue?”** Xue Yufeng saw Wang Lin robbed of his ability to speak, so he asked Han Sen—

Han Sen said, **“You have to remove the frost element. If you practise it profoundly, you must ingest something warm to nurse your body. You should also improve Ice-heart. And ideally, it would be best if you didn’t live somewhere this cold.”**
...
The Xue family treated Han Sen like an honoured guest now, too. They asked him to help personally modify Jade-skin and the geno fluid again. They also wanted him to help them improve Iceheart.

The three other families were happy, too. If this worked, then it meant everyone could practise the Frost Sutra.
...
Aside from modifying the Frost Sutra and Ice-heart, Han Sen spent some time indulging in a number of rare books that were secret to the other families.
...
When Han Sen left them, he continued modifying his own new Jade-skin. The Frost Sutra was used as a base, but he knew it had to be more than that.

Han Sen needed it to be much better than what it was, so it could provide support for his Dongxuan Sutra. For the cons his signature sutra may have harboured, he hoped his modifications of Jade-skin could rectify them.
