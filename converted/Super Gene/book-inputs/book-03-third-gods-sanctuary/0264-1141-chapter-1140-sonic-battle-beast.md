# Chapter 1141: - Sonic Battle Beast {.hidden-title}

<section id="chapter-1141" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1141-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1141</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Sonic Battle Beast</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1141-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen stared at the shadow in the tree with shock.</p>
