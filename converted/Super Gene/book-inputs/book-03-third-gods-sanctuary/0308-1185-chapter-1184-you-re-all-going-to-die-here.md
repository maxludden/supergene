# Chapter 1185: - You’re All Going to Die Here {.hidden-title}

<section id="chapter-1185" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1185-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1185</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- You’re All Going to Die Here</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1185-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen removed the Dragon-Blood Ring from his finger. If Immortal Emperor truly was Sky King, he’d recognise Dragon King right away. Han Sen and Dry Bone King arrived at the Immortal Hall. Han Sen was eager to see what Immortal Emperor looked like.</p>
...
The peacock was gold, with a number of multi-coloured ornamental eyespots decorating its plumage. It was stunning.
