# Chapter 1286: - Attacking Saint Fan Shelter {.hidden-title}

<section id="chapter-1286" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1286-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1286</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Attacking Saint Fan Shelter</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1286-text" markdown="1">
<p class="first2"><span class="first-letter">X</span>ie Yuxin returned to Yu Shaoqing’s side and saw Yu Qianxun beside him, also. She asked, **“Qianxun?”**</p>
...
Han Sen only needed seven more points to completely max out. His fitness was 3,700, a staggering sum.

When Han Sen eventually reached demigod status, however, he’d do so at the number of 7,000.
