# Chapter 975: - Mystic Stone Room {.hidden-title}

<section id="chapter-975" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-975-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">975</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Mystic Stone Room</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-975-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he Red-Eye Rabbit jumped and grabbed one of the tree’s fruit. It swallowed it in one gulp, and immediately after doing so, started to roll on the floor as if it was suffering.</p>

Not long after, it calmed down. It looked weaker than it had before, and its life-force was faint. But slowly, it began to return to normal.
...
Han Sen turned his gaze back to the tree. Its life-force was incredibly strong, and he did not even have to use the dongxuan aura to feel it.
