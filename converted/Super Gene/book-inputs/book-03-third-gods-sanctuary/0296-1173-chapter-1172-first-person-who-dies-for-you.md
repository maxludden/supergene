# Chapter 1173: - First Person Who Dies for You {.hidden-title}

<section id="chapter-1173" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1173-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1173</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- First Person Who Dies for You</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1173-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen used his Blood-Pulse Sutra to open nine gene locks. He lowered his red body and avoided Dry Bone’s incoming punch.</p>
...
Dry Bone King looked sour, and the flames of his rage were only being fanned with each missed attack. Suddenly, he threw off the chestplate of his armour.
