# Chapter 971: - Red-Eye Rabbit {.hidden-title}

<section id="chapter-971" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-971-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">971</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Red-Eye Rabbit</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-971-text" markdown="1">
<p class="first2"><span class="first-letter">R</span>ustle. Rustle. Rustle.</p>
...
The red-eye rabbit continued to nibble the food without interruption, but at this point, Han Sen realised there was something very wrong with it.
...
After travelling briefly, he stumbled across a canyon. He was at the top, and when he leaned over to take a peak, he saw many more red-eye rabbits.
...
This rabbit also had an invisible barrier of protection. But this rabbit was weaker, and Han Sen was able to break through the force-field and kill it.

<section class="world-voice-card" role="note"><p class="world-voice"><em>“Ordinary Creature Red-Eye Rabbit killed. No beast soul gained. Consume its flesh to gain zero to ten ordinary geno points randomly.”</em></p></section>
</section>
