# Chapter 1031: - Daddy is Popular {.hidden-title}

<section id="chapter-1031" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1031-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1031</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Daddy is Popular</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1031-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen, browsing the aisles of the supermarket, held Bao’er in his arms. He had spent so much time in the sanctuary, returning to the conveniences of civilisation made for a nice change of pace.</p>
...
**“Lanxi is my big sister; I didn’t realise that you knew her.”** Qu Wange smiled.
