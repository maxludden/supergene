# Chapter 956: The Strongest Skill {.hidden-title}

<section id="chapter-956" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-956-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">956</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">The Strongest Skill</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-956-text" markdown="1">
<p class="first2"><span class="first-letter">O</span>din’s Eye could expose a target’s weakest point, and it was not like the Falsified-Sky Sutra. Han Sen had his own method of evaluating his opponents, though, through his Dongxuan Sutra. He used it trace his foe’s attacks and effectively block each one.</p>

Fighting Liu Meng was not easy. He was around the same level as Han Sen, and he was exceptionally talented. Since he was unable to break through Liu Meng’s defence, Han Sen knew victory would not come easy when it was his turn to attack.
...
One would attack and the other would defend. Their fighting skills were incredible, but it shocked the onlookers to see Liu Meng unable to penetrate Han Sen’s defence.
...
Both of them swapped between attack and defence many times, and a decisive victor seemed impossible to decide.
...
And after all that time had elapsed, neither had been able to inflict the slightest damage to the other. Their defences were impenetrable.
