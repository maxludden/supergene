# Chapter 1072: - Devil’s Realm {.hidden-title}

<section id="chapter-1072" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1072-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1072</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Devil’s Realm</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1072-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was shocked. The black mist grew to swallow the entire area. Inside, his Dongxuan Aura had been throttled, and its effective radius had been brought down to a mere ten meters.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Sacred-Blood Creature Ghost Fang killed. No beast soul gained. Consume its flesh to gain zero to ten sacred geno points randomly.”</em></p></section>
...
**“Look, you just need to know the danger you’re in. This place harbours countless creatures, ones that are all hungry. There are also cracks in this dimension,”** Dragon King explained more succinctly.
