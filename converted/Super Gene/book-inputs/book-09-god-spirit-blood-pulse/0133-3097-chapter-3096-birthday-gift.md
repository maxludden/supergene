# Chapter 3097: Birthday Gift {.hidden-title}

<section id="chapter-3097" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3097-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3097</p>
</section>
...
<section class="element chapter-text" id="chapter-3097-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter Han Sen told them his shop name, Feng Fei Fei thought it sounded familiar. But she paid in no true mind and did not make the connection.</p>
