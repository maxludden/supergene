# Chapter 3081: - Couldn’t Help It {.hidden-title}

<section id="chapter-3081" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3081-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3081</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Couldn’t Help It</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3081-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was finally aware of the reason why the bald man was staring at the water and not moving. Now that he looked at his reflection in the water, Han Sen only had one feeling</p>
