# Chapter 3071: - Night Cry Valley {.hidden-title}

<section id="chapter-3071" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3071-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3071</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Night Cry Valley</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3071-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen thought Night Cry Valley would not have had any people there for that place had eight sound bugs. The area had no land pulses, and eight sound bugs were difficult to catch. No one should have been there.</p>
...
Feng Fei Fei had come to Night Cry Valley for an eight sound bug. The eight sound bugs that had already hatched could not be perfectly tamed, but they could be used to create gene medicine that could moisturise the throat. For a singer, that was very good stuff.
...
The dark green body did not have scales, but it had many small lumps. It looked like a toad’s bumps. Seeing the big gecko come before the stone gap, the stone gap flashed with a red colour. Something emerged from it.
</section>
