# Chapter 3175: - Purple Mist That Comes from the East {.hidden-title}

<section id="chapter-3175" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3175-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3175</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Purple Mist That Comes from the East</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3175-text" markdown="1">
<p class="first2"><span class="first-letter">E</span>veryone chose to watch this fight because God of Wealth’s name had become rather outstanding in the fights. Three people from the same God Spirit had already reached the top 16. It was a magnificently rare achievement.</p>
