# Chapter 3204: - Sword Slashes Weapon God {.hidden-title}

<section id="chapter-3204" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3204-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3204</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Sword Slashes Weapon God</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3204-text" markdown="1">
<p class="first2"><span class="first-letter">A</span> snow-white spear flew out of the arsenal behind Weapon God. It landed in front of Weapon God. His two hands gripped the long spear. The long spear’s spear mind went into the sky. Han Sen and the others felt chills run down their spines as the mountains and fields around started to shake. Things were shattering everywhere. The spear-type weapons on the ground exploded with scary power. It released many spear lights that shocked the sky. They were all headed toward the long spear in Weapon God’s hands.</p>
...
Knives, spears, swords, halberds, axes, onoes, hooks, tridents, and various other weapons flickered with a shocking god light. The entire ocean of weapons that populated Soldier Knife Sky glowed with mesmerising light. All that light went to imbue the array of weaponry behind Weapon God.
...
The armour that Weapon God wore beneath that scary power underwent some changes. It turned pitch-black. Scary black flames were burning on it. It was like space was burning alongside it.
...
Han Sen looked cold. The Inch Grey Sword in his hands moved. He suddenly ripped space and made Weapon God’s giant armour-clad self be split in two.
