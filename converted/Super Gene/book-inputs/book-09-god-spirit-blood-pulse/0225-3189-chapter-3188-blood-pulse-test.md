# Chapter 3189: - Blood-Pulse Test {.hidden-title}

<section id="chapter-3189" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3189-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3189</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Blood-Pulse Test</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3189-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">P</span>ick your nose— Crawl like a dog— Pee like a dog—”** Bao’er was playing with the paper man. Rocky Dee was feeling grossly embarrassed.</p>
...
**“There is a treasure behind the god temple,”** Rocky Dee said. **“It is a treasure that belongs to the God Chaos Party. All you must do is put a drop of blood into that god item. The god item can then analyse your genes. It will trace you back to your very origin and find out where you were from. It can trace your ancestors.”**
