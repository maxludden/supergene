# Chapter 3075: - Treasure in the Box {.hidden-title}

<section id="chapter-3075" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3075-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3075</p>
</section>
...
<section class="element chapter-text" id="chapter-3075-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">R</span>obbery? From where could I have possibly stolen these things?”** Han Sen took out a silver mutant eight sound bug and tossed it to Mister Yang. Mister Yang picked up the eight sound bug egg and looked at it. His eyes almost popped out of his skull. **“Mister, did you really dig this up?”**</p>
...
Han Sen put many bags of blood inside the box. The blood colour of the patterns started to appear darker, and the petrifying light grew stronger. When there was only one bag of blood left, Han Sen suddenly heard a **“katcha”** noise. The stone box opened.
...
The stone box’s petrified light was gone. Han Sen touched the stone ocarina, sighed, and said, **“Little Big Sister Xiang Yin, where are you?”**
