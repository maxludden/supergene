# Chapter 3041: - Digging Egg {.hidden-title}

<section id="chapter-3041" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3041-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3041</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Digging Egg</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3041-text" markdown="1">
<p class="first2"><span class="first-letter">A</span> giant king class gene race overbearing bug was blown up by Han Sen in one punch. The shattered shell was scattered everywhere. It dyed the whole of the god temple red and scared everybody.</p>
