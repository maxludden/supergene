# Chapter 3160: - Breaking the World {.hidden-title}

<section id="chapter-3160" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3160-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3160</p>
</section>
...
<section class="element chapter-text" id="chapter-3160-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">B</span>reaking the world— Underworld Silhouette—”** Rocky Dee coldly shouted. The black flames on his body turned white. The flames were strong. There were like ice that could not be broken.</p>
