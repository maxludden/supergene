# Chapter 3164: - It Really Is Annihilation Class {.hidden-title}

<section id="chapter-3164" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3164-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3164</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- It Really Is Annihilation Class</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3164-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">L</span>ittle Yin, you have made Little Auntie very sad.”** Feng Fei Fei’s eyes were so red that tears were about to flow.</p>
...
Feng Yin Yin had been too pushy. She only recognised that now. She quickly showed her God Spirit mark off.
...
An inheritor Blood-Pulse was very important. It did not just benefit one person. The children and grandchildren would also have this honour.
