# Chapter 3018: - No. 1 General {.hidden-title}

<section id="chapter-3018" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3018-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3018</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- No. 1 General</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3018-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">S</span>acred’s first general, Purple Fight, I have heard of your name,”** Shadow God coldly said upon seeing Purple Fight. **“What a shame— All you have left is just your mind now.”**</p>
...
True dragon, Phoenix, Qilin, Fish bird. All kinds of creatures from all sorts of legends kept appearing in the dark. All of them had a scary presence. They did not look like shadows.
