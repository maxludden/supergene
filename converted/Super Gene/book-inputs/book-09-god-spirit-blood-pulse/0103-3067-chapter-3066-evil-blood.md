# Chapter 3067: - Evil Blood {.hidden-title}

<section id="chapter-3067" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3067-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3067</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Evil Blood</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3067-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>ang Qi Yuan was so fast that he could have killed Jian Bu Gu’s. To him, this had been a very rare opportunity.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Successfully combined with the blood ghost spirit. Got gene to combine skill Evil Blood.”</em></p></section>
