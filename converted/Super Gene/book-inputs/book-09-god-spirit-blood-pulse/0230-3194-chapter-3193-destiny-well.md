# Chapter 3194: - Destiny Well {.hidden-title}

<section id="chapter-3194" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3194-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3194</p>
</section>
...
<section class="element chapter-text" id="chapter-3194-text" markdown="1">
<p class="first2"><span class="first-letter">Q</span>in Bai pulled Han Sen away from the doors of the Feng family castle and asked, **“Han Sen, why have you come looking for me?.”**</p>
