# Chapter 2994: - United {.hidden-title}

<section id="chapter-2994" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2994-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2994</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- United</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2994-text" markdown="1">
<p class="first2"><span class="first-letter">R</span>ain slid down the roof. It landed on a stone board and created some bubbles.</p>
...
The rain was too much. The umbrella was very low, so one was not able to see what the red-clothed woman looked like. Yet her ridiculously curvy body and long black hair, which looked like a waterfall, were very eye-catching. One may not have been able to see her face, but one could recognise her.
