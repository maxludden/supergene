# Chapter 3038: - Lotus God Temple {.hidden-title}

<section id="chapter-3038" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3038-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3038</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Lotus God Temple</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3038-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen wanted to explain he was not Mister Yang, but Mister Yang walked in, bowed to Han Sen, and said, **“Mister, there is something wrong in the garden. You should go take a look.”**</p>
...
That made Han Sen think about a lot of things. The anti-material world was a world based on humans, and the geno universe did not have any humans. Until Qin Xiu entered the geno universe and had the Crystallisers combine with his genes, there were not any there. It was only after that was done did humans start appearing in the geno sanctuaries.
