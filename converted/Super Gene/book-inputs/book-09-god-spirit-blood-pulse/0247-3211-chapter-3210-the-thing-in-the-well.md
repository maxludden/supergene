# Chapter 3211: - The Thing in the Well {.hidden-title}

<section id="chapter-3211" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3211-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3211</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Thing in the Well</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3211-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>here was fear in the young lady’s eyes, but she still listened to the priest and went toward the Destiny Well. At this time, the blood spring in the Destiny Well was almost gone. The priest shouted at the girl, **“Do not be afraid! Just use the same method that I have always taught you! It will be fine!”**</p>
