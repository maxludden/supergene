# Chapter 3079: - Holy Light Salamander {.hidden-title}

<section id="chapter-3079" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3079-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3079</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Holy Light Salamander</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3079-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen felt quite tempted after hearing that. **“What is that gene race called?”**</p>
...
**“Mister Jian, in the top-class gene races, are there are any gene races that have blue blood?”** Ever since Han Sen had reached the universe of kingdoms, he realised the humans there did not train their bodies. Their blood was red.
