# Chapter 3116: - Teacher Jian Bu Gu {.hidden-title}

<section id="chapter-3116" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3116-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3116</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Teacher Jian Bu Gu</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3116-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>housand Mile Reach was very shocked. He almost forgot the way out while leaving Feng Castle.</p>
