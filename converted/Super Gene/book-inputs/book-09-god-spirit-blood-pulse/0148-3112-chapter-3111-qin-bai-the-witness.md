# Chapter 3112: - Qin Bai the Witness {.hidden-title}

<section id="chapter-3112" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3112-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3112</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Qin Bai the Witness</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3112-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>teel Scene was murdered inside Ice Snow God Temple. Gong Shu Zhi, Si Tu Ya, and Lu San Zhi were murdered inside Ice Snow City’s Steel Manor. The news was heard all over Jade Wall City.</p>
