# Chapter 3106: - The Loser Crown Prince {.hidden-title}

<section id="chapter-3106" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3106-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3106</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Loser Crown Prince</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3106-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">M</span>ister Crown Prince.”** Lu San Zhi saw the young man and was shocked. He quickly jumped off of the male lion and kneeled before the crown prince.</p>
...
**“Mister Crown Prince, this has to be sorted out sooner or later,”** Han Sen said. **“If you keep navigating around the issue, it only delays what is inevitable. I do not need to go to the palace, but can I ask you for a favour?”**
