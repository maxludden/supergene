# Chapter 3055: - Trapped in Jade Lion Valley {.hidden-title}

<section id="chapter-3055" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3055-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3055</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Trapped in Jade Lion Valley</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3055-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he king class Jade Lion king was not scary to Peaceful and the others, even if the Jade Lion king was already an adult. It was just a strong king class gene race.</p>
...
Everyone realised that the purple-haired monkey’s speed was faster than that of the wind-winged snake’s combined with Ouyang Qiu Shan. It feigned weakness earlier to lure them to Jade Lion valley.
