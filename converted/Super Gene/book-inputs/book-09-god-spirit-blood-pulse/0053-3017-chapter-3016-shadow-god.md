# Chapter 3017: - Shadow God {.hidden-title}

<section id="chapter-3017" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3017-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3017</p>
</section>
...
<section class="element chapter-text" id="chapter-3017-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">S</span>acred’s remnants, come out and die!”** A godly voice echoed throughout space. The ice walls of the ice bunker’s laboratory exploded. The tools were breaking and falling apart.</p>
