# Chapter 3099: - Saving People {.hidden-title}

<section id="chapter-3099" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3099-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3099</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Saving People</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3099-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>eng Fei Fei was one of the three top singers. She was very powerful. All of the party guests were high-class people, but many people were injured by her sonic blast. People were using their gene-class powers to try and help her, but all attempts were futile. Her body was like a sonic tide. She had a phoenix’s body to protect her, but that meant no other powers could come close.</p>
