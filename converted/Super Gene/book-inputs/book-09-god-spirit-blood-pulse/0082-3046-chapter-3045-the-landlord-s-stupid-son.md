# Chapter 3046: - The Landlord’s Stupid Son {.hidden-title}

<section id="chapter-3046" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3046-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3046</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Landlord’s Stupid Son</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3046-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>ho would have suspected that Han Sen’s reaction would end up surprising Mister Yang? He was not angry. He actually laughed.</p>
