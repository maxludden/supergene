# Chapter 3159: - Death Silhouette {.hidden-title}

<section id="chapter-3159" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3159-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3159</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Death Silhouette</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3159-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>he Crystallisers were powerful, but they were not strong enough to overcome reincarnation. How were they connected to the God Chaos Party?”** Han Sen wondered. He could not figure out why.</p>
...
Upon looking closer, one noticed Death Silhouette was the side of Han Sen’s face. Even though it was just a black shadow, there was no face or emotion displayed. Anyone who knew Han Sen would be able to recognise it was him.
