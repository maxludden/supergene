# Chapter 3147: - God of Wealth Temple {.hidden-title}

<section id="chapter-3147" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3147-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3147</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- God of Wealth Temple</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3147-text" markdown="1">
<p class="first2"><span class="first-letter">P</span>icking the right human to give a Blood-Pulse to was like venture capitalising. It depended on whether or not one had good eyesight. One also needed variety. If one or two humans were able to develop quite well in the future, benefits could be reaped.</p>
...
For things like god temples, once one was established in a place, it could no longer be moved. An example was Feather Fairy’s god temple. Almost no humans travelled there, but Feather Fairy had to stay where he was. He was unable to relocate his temple, so he had to make do with where it was.
...
Because a default god temple only had one god base, it could only allow one God Spirit. If there were more god bases, a god temple could harbour more God Spirits. The higher the level the god temples were, the more God Spirits that it could have.
