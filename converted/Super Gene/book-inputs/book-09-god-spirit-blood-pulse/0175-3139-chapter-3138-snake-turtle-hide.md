# Chapter 3139: - Snake Turtle Hide {.hidden-title}

<section id="chapter-3139" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3139-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3139</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Snake Turtle Hide</h1>
</section>
</section>
</section>
</section>
...
**“If things are indeed like that, then let’s not dig up anything.”** Sky King understood. He ordered people to replant their excavation efforts and avoid any area that resided within 300 miles of the river.
