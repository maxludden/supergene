# Chapter 1911: - Green Ligh {.hidden-title}

<section id="chapter-1911" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1911-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1911</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Green Ligh</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1911-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen found a hidden place in Red Mist Valley. He was going to wait for the spring to burst.</p>
...
**“I’ll have to try. Luckily, it is just a Viscount xenogeneic. It cannot be that large of a threat.”** Han Sen donned his Marquise armour and the rabbit shoes. He flew past the heads of the xenogeneics and headed straight into the valley.
...
Han Sen kept running his hands over it, and eventually, he realised there was a space next to it. It was a cave.

Han Sen thought he was adequately protected, with the Marquise armour and the rabbit shoes, so he entered the cave.
...
**“It’s lucky I have this Marquise armour. A light like this looks Viscount level at the lowest,”** Han Sen thought to himself. He drew his Ghost Teeth Knife, and with his ice powers and blood, he cut towards the light.
...
Han Sen then realised he could no longer move. It was as if he had been stopped by a strange power. He was stuck in the same position, unable to move.
...
Han Sen fired up Jade-skin, the Blood-Pulse Sutra, the Dongxuan Sutra, and The Story of Genes, but still, he was unable to escape the green light.
