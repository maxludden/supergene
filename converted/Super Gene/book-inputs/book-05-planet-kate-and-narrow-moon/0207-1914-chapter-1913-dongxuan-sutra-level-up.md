# Chapter 1914: - Dongxuan Sutra Level Up {.hidden-title}

<section id="chapter-1914" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1914-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1914</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Dongxuan Sutra Level Up</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1914-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he centipede opened its mouth to eat the little mink. It suddenly stopped, though, and it turned to look behind itself. Tap! Tap! Tap!</p>

Han Sen’s body was jerking like a poorly-built robot as he slowly approached.

The centipede released a weird shriek. And then, the eyes on its back started shooting out more green light. Its body manoeuvred into a semi-circle as it did this.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Viscount xenogeneic hunted: Evil-Eye Dragon. Xenogeneic Gene found.”</em></p></section>

Han Sen thought that was a bit of a shame. He hadn’t gotten a beast soul that wielded that wicked power. But even so, levelling up his Dongxuan Sutra through this battle was more than enough.
