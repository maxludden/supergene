# Chapter 2043: - Battle in the Dragon Pool {.hidden-title}

<section id="chapter-2043" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2043-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2043</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Battle in the Dragon Pool</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2043-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen only noticed now that the helmet on the seat turtle statue had a circular, plate-sized slot in the top.</p>
...
The Spiky Turtle King’s black diamond shell began to shine. Then, the entire statue started to shine with that same black light, too. The blue statue slowly turned black, and the turtle’s hammers transformed into black crystals. A life-force began to radiate from them.
...
And then, an angry beast appeared. It had blue scales, and it possessed the head of a dragon. Its body, however, was like a Qilin’s. It was glowing blue. It wasn’t like a monster, overall; it was more like a holy beast.
...
The Dragon God roared. Its blue presence struck the hammer with earthquake force.
...
The scary power flew wildly throughout Return Ruin Sea. Even underwater, Han Sen could feel the surges of power. Waves rose to heights of a hundred meters, and lots of water was vaporised.
</section>
