# Chapter 1872: - Cave {.hidden-title}

<section id="chapter-1872" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1872-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1872</p>
</section>
...
<section class="element chapter-text" id="chapter-1872-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span> want to go to Planet Crooked Rock,”** Han Sen told Ice-bird Duke.</p>
