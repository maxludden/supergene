# Chapter 1934: - Magic {.hidden-title}

<section id="chapter-1934" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1934-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1934</p>
</section>
...
<section class="element chapter-text" id="chapter-1934-text" markdown="1">
<p class="first2"><span class="first-letter">M</span>oon Wheel King was right. Han Sen’s Moon only had thirty percent of his own gentle power, and that was because Han Sen’s Dongxuan Sutra had only been able to simulate thirty percent.</p>
