# Chapter 2167: - Returning to Narrow-Moon {.hidden-title}

<section id="chapter-2167" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2167-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2167</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Returning to Narrow-Moon</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2167-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen sat on a ship departing Sky Palace, bound for Narrow Moon. He hadn’t been allowed to take half of the ocean mountain with him, but the Sky Palace leader permitted him to keep a bunch of ocean stones.</p>
...
Han Sen had a look at the ocean stone bug. After Bao’er annoyed it for a while, it stopped moving and played dead. It realised that the more it resisted, the happier Bao’er would become.
...
Its life-force was not very strong, so Han Sen was unsure how it had managed to break the ocean mountain as it had.
...
The bone knife looked even stronger after that. Its red colour had grown even darker.
