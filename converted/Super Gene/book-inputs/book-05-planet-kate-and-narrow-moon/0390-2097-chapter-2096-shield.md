# Chapter 2097: - Shield {.hidden-title}

<section id="chapter-2097" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2097-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2097</p>
</section>
...
<section class="element chapter-text" id="chapter-2097-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">L</span>et’s see how many attacks you can block,”** Sleepless Duke shouted. The other Night Ghosts began to cackle, gathering up a force of ghost air.</p>
...
Sleepless Duke had a plan. She needed to take Han Sen and Lone Bamboo as hostages. If she did that, she’d have an even easier time getting through Sky Palace’s defences.
...
When the ghost air landed, the entire base was annihilated. The construct was practically vaporised.
...
The blue shield around Han Sen was like a God-light. It continued to encase Han Sen, unwavering in the slightest.
...
**“Sacrifice blood to the spear. The higher quality the blood and the more you offer, the stronger it becomes. If there's enough blood, it is not too difficult to muster a King class attack,”** Kahn said.
