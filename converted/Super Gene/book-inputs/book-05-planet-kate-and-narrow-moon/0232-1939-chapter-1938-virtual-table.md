# Chapter 1939: - Virtual Table {.hidden-title}

<section id="chapter-1939" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1939-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1939</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Virtual Table</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1939-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>eeing how shocked Han Sen looked, Hai’er took his reaction for a confirmation. She then murmured, **“We shouldn’t talk here. We should find someplace else to chat.”**</p>
