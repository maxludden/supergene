# Chapter 2052: - Blowing Up a Planet with One Hand {.hidden-title}

<section id="chapter-2052" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2052-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2052</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Blowing Up a Planet with One Hand</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2052-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">Y</span>ou are Han Sen?”** The shura queen asked when she saw Han Sen without armour. She recognised him.</p>
...
**“You came here, didn’t you? That means you already believe me.”** Han Sen smiled, and he then went on to say, **“The Battle of Franco, the Assault on Heilman’s, the Strike on 4,690; they can flip the situation of the shura on its head. Can you actually sort out these problems?”**
...
The shura queen started to look concerned. She picked up the phone and dialled a number.
