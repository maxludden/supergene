# Chapter 2002: - Rare Beast Island {.hidden-title}

<section id="chapter-2002" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2002-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2002</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Rare Beast Island</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2002-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter that fight, Sky Palace students frequently debated whether Han Sen or Lone Bamboo was stronger. The discussions never yielded any answers, though.</p>
...
The next few rounds of the exam offered no trouble. He won every match and achieved first place in the Earl class exams. He received permission to visit the holy house, and there, he found the Under the Sky knife-skill.

He was also the recipient of more Fenghou Pills and a Marquise treasure for a prize.

Han Sen’s name was famous in Sky Palace, but he cared little for the recognition. He focused on practising his knife-skills at home.
...
After Han Sen took the scroll, he quickly learned the knife-skill. And just as expected, with his Heavenly Go, Dongxuan Sutra, and Sky Palace as a base, it was easy to get comfortable with. He improved a lot in just a few days.

**“This knife-skill has a significant flaw. It is not because Yun Suyi performed it incorrectly.”** After Han Sen practised with it himself, he quickly discovered the problem.
...
**“If I’m known to hold this knife-skill, when I use the Dongxuan Sutra and Heavenly Go, people will believe I’m using Under the Sky. If I’m careful, Yisha won’t think I am Dollar.”** Han Sen wanted this skill badly, and that was one of the reasons why.
...
Han Sen went to the seventh floor of the White Jade Building. He did not see Yun Suyi, so he settled for absorbing the Jade Air and levelling up his Jade-skin.
...
His armour had been exchanged for a new set that looked incredibly valuable, and he was also decorated with an array of jewellery. He looked very powerful.
