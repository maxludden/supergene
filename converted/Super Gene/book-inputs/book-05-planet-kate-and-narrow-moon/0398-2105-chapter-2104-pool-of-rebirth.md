# Chapter 2105: - Pool of Rebirth {.hidden-title}

<section id="chapter-2105" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2105-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2105</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Pool of Rebirth</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2105-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>oly Heaven’s Pool of Rebirth was one of the most famous pools in the geno universe. Very few items existed that could help Kings level up, but Pool of Rebirth was one of them.</p>
...
They both looked like Feathers, with faces reminiscent of marble statues, and their life-forces were Marquise level. But just feeling their presence, Han Sen knew immediately that something was amiss. He did not believe for one second that they were truly Marquises, plain and simple.
