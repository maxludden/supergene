# Chapter 1883: - The Kings Break God-light {.hidden-title}

<section id="chapter-1883" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1883-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1883</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Kings Break God-light</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1883-text" markdown="1">
<p class="first2">*&lt;!-- <span class="first-letter">s</span>ource: strong.calibre4 --&gt;</p>
**<!-- source: span.dropcap -->
Chapter 1882: The Kings Break God-light***
...
The same thing occurred to the monk as it did the other Kings, too. The God-light could not be broken.
...
If they were unable to break the Goddess statue’s God-light, the power gap between a deified being and a King must have been rather large.
...
Guna hummed and said, **“Yes. The other way is what the Kings are attempting. Break the God-light and take control of Purgatory Heaven the hard way; only then can you stop it.”**
