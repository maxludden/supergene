# Chapter 1813: - A Rod {.hidden-title}

<section id="chapter-1813" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1813-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1813</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- A Rod</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1813-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>ithout hesitation, Han Sen walked right up to the crystal sphere.</p>
