# Chapter 1887: - I Make the Calls {.hidden-title}

<section id="chapter-1887" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1887-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1887</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- I Make the Calls</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1887-text" markdown="1">
<p class="first2"><span class="first-letter">G</span>uya looked at Buddha King. The clouds that trapped Buddha King rose up and drifted over to her.</p>
...
**“Kill them, and you will be considered one of us.”** Guya pointed at Gold Jade King, Giant King, and the others.
