# Chapter 1897: - The Possibility of Levelling Up {.hidden-title}

<section id="chapter-1897" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1897-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1897</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Possibility of Levelling Up</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1897-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span> don’t know,”** Han Sen said quietly.</p>
...
His Spell geno armament had been difficult to develop. It required an external sort of power for that to occur. If he tried to level it through solo practise, it’d be a slow process. It’d probably take him a hundred years to get it up to Viscount class through training alone.

That wasn’t about Han Sen performing poorly, though. It was because The Story of Genes was not for humans. It was extremely unlikely that Han Sen had been able to practise it in the first place.
...
Han Sen confirmed he’d go, despite his total lack of enthusiasm in it. He began practising Yin Yang Change right away, though.
...
With Yin Yang Blast as a base, he could easily learn how to take advantage of Yin Yang Change. He would only need a bit of practise before using it.
...
Yisha thought the Red Mist Spring would make itself apparent in around forty days. So, Han Sen had plenty of time to practise.
...
**“It is because Queen is great and her knife skills are the best. She practises the strongest Teeth Knife of the Rebate. I really want to be like her, so that is why I want to obey her,”** Qing Li said in explanation.
...
**“I will write a few words for you, and then you can go practise them. If you can write them down exactly the same, I will take you as my student.”** Han Sen said that, and then brought out a wooden board. He used his fingers to write down a few words, and then gave her the board.
</section>
