# Chapter 1726: - Qiao {.hidden-title}

<section id="chapter-1726" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1726-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1726</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Qiao</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1726-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen quickly found out that Hardman was loaning him out to a hunting group called Wizard.</p>
