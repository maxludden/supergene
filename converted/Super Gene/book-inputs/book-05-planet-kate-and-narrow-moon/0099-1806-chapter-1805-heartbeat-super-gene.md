# Chapter 1806: - Heartbeat Super Gene {.hidden-title}

<section id="chapter-1806" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1806-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1806</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Heartbeat Super Gene</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1806-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he little monster grunted at Han Sen and Yisha, wanting them to go inside quickly.</p>
...
**“Yeah, someone from a small race no one has heard of before. Come on, how can you expect him to command those of a recognised higher race?”** The bird-faced man looked at Han Sen with disdain.
