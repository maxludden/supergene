# Chapter 2049: - Planet Sky Cloud {.hidden-title}

<section id="chapter-2049" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2049-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2049</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Planet Sky Cloud</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2049-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen lifted his hand toward Jade Ming’er. Jade Ming’er’s body was instantly bound and lifted toward Han Sen—</p>
...
Planet Sky Cloud was a planet that both humans and shura lived on. It was a lawless place, and risky businessmen frequently travelled there. And with the savage natives of Planet Sky Cloud, that place was known to be very dangerous.
