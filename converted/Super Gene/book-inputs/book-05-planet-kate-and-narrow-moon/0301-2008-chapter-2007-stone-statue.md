# Chapter 2008: - Stone Statue {.hidden-title}

<section id="chapter-2008" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2008-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2008</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Stone Statue</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2008-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen didn’t like doing it, but he still ran inside the valley. The speed of the rabbit shoes quickly brought him beneath the little valley’s tree.</p>

Han Sen leapt atop the tree, using the Dongxuan Aura to look inside the hole. He noticed that it was quite spacious within and that most of the tree was hollow.

However, there was no life-force or treasure to be seen.
...
The statue was green and black, so he couldn’t tell what its original colour might have been. But it was of a man sitting.
...
Eventually, it seemed to realise that its herd was gone. It hesitated, wondering if it should continue chasing Han Sen, and it slowed down a touch.
