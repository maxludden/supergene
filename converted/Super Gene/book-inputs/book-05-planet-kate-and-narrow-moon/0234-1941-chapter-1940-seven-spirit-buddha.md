# Chapter 1941: - Seven Spirit Buddha {.hidden-title}

<section id="chapter-1941" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1941-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1941</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Seven Spirit Buddha</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1941-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen didn’t bother to contradict her again. He followed the big group across the desert.</p>
...
**“Stop playing,”** Hai’er said with an eye-roll, but then she realised that Han Sen was already running off.
...
’You recognise him?” Han Sen asked.
