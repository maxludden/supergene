# Chapter 2045: - Dragon Corpse {.hidden-title}

<section id="chapter-2045" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2045-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2045</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Dragon Corpse</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2045-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he battle continued to rage upon the surface of the sea. Fortunately, it had little effect on the ocean depths.</p>
...
That evil Crystalliser might still be around. How about I stay here and you go for help?” Long Ying did not want to leave Dragon Fifteen unprotected.
...
But when he grabbed the scale by its edges, he was unable to remove it. Dragon God was dead, and its life-force was gone. The flesh had certainly weakened. But even so, it seemed that a Marquise would have difficulty removing the Upside-Down Scale.
