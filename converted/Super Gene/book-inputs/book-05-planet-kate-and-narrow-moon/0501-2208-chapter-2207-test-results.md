# Chapter 2208: - Test Results {.hidden-title}

<section id="chapter-2208" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2208-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2208</p>
</section>
...
<section class="element chapter-text" id="chapter-2208-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he final test was the geno tree. Han Sen stood before it and cut his finger. He let a droplet of blood fall onto the geno tree.</p>
...
Han Sen’s Blood-Pulse Sutra could change the messaging of genes, but Burning Lamp Alpha’s geno art was quite different. The Blood-Pulse Sutra primarily controlled its own genes. It couldn’t change the genes of another creature, like Burning Lamp Alpha’s shape-shifting technique.
...
Han Sen had trained in Sky Palace, fought the greatest Marquise there, and been labelled the knife and sword master; there was no way he only possessed ten thousand flowers of strength.
