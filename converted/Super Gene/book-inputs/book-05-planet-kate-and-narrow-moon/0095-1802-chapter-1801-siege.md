# Chapter 1802: - Siege {.hidden-title}

<section id="chapter-1802" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1802-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1802</p>
</section>
...
<section class="element chapter-text" id="chapter-1802-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen touched the scabbard and picked it up. It felt comfortable in his palm, but it was quiet like it was dead. There was nothing more special about it.</p>
