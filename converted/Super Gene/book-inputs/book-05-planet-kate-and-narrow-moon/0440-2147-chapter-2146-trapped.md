# Chapter 2147: - Trapped {.hidden-title}

<section id="chapter-2147" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2147-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2147</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Trapped</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2147-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen let Kahn into the camp so they could continue their discussion. Kahn spoke without preamble. **“You might not believe me when I tell you this, but we are all trapped on this world.”**</p>
...
In the meantime, Kahn explained more of how the planet had been found. The Demon and the Buddha were the first ones to discover Metal World. A battle had drawn them into that rarely-travelled region of space, and as they fought, they stumbled across the hidden planet.
...
It was only after the Marquises landed on the planet that they realised how dangerous the place was. And it was also then that they discovered they were unable to leave.
