# Chapter 1795: - Chaos {.hidden-title}

<section id="chapter-1795" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1795-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1795</p>
</section>
...
<section class="element chapter-text" id="chapter-1795-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen frowned, but he didn’t have much of an opinion about Mister Ji breaking promises.</p>
