# Chapter 2054: - Path {.hidden-title}

<section id="chapter-2054" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2054-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2054</p>
</section>
...
<section class="element chapter-text" id="chapter-2054-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he shura queen walked to the altar and stood before the shura coffin. After bowing sincerely before it, she drew a dagger and stabbed at the head of the coffin.</p>
