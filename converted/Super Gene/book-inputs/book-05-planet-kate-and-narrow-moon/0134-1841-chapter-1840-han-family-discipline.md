# Chapter 1841: - Han Family Discipline {.hidden-title}

<section id="chapter-1841" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1841-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1841</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Han Family Discipline</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1841-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he sixth day after their arrival to the base, Han Sen summoned everyone to a plaza.</p>
...
The Viscounts and Barons looked enraged. It didn’t take long for them to realise that being a servant meant they would not receive any preferential treatment. Aside from a place to live, everything cost money.
...
**“Mister Han, what kind of rules are these? We were brought here to be managers. We didn’t sign up for hard labour!”**
