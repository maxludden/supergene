# Chapter 2164: - The Secret of the Ocean Stones {.hidden-title}

<section id="chapter-2164" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2164-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2164</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Secret of the Ocean Stones</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2164-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen looked at the ocean mountain with his right eye. Under the effects of the Purple Eye Butterfly beast soul, the history of the ocean mountain played across his right eye like a movie.</p>
...
When the stone was completely black, the stone bug leapt back into the lava, then rolled and swam through it again.
...
**“Yeah, but what sort of poem or drawing? Have you forgotten that Han Sen uses weapons? I think he is going to leave behind a knife-mark. Think about it. If Teacher Han Sen left behind a deep knife-mark with the sensations of his skills, then we could study it, and our students might become better at knife-skills. Wouldn’t that be a nice thing?”**

**“You are right. But if that is the case, then leaving behind a sword-mind might be even better.”**
...
**“Han Sen has never seemed to seek fame. He will probably just leave his name or a simple knife-mark behind,”** Thousand Feather Crane said.
