# Chapter 2021: - Dream {.hidden-title}

<section id="chapter-2021" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2021-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2021</p>
</section>
...
<section class="element chapter-text" id="chapter-2021-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>abits could be very scary things. Han Sen had been on Dream Island for three months now, and he had grown used to having two Sky Heart Locks on his body.</p>
