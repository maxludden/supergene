# Chapter 2074: - Absolute Container {.hidden-title}

<section id="chapter-2074" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2074-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2074</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Absolute Container</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2074-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>here are the items you sucked into it? Can I see them?”** Han Sen asked Bao’er happily.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Marquise Gene +1.”</em></p></section>
...
Han Sen had nothing to do, so he practised with his Jade-skin. He also watched the refinement process for the Blood Feather Knife. He learned a lot.
...
As the temperature dropped, the Blood Feather Knife looked like it was being crystallised. In the end, the entire knife appeared to be entirely crystal, just like the container itself.
