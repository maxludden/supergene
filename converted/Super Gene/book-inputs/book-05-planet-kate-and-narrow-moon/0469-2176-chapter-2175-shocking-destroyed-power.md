# Chapter 2176: - Shocking Destroyed Power {.hidden-title}

<section id="chapter-2176" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2176-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2176</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Shocking Destroyed Power</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2176-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>arr’s hand came into contact with the tip of the arrow, and the expressions on Barr’s faces hardened. A black light that looked indestructible cloaked his hand, and it looked like the arrow would shatter against it.</p>
...
When that scary power faded away, the black light went with it. Qing Li and the others could see that the bone armour Barr had worn was now all gone. His big body was exposed.
