# Chapter 2056: - Returning to the Return Ruin Sea {.hidden-title}

<section id="chapter-2056" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2056-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2056</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Returning to the Return Ruin Sea</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2056-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen’s power was enough to compare with a Marquise due to the dragon wing buffs and Break Space Flash. Those two abilities made Han Sen far stronger.</p>
...
With this realisation, Han Sen felt relieved. He decided to rest at home for another two days before going back to the Return Ruin Sea.

**“Remember me. Little-flower and Ling’er need you,”** Ji Yanran said before Han Sen left, holding him tight.
...
They were Dragons, but Han Sen did not see Dragon Fifteen or Long Ying amongst them. They were unfamiliar to him, aside from Xius, who he recognised.
