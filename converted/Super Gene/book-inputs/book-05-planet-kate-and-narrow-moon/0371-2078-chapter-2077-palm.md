# Chapter 2078: - Palm {.hidden-title}

<section id="chapter-2078" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2078-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2078</p>
</section>
...
<section class="element chapter-text" id="chapter-2078-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>ack on Planet Eclipse, Han Sen opened the box and found a small data card inside.</p>
