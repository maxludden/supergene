# Chapter 1728: - Who Reaps the Benefits {.hidden-title}

<section id="chapter-1728" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1728-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1728</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Who Reaps the Benefits</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1728-text" markdown="1">
<p class="first2"><span class="first-letter">A</span> train’s horn cracked the air, while powerful aircraft flew through the sky above.</p>
...
As they discussed this, two people dismounted an armoured truck and approached them.
...
Hardman shook his head and returned to the armoured truck. Guris was inside commanding the operation.
...
Now Han Sen had done them a favour by luring the xenogeneic into action. And now that it was in their sights, Mister Tiger was running over. He was only a mile away.
