# Chapter 1909: - Crystalliser {.hidden-title}

<section id="chapter-1909" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1909-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1909</p>
</section>
...
<section class="element chapter-text" id="chapter-1909-text" markdown="1">
<p class="first2"><span class="first-letter">Q</span>uickly, Han Sen noticed he was able to read the text contained within the diary. It was written in the ancient language of humans—a text often used by the Crystallisers. There were, however, a variety of symbols not even he could understand. All-in-all, he didn’t understand everything together.</p>
...
When the man didn’t object to Han Sen’s behaviour, it made Han Sen feel safe enough to relax a little. So, he continued reading the diary. It must have been a draught of sorts. There were many random things jotted down.
...
This was what Han Sen had retrieved from the Main Control Room of the Crystallisers. Ever since that time, he hadn’t found a single thing associated with the book.

Not even Stay Up Late knew where The Story of Genes came from. He read it, shook his head, and thought it must be a prank. No one could use The Story of Genes, or even practise it. It was not something any creature could learn.
...
Aside from the standard content, there were actually many notes explaining things. But they weren’t related to how you’d actually practise with the text. The notes were of a scientific nature.

Han Sen read it all seriously, right up until he reached the end.

The content, from back to front, was the same as his own The Story of Genes. There was, however, an additional page. That page had nothing to do with how to practise the work, though. It was a summary.
...
There was something else he understood, too. **“Cannot figure out the requirements for practise. The Story of Genes theory does not make sense. Can I not create a god?”**
...
The man said, **“Scientific research is all about simplifying the complicated things. You can let those other fools worry about science itself. This is a geno art I created, through the theory of rock creatures. Ordinary Crystallisers can practise it.”**
