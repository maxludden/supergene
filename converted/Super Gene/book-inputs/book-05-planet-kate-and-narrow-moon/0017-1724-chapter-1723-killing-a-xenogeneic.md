# Chapter 1724: - Killing a Xenogeneic {.hidden-title}

<section id="chapter-1724" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1724-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1724</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Killing a Xenogeneic</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1724-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">C</span>ommander, where should I lead it?”** Han Sen asked calmly.</p>
...
As soon as he said it, Guris realised that was one of the strangest commands he had ever given. It was odd telling a soldier to keep a xenogeneic busy for some time. People would think he was crazy for issuing such an order, but he had no choice, given the circumstances.
...
As Han Sen had led the xenogeneic forward, he had punched the creature many times. None of his hits were effective, though. The xenogeneic did not have geno armour, but it was far stronger than an armoured Kate. As a result, Han Sen could not deal any damage to the creature’s body.

After Han Sen evaded the next strike of the xenogeneic, he put the glove on his hand.

In the Alliance, Han Sen hadn’t been able to use the Northern King Glove while wearing armour because he hadn’t possessed his own geno armour. Now that he had generated his own set of armour, this was no longer a problem. So, Han Sen was able to put the glove on his right hand and make it look something more like a gauntlet.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Xenogeneic Baron hunted; xenogeneic gene found.”</em></p></section>
...
Before he had the time to think about what happened with the tattoo, though, Han Sen leapt over to the creature and pulled out its ten nails. The nails were where the thing had mutated.
