# Chapter 1767: - Siege {.hidden-title}

<section id="chapter-1767" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1767-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1767</p>
</section>
...
<section class="element chapter-text" id="chapter-1767-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>hat’s with that guy? Could he not understand our language?”** Han Sen had encountered rude people before, but none that were rude to that extent.</p>
