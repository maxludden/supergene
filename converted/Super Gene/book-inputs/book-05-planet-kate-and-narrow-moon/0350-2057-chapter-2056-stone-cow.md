# Chapter 2057: - Stone Cow {.hidden-title}

<section id="chapter-2057" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2057-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2057</p>
</section>
...
<section class="element chapter-text" id="chapter-2057-text" markdown="1">
<p class="first2"><span class="first-letter">X</span>ius and the Dragon lady did not lower their voices, so Han Sen could hear everything they said clearly.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Xenogeneic Marquise hunted. Rock Shark: xenogeneic gene found. Obtained Rock Shark beast soul.”</em></p></section>
...
Han Sen kept rubbing against her, recalling the behaviour of Little Silver and Little Star. He thought about them for tips on how a creature should behave if it wanted to be cute.
