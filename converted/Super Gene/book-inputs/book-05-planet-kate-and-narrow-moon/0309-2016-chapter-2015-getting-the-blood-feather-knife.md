# Chapter 2016: - Getting the Blood Feather Knife {.hidden-title}

<section id="chapter-2016" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2016-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2016</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Getting the Blood Feather Knife</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2016-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">H</span>an Sen!”** Yun Sushang said suddenly.</p>
...
**“Of course. Sister Yun’s knife-skill is strong, and so the knife is yours.”** Angia forced a smile and passed the box to Yun Suyi.
...
The other students started to leave, too. They also wished to know if Under the Sky had truly been fixed. If that was true, then Sky Palace had another exclusive knife-skill.
