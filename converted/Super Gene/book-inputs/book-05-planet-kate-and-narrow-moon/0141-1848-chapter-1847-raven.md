# Chapter 1848: - Raven {.hidden-title}

<section id="chapter-1848" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1848-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1848</p>
</section>
...
<section class="element chapter-text" id="chapter-1848-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>nside the base, people continued to become infected. Han Sen wanted to leave, taking Little Angel, Zero, and the others with him. But he was not sure if the strange contagion had already spread to his companions. If he left now, with an infection amongst them, things could turn pretty bleak.</p>
