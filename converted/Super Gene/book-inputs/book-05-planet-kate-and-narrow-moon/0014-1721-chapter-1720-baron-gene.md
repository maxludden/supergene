# Chapter 1721: - Baron Gene {.hidden-title}

<section id="chapter-1721" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1721-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1721</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Baron Gene</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1721-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>here was a problem generating my geno armour. This is a medicine that should help, and so I am heating it up,”** Han Sen said.</p>
...
Han Sen lifted the entire cooker and pot, and then he gulped it all down like a pool of soup.
...
His Spell armour, as he had begun calling it, didn’t seem to improve. That surprised him.

Xenogeneic genes only increased the strength of Han Sen’s actual body. They didn’t improve his Spell armour.
