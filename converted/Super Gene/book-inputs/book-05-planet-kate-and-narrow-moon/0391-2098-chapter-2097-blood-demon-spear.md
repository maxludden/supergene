# Chapter 2098: - Blood Demon Spear {.hidden-title}

<section id="chapter-2098" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2098-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2098</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Blood Demon Spear</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2098-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>leepless Duke bellowed to the sky in rage.</p>
