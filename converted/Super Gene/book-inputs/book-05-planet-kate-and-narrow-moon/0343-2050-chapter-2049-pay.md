# Chapter 2050: - Pay {.hidden-title}

<section id="chapter-2050" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2050-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2050</p>
</section>
...
<section class="element chapter-text" id="chapter-2050-text" markdown="1">
<p class="first2"><span class="first-letter">Y</span>ou guys aren’t from Planet Sky Cloud?” The middle-aged shura asked Han Sen with rhetorical certainty.</p>
