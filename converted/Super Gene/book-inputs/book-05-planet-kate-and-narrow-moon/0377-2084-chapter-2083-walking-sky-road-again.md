# Chapter 2084: - Walking Sky Road Again {.hidden-title}

<section id="chapter-2084" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2084-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2084</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Walking Sky Road Again</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2084-text" markdown="1">
<p class="first2"><span class="first-letter">Y</span>isha saw his Xuanyuan Dragon wings and his Stone Cow’s stone-skin, and she believed Han Sen— She couldn’t think of a better explanation, so Han Sen got away with it.</p>
...
The wider the Bai Sema grew, the lower its defence dropped. At its smallest, it could block the force of a King-class attack and shrug off the damage.
...
Han Sen’s genes weren’t stable, so he wasn’t a genius when it came to practise. He could not practise things quickly, but he was good at using techniques.

His techniques made him very strong, but to people that practised, reaching the status of deified was the ultimate goal. No matter how well Han Sen performed, if he could not reach that lofty point, then the elites wouldn’t always look up to him.
