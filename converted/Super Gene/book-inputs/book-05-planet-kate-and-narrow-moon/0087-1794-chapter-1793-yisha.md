# Chapter 1794: - Yisha {.hidden-title}

<section id="chapter-1794" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1794-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1794</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Yisha</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1794-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hen Mister Ji saw Han Sen jump back, he immediately put himself in battle mode. He looked toward the grapevine ahead of them-</p>
