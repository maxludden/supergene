# Chapter 2070: - Rainbow Cloud Peak {.hidden-title}

<section id="chapter-2070" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2070-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2070</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Rainbow Cloud Peak</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2070-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>hey are both spirits guarded by Jade Air, and yet, there is so much difference between them. I need to get more Jade Fairy Spirit Orbs to level up my Jade-skin. Maybe the results will surprise me,”** Han Sen thought to himself.</p>
...
The Fairy Orbs made Han Sen’s Jade-skin God-light grow stronger, though. The Jade Tiger Spirit Orb didn’t give him that feeling.
...
The man wasn’t of the Sky. He had the head of a white tiger, and the armour he wore was made of fur. He looked like one of the Tego, but it wasn’t the one he had encountered before.
