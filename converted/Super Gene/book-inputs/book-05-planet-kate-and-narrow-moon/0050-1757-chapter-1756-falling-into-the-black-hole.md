# Chapter 1757: - Falling into the Black Hole {.hidden-title}

<section id="chapter-1757" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1757-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1757</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Falling into the Black Hole</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1757-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen felt as if something was wrong. He stayed outside the door and just watched.</p>
...
But before he was able to do so, the flash of a sword-light came toward him. A Kate Noble attacked, prompting him to fight back the aggressor with his hammer.
...
Han Sen was in shock, and he couldn’t stop himself from being dragged in that direction, either. He grabbed at the rock floor, but he was still being pulled away, leaving scratch-marks behind in the stone.
...
Soon after, even if they weren’t hurt, they were still magnetised to the lotus. Han Sen tried his best to move, but he could not shift his leg away from the lotus.
...
Han Sen did not try struggling, though, for he knew such an endeavour would be pointless. He just started to think about how he might be able to escape.
...
One Noble was standing on his feet, holding the lotus seed in his hands. It looked as if he hadn’t been affected by it.
...
**“Strange. Why aren’t they affected?”** Han Sen looked around and put away his geno armour. He stopped using his geno.
