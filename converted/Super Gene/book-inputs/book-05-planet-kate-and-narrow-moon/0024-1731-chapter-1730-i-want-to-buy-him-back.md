# Chapter 1731: - I Want to Buy Him Back {.hidden-title}

<section id="chapter-1731" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1731-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1731</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- I Want to Buy Him Back</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1731-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen made a silent gesture to Lan Se. Qiao picked up the phone.</p>
...
Over the next few days, there was little to do. Aside from practising, he was researching how to eat xenogeneics. As he did, he discovered something of note.
