# Chapter 1978: - Mutant Gene {.hidden-title}

<section id="chapter-1978" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1978-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1978</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Mutant Gene</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1978-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter killing the Xuanyuan Dragon, the crew left Xuanyuan Cave.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Xenogeneic Viscount hunted. Jade Ant: xenogeneic gene found.”</em></p></section>
