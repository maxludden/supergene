# Chapter 2191: - Taking the Legacy {.hidden-title}

<section id="chapter-2191" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2191-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2191</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Taking the Legacy</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2191-text" markdown="1">
<p class="first2"><span class="first-letter">Y</span>isha had been a very special person to the Rebate, so there was no need to worry about the funeral too much. Narrow Moon performed the services very well, and all Han Sen had to do was cooperate with their rituals.</p>
...
Night River King stared at the guardian tablet as it was passed toward him, and his eyes sparkled. The geno art he practised was aligned quite well with the boons that the deified toad could impart. He’d be able to use the ice and moon powers of the deified toad to become half-deified in only a few centuries.
