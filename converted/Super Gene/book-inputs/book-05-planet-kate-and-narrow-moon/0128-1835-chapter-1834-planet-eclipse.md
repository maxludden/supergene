# Chapter 1835: - Planet Eclipse {.hidden-title}

<section id="chapter-1835" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1835-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1835</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Planet Eclipse</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1835-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">G</span>et ready for what?”** Han Sen asked. Having a planet to oneself should be a good thing, but Yisha’s tone didn’t make it sound as if it was.</p>
...
**“Good thinking,”** the officer said, with a bow. **“And out of the leftover planets, Planet Jade-shell is the richest. Shall we give it to Queen’s student Han Sen?”**
...
Planet Eclipse was like a flavourless rib of chicken.
