# Chapter 1830: - The Knife That Destroys the Sky and Earth {.hidden-title}

<section id="chapter-1830" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1830-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1830</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Knife That Destroys the Sky and Earth</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1830-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter the eleventh knife rain, there were so many knives on the ground. They were all over the place, and there was hardly a place to step.</p>
...
The falling knives exploded when struck, shattering. Many were broken, scattershotting Han Sen— They gave him a number of cuts, proving his Baron armour could not stop them.
