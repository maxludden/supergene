# Chapter 2006: - Stone Cow Valley {.hidden-title}

<section id="chapter-2006" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2006-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2006</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Stone Cow Valley</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2006-text" markdown="1">
<p class="first2"><span class="first-letter">P</span>ang! Pang!</p>
...
The Stone Cow was starting to realise something was frightfully wrong. Instead of bellowing at Han Sen, it was now trying to turn around and run away. Unfortunately for the cow, it was still as slow as a sloth. It couldn’t escape Han Sen’s watchful eye.
