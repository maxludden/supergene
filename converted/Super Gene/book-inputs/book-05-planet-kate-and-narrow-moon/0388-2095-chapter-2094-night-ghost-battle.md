# Chapter 2095: - Night Ghost Battle {.hidden-title}

<section id="chapter-2095" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2095-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2095</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Night Ghost Battle</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2095-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">P</span>lease give me a hand taking down this asshole! He is the one that slew my workers, and many Night Ghosts as well,”** Kahn called out when he saw Han Sen and the others coming. He looked joyous in relief.</p>
...
Lone Bamboo’s sword was still at the man’s throat. He ignored the knife Kahn was using and raised a finger to point at Kahn. A sword-light swiftly shot toward the dead center of Kahn’s forehead.
