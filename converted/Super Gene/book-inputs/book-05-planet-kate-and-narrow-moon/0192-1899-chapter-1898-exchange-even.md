# Chapter 1899: - Exchange Even {.hidden-title}

<section id="chapter-1899" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1899-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1899</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Exchange Even</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1899-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">G</span>one? How can they be gone?”** Du Lishe asked curiously.</p>

Qing Li explained it, and then let her take a look at the broken wood chips.

After Du Lishe heard what she was told, she had a look of disbelief. **“Really? How long has Han Sen been practising Teeth Knife? You say he has a Teeth Knife knife-mind and can use it to such a high level? I can’t help but find that hard to believe.”**
