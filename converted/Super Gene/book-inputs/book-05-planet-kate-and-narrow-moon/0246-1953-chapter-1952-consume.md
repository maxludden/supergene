# Chapter 1953: - Consume {.hidden-title}

<section id="chapter-1953" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1953-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1953</p>
</section>
...
<section class="element chapter-text" id="chapter-1953-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">C</span>ool! You became an ant; how did you do that? Teach me! If I learn it, I can sneak into any women’s locker rooms that I want to!”** Wang Yuhang’s eyes opened wide. He looked at Han Sen, who was being held by Spell, and smiled.</p>

Little Silver, Little Angel, and Dragon Lady looked at Han Sen’s ant body curiously.

Han Sen felt depressed. He sent his words to be spoken through Spell. So, Spell spoke for him by saying, **“Cool my ass! Go and find a way to turn me back to normal.”**
...
**“When I become an ant, I cannot use geno arts. I can only use The Story of Genes. If I can recover, I plan to use The Story of Genes as an excuse. Nobody else has ever practised it before, so no one will know if I’m telling the truth or not,”** Han Sen said, through Spell.
...
**“You assholes!”** Han Sen felt so mad, and so he jumped atop Spell’s shoulder. Spell then started to fire shiny bullets at them.
...
The stronger the ant was, the more digesting power they had. The geno art they learned was called Consume. Practising the skill required a body that was similar to the Consuming Ants, though.

Burning Lamp Alpha could turn others into ants, but he hadn’t given Han Sen the body of an actual Consuming Ant.

Han Sen was just a common ant without any intelligence. He could not generate a geno armour, so there was no way he could learn Consume.
...
Consume appeared to satisfy all of his needs, but only Consuming Ants could practise it.

Han Sen wanted to try it, so he started practising.

He thought it’d be difficult, but after a few whirls, he felt a chill inside his stomach. It was an odd sensation.

**“I can practise this?”** Han Sen was shocked.

Since the skill was having an effect, that meant he could practise it.

Since Han Sen had nothing to do, he kept practising with Consume. He learned quickly, and he achieved beginner status in a few short days.

**“I wonder if Metal Eater can practise something like this? I can take it back to the Sanctuary for him.”**

But Han Sen was just practising for the time being. He didn’t mean to practise it all that much, as he didn’t want to be an ant forever.
