# Chapter 1931: - Moon {.hidden-title}

<section id="chapter-1931" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1931-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1931</p>
</section>
...
<section class="element chapter-text" id="chapter-1931-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he Dukes didn’t look at the blade in the same way Han Sen had. They all looked at it for less than a minute before handing it back over to Black-Moon King. The entire thing was done in a few minutes.</p>
