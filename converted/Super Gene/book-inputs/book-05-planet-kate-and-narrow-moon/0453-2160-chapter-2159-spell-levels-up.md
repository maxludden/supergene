# Chapter 2160: - Spell Levels Up {.hidden-title}

<section id="chapter-2160" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2160-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2160</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Spell Levels Up</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2160-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>ll the races that sent Marquise teams to Metal World were growing worried. Their elites had been waiting outside the planet, but after half a month went by, not a single Marquise had returned. They sent a few more Marquises to find out what might have transpired there, but none of them came back either. All of the elders were growing angry at the threat to their people.</p>
...
The white Metal Beast told Han Sen how he could leave Metal World. The storm that plagued Metal World cycled between blue and red, and most of the time, leaving was impossible. Every tenth swap of colour, however, there would be a brief pause in the storm. It was only during that time that the planet could be escaped.

When the Demons and the Buddhas first travelled there, it was during that small window. That was how they were able to enter and leave.
...
Han Sen didn’t meet with them, though. He stayed close to the white Metal Beast and kept drinking its metal xenogeneic fluid. As he waited for the tenth cycle of the storms, he spent most of his time practising The Story of Genes.
...
**“Is it finally happening?”** Han Sen was excited. He had used so many resources to level it up, and he had always wondered what new powers he might achieve upon levelling it up to Marquise.

**“I wonder if it will develop a new shape. Of course, if the power doesn’t increase proportionately, then this geno art wouldn’t be very well-balanced. The resources consumed thus far would be a waste, and I’m not even sure if there would be any point carrying on with its practise.”** The Spell armour began to glow with holy light. Spell was now shining as brightly as a sun.

Boom!

Han Sen’s body shook, and then the armour disappeared. It took on the shape of a lady standing directly in front of Han Sen—
