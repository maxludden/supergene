# Chapter 2197: - Sound {.hidden-title}

<section id="chapter-2197" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2197-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2197</p>
</section>
...
<section class="element chapter-text" id="chapter-2197-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>s he spoke to Huangfu Jing, Han Sen had a look at the route and estimated the travel time it would take for him to get there. **“Don’t register it just yet. Wait for me on Planet Jade Drum. I’ll be there in four days; can you wait that long?”**</p>
