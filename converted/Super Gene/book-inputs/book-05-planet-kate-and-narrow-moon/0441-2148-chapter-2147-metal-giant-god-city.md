# Chapter 2148: - Metal Giant God City {.hidden-title}

<section id="chapter-2148" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2148-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2148</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Metal Giant God City</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2148-text" markdown="1">
<p class="first2"><span class="first-letter">A</span> giant city was nestled into the slopes of a metal mountain. The city was made of the same black metal as the mountain, and it looked like it had been carved from the mountain rather than built.</p>
...
The Marquises that guarded the cave entrance released their God-lights, killing the two nearest metal xenogeneics.
