# Chapter 1751: - Xina {.hidden-title}

<section id="chapter-1751" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1751-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1751</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Xina</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1751-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen found a golden bone inside her corpse. It was ten centimeters long.</p>
