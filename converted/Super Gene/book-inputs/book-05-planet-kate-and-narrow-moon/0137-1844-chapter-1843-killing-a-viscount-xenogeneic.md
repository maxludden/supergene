# Chapter 1844: - Killing a Viscount Xenogeneic {.hidden-title}

<section id="chapter-1844" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1844-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1844</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Killing a Viscount Xenogeneic</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1844-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2"><span class="first-letter">K</span>illing a Viscount Xenogeneic**</p>
...
And as this occurred, Han Sen leapt forward and unleashed a strike against the xenogeneic snake. Its metal-looking body was delivered a hefty cut that drew blood.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Xenogeneic Viscount hunted; xenogeneic gene found: King Earthworm”</em></p></section>
