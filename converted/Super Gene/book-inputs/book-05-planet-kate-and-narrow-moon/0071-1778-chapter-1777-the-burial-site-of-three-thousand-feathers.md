# Chapter 1778: - The Burial Site of Three Thousand Feathers {.hidden-title}

<section id="chapter-1778" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1778-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1778</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Burial Site of Three Thousand Feathers</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1778-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">L</span>ong ago, three thousand prisoners were forced to mine ore across Mosi Mountain. They were unable to leave until death claimed them.”** Kong Fei did not answer Duke Brilliant. All he did was say something that made no sense, given the current context.</p>
...
After that, Duke Brilliant waited for no further reply. His body shone with the colour gold, as his wings spread out like suns of their own. Their light shone across the area, and everything the light touched was turned into gold.
