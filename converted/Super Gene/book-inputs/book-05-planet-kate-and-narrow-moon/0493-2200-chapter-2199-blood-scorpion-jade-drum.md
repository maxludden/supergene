# Chapter 2200: - Blood Scorpion Jade Drum {.hidden-title}

<section id="chapter-2200" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2200-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2200</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Blood Scorpion Jade Drum</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2200-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen carefully examined the red patterns that adorned the Jade Drum and realised that they formed the shape of a scorpion. In all, it was around the size of a man’s hand. It was red like jade, and it contrasted sharply with the white surface of the Drum. The pattern didn’t look as if it had been engraved into the item, though. It looked as if an actual scorpion lived beneath the Drum’s surface.</p>
...
Han Sen gathered up his Jade-skin power and struck the surface of the Drum again.
...
It was fortunate their injuries weren’t lasting. They recovered with their geno arts, but they had realised just how scary that Blood Scorpion Jade Drum was.
