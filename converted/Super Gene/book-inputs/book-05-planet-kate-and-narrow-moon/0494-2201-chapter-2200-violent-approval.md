# Chapter 2201: - Violent Approval {.hidden-title}

<section id="chapter-2201" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2201-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2201</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Violent Approval</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2201-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen frowned. He had tried using his Destiny’s Tower to try to claim the other Jade Drum, but it did not work.</p>
