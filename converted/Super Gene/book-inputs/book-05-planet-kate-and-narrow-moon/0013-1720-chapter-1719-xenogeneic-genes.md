# Chapter 1720: - Xenogeneic Genes {.hidden-title}

<section id="chapter-1720" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1720-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1720</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Xenogeneic Genes</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1720-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen looked at the information available on the internet, but he could not find any others who were associated with the sanctuaries. It seemed no one else on Kate was.</p>
...
Lan Se knew Hardman would not want to keep Han Sen on any longer than he had to because he had not become a Noble. And she was afraid Han Sen might resort to desperate measures to survive that could bring harm to Planet Kate. She sympathised with him, and that was why she made the offer.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Xenogeneic Gene discovered.”</em></p></section>
