# Chapter 356: Super Gene? {.hidden-title}

<section id="chapter-356" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-356-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">356</p>
</section>
...
<section class="element chapter-text" id="chapter-356-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen looked at the alloy box in front of him in surprise. He remembered that his dad died in an aircraft accident, and people did not even find his body, so how was it possible that he had left something behind?</p>
...
**“Han Jingzhi, Unit 7, Secret Service, AX9558,”** Han Sen read the characters to himself and felt surprised.
...
Seeing the work permit, Han Sen learned that his great grandpa used to work for a governmental organisation in the Alliance, but it looks like he was just an ordinary staff member.
...
It felt like a piece of jade. Since Han Sen knew nothing about jewellery, he did not know what it was.
