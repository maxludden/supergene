# Chapter 323: An Invite from the Queen {.hidden-title}

<section id="chapter-323" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-323-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">323</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">An Invite from the Queen</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-323-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>hank you for the chance.”** Han Sen smiled and threw a punch at the young man.</p>
...
As long as they did not use those hyper geno arts that only evolvers could practise, there was no way for anyone to tell they were evolvers. People would only think that they were strong unevolved persons.
