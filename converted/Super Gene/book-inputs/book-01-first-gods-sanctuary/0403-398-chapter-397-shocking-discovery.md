# Chapter 398: Shocking Discovery {.hidden-title}

<section id="chapter-398" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-398-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">398</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Shocking Discovery</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-398-text" markdown="1">
<p class="first2"><span class="first-letter">N</span>ing Yue slowly walked into the cold liquid of the evolution pool. Initially, he did not want to become an evolver so soon. Once he finished evolution, he must leave First God’s Sanctuary in a short amount of time, otherwise his body would be damaged permanently.</p>
...
Although he did not have the best health, Ning Yue was the only person who had practised the sword skills of the family successfully.
...
When Ning Yue was a little boy and just started to learn to use sword, he abandoned the strong super geno art and insisted on practising the old sword techniques.

When he just started, the techniques were not even close to the modern super geno art, but Ning Yue did not question his own decision. Two years ago, Ning Yue finally succeeded in practising the old sword techniques and understood its essence. He eventually knew how ridiculous the adaptation was.
