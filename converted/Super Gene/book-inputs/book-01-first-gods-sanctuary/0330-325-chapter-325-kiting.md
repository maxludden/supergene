# Chapter 325: Kiting {.hidden-title}

<section id="chapter-325" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-325-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">325</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Kiting</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-325-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen did not have any room to run. Reaching him in a second, Queen’s kick was even more horrendous than the turtle bite.</p>
...
Killed with one strike, and not even in a vital body part. There was only one possibility for the system to make such a judgement: the two parties were too far apart in strength that they were not on the same level.
...
Queen was much stronger than the super creatures. If he had more chance to practise with her, it would be great for him to prepare himself for the future hunting.
...
After leaving Gladiator, Queen dialled a number and made a short call. She reported to Huangfu Xiongcheng her conclusion, which was she believed A Soldier on Warship was a suitable opponent for Qian Hezhen.
