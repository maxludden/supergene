# Chapter 301: Another Nest {.hidden-title}

<section id="chapter-301" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-301-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">301</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Another Nest</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-301-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he ghost butterfly boomerang made a curve in the air and flew toward the target.</p>
...
Han Sen knew this meant Yang Manli had recognised him as a leader.
...
One year was too long for Han Sen— He did not want to wait for more than a decade to evolve, which was why Han Sen wanted to hunt super creatures. However, Han Sen was still trying to complete the third phase of Heresy Mantra and he needed time to finish practising Panorama. It will still take him some time to get ready to face super creatures.

When Han Sen was about to go back to Black-hawk and practise Panorama in Gladiator, he suddenly heard some astonishing news.
