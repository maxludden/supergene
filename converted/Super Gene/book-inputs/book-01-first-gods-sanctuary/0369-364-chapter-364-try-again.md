# Chapter 364: Try Again {.hidden-title}

<section id="chapter-364" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-364-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">364</p>
</section>
...
<section class="element chapter-text" id="chapter-364-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">N</span>ame it,”** said Ye Yufeng.</p>
...
Even they were all evolvers at this point, they had just evolved and had never practised hyper geno arts designed for evolvers. Compared to an average evolver, they were much weaker.
...
The four of them explained all the beast souls they owned each and designed a plan to fight the wolf according to its characteristics. It took them a long while to finalise the plan.
