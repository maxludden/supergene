# Chapter 143: Not under This Cup {.hidden-title}

<section id="chapter-143" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-143-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">143</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Not under This Cup</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-143-text" markdown="1">
<p class="first2"><span class="first-letter">J</span>i Yanran had been preparing for Starry Cup recently as well and had spent long hours practising every day. She did not expect to see Han Sen here again.</p>
...
Han Sen acted as if he had not heard it and continued to exchange the cups. Then he sat up and looked at the group of people. **“As you said, if you could guess right, I don’t care what you do. If not, then fuck off and stay away from Ji Yanran.”**
