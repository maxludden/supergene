# Chapter 414: Weird Woman {.hidden-title}

<section id="chapter-414" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-414-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">414</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Weird Woman</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-414-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen pondered and took back the holy angel. He shape-shifted into the colour shifter and leaned against the mountain wall, turning into a part of the rocks. No one could tell he was there.</p>
...
Deep inside the mountain, Han Sen carefully walked in the labyrinth. After an hour, the hoof beats could no longer be heard. Han Sen became alarmed and slowed down. He pondered and shape-shifted again into the colour shifter.
...
Then she opened an alloy case filled with bottles and cans. When she started to pour the content of a bottle into the wok, Han Sen realised it must be spice.
