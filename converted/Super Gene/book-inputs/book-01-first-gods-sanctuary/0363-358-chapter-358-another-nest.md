# Chapter 358: Another Nest {.hidden-title}

<section id="chapter-358" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-358-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">358</p>
</section>
...
<section class="element chapter-text" id="chapter-358-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">A</span>ll right,”** Han Sen replied and accelerated a little bit.</p>
...
Han Sen also put away Mew and followed the group. If it was an ordinary place, Han Sen would have chosen to rush inside a moment ago. However, in Jade Dragon Mountains, he was not sure if there were additional creatures, so he chose to take his time.
