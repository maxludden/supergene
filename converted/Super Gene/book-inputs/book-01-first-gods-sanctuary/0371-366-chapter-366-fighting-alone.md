# Chapter 366: Fighting Alone {.hidden-title}

<section id="chapter-366" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-366-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">366</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Fighting Alone</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-366-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen could tell that the Chen brothers were having second thoughts and did not feel hopeful anymore.</p>
...
Even with the flame lieutenant and time curse used, Han Sen who had shape-shifted was still much slower than the wolf. Normally speaking, Han Sen would not be able to dodge all the attacks from the wolf.
