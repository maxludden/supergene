# Chapter 78: Rock-paper-scissors {.hidden-title}

<section id="chapter-78" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-78-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">78</p>
</section>
...
<section class="element chapter-text" id="chapter-78-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">D</span>rinking without a drinking game is always a little boring. How about we play a little game?”** It only took a short while before Tang Zhenliu suggested a game.</p>
