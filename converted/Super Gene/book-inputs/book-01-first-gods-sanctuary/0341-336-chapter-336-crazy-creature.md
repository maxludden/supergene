# Chapter 336: Crazy Creature {.hidden-title}

<section id="chapter-336" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-336-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">336</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Crazy Creature</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-336-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen stared down the cliff and was shocked. So were Jin Rijie, Jin Qiuli and Sun Minghua.</p>
...
Han Sen watched the lava pool as he listened to the professor. He thought the professor’s explanation made a lot of sense. The behaviours of the turtle was much like the golden growler. Maybe it was indeed giving birth here.
...
The stone wall was cracked by the creature, and it was bleeding heavily, it’s blood colouring the stone red.
