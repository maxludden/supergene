# Chapter 87: Cheating {.hidden-title}

<section id="chapter-87" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-87-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">87</p>
</section>
...
<section class="element chapter-text" id="chapter-87-text" markdown="1">
<p class="first2"><span class="first-letter">Y</span>ang Manli led Han Sen in front of a sealed device the size of a train compartment. The device was around 150 feet long. She turned it on and entered some data before she took off her jacket, revealing a black professional training suit underneath.</p>
