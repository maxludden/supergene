# Chapter 282: Same Price {.hidden-title}

<section id="chapter-282" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-282-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">282</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Same Price</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-282-text" markdown="1">
<p class="first2"><span class="first-letter">X</span>u Ruyan was a bit worried that Han Sen might know about the life lotus. Although few people had seen a nest, all the information was readily available on the Skynet. If Han Sen could tell that there was a nest here, that would be horrible news to her.</p>
...
In the process of fighting the skeleton, Han Sen gradually became familiarised with its dagger skills in footwork. He was obsessed with finding a way to beat the skeleton.
</section>
