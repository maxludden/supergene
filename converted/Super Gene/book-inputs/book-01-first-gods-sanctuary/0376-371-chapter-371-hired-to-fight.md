# Chapter 371: Hired to Fight {.hidden-title}

<section id="chapter-371" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-371-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">371</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Hired to Fight</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-371-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter returning to his dorm, Han Sen dialled Huangfu Pingqing’s number and saw her in the holographic image.</p>
...
**“Little brother, you must be calling me for some favour?”** Huangfu Pingqing said, smiling.
