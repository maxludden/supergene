# Chapter 330: Fighting the Turtle {.hidden-title}

<section id="chapter-330" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-330-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">330</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Fighting the Turtle</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-330-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>un Minghua wanted to get closer to the turtle. Jin Rijie checked the distance and did not object.</p>
...
**“Damn! Han Sen, this is not Steel Armour Shelter yet,”** said Jin Rijie solemnly with his brows knitted.
...
Although Sun Minghua had maxed out on all his geno points, he did not spend any time practising martial arts and did not react fast enough. When he summoned his mount, the turtle was already next to him.
