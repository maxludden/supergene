# Chapter 329: The Turtle Again {.hidden-title}

<section id="chapter-329" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-329-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">329</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">The Turtle Again</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-329-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he three from Glory Shelter had heard this too many times and were no longer interested, while Han Sen was intrigued.</p>
...
Han Sen had only just started on practising Overload. He was afraid that the turtle might return to the ocean.
...
Since Han Sen was interested, Sun Minghua had shared a lot. Sun Minghua did his research for his interest as well as to benefit mankind, so he had nothing to hide and taught Han Sen a lot of practical knowledge, such as how to determine which plants were edible and which plants were toxic. Han Sen memorised all the information, which might be lifesaving in the future.

After travelling on the back of the golden growler, Han Sen understood that once he left the shelters, it was not easy for a human to survive in the wild.
