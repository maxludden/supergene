# Chapter 164: Sacred-blood Pet {.hidden-title}

<section id="chapter-164" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-164-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">164</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Sacred-blood Pet</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-164-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen quietly tracked the gang and saw they had set up a tent and made a fire.</p>
...
Having an idea, Han Sen summoned Mew and ordered it to run toward the other side and roar at the gang.
...
Seeing the gang running away, Han Sen summoned the wings and shape-shifted into bloody slayer, flying toward the camp in darkness.
...
Two daggers were shot at Han Sen and mercilessly nailed in the gaps on the elbow part of his armour. To kill Baldy, Han Sen had no time to dodge.
...
Son of Heaven finally understood, **“Damn, that is not a sacred-blood creature. It is a sacred-blood beast soul pet! That motherfucker had fed a sacred-blood pet!”**
...
Han Sen ran for a while and shape-shifted back after losing the gang. He put Gu on the ground and cut loose the ropes.

**“Dollar?”** Gu recognised him.
