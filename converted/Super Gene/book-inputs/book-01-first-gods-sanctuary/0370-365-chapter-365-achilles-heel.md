# Chapter 365: Achilles\u2019 Heel {.hidden-title}

<section id="chapter-365" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-365-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">365</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Achilles\u2019 Heel</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-365-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he four of them entered the nest one by one as they planned. This time, Chen Nanxing was the first.</p>
