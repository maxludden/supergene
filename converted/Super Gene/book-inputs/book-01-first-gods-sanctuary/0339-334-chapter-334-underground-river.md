# Chapter 334: Underground River {.hidden-title}

<section id="chapter-334" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-334-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">334</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Underground River</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-334-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen directly summoned his horn bow and mutant black stinger arrow and made a shot at the sacred-blood copper demon.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Sacred-blood creature copper demon killed. No beast soul gained. Drink its blood to gain 0 to 10 sacred geno points randomly.”</em></p></section>
...
Han Sen had not objections. Even a mutant shape-shifting beast soul was extremely popular. Han Sen did not mind earning some money.
