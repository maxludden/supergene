# Chapter 109: Scaled Armadillo {.hidden-title}

<section id="chapter-109" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-109-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">109</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Scaled Armadillo</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-109-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span> hope he can.”** Looking down, Fist Guy was not sure either.</p>

One could never be sure about the result when one was about to hunt a sacred-blood creature. The infamy of Ass Man also added to their lack of confidence in Han Sen—
...
**“Scaled armadillo?”** The rest suddenly realised that scaled armadillo was the name of the sacred-blood creature and all became thrilled.
...
The gang had scattered, but as Han Sen looked back, he realised that the silver bird had chosen him to follow, its ferocious bird eyes red as blood gazing at him unblinkingly.
