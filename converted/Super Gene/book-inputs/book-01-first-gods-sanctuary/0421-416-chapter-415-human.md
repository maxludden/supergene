# Chapter 416: Human? {.hidden-title}

<section id="chapter-416" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-416-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">416</p>
</section>
...
<section class="element chapter-text" id="chapter-416-text" markdown="1">
<p class="first2"><span class="first-letter">O</span>n another thought, Han Sen was not even sure if he could hurt her with the cursed wolf dagger, given how strong she was. The gap between himself and someone with a fitness level over 100 was simply too big.</p>
...
Han Sen put the super Pat armour on the rock worm and enhanced its defence. This way, it could compete against the white rhinoceros.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Super creature evil goblin killed. No beast soul gained. Life essence available. Meat inedible.”</em></p></section>
