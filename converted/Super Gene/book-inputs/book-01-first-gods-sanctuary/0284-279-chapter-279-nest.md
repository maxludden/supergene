# Chapter 279: Nest {.hidden-title}

<section id="chapter-279" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-279-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">279</p>
</section>
...
<section class="element chapter-text" id="chapter-279-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>hat’s it—”** Han Sen was overjoyed when looking at the odd shape of mountains.</p>
...
Han Sen did not realise that the reason that the group had not entered the nest yet was mainly because they had lost most of their equipment on the ocean, under the attack of marine beast.
...
Han Sen used the colour shifter to move slowly to the entrance. After more than an hour, he was in front of the nest.
...
Han Sen decided to be careful and summoned his phantom ant armour, protecting himself thoroughly and slowly walking down the winding path.
