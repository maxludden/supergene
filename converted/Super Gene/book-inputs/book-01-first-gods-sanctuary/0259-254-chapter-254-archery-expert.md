# Chapter 254: Archery Expert {.hidden-title}

<section id="chapter-254" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-254-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">254</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Archery Expert</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-254-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span> was just wondering why they both chose archery. It turns out that there’s something going on between the two!”**</p>
...
The viewers of the game were also in a heated discussion. Eventually, it was Black-hawk’ s turn. Their opponent was Smith military Academy.

People were guessing who Situ Xiang would pick to represent Black-hawk and were surprised by the result. Except for Xu Tianhao was the old Capt., The other four teammates were the four freshmen from room 304.
...
In the show hosted by Wen Xiuxiu, a famous archery expert Feng Jiulun was invited to analyse the game.
...
Smith military Academy was on the same level as Black-hawk. Last year, Smith military Academy did not do that well in archery either, only slightly better than Black-hawk.

This year, Smith Military Academy also recruited many archery students, among whom Fang Wending was one of the top.

Feng Jiulun cleared his throat and said lightly, **“Black-hawk and Smith are on the same level and I will say it’s a 60% chance of winning.”**

**“You think Black-hawk only has a 60% chance of winning?”** Asked Wen Xiuxiu, surprised.
