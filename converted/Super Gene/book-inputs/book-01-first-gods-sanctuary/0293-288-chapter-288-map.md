# Chapter 288: Map {.hidden-title}

<section id="chapter-288" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-288-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">288</p>
</section>
...
<section class="element chapter-text" id="chapter-288-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen thought that since he had been gone for so long, a new head of the special squad must have been appointed in his stead. After all, there were rules about that.</p>
