# Chapter 367: Coming Back from Death {.hidden-title}

<section id="chapter-367" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-367-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">367</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Coming Back from Death</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-367-text" markdown="1">
<p class="first2"><span class="first-letter">Y</span>e Yufeng felt more and more odd, his brows knitted.</p>
...
Han Sen had never practised Heavenly Go. He had just learned kiting skills from Queen and had no idea what Queen was practising.
...
It was a narrow corner between two stone walls. The two walls formulated an angle of 45 degrees, and there was a large stone about 3 feet tall in front of Han Sen—
...
Ye Yufeng who was watching suddenly became pale. As he tried to rush over, he realised it was too late. Ye Yufeng had to watch the wolf going at Han Sen—
