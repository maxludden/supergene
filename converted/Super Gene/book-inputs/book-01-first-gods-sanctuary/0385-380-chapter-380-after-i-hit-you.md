# Chapter 380: After I Hit You {.hidden-title}

<section id="chapter-380" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-380-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">380</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">After I Hit You</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-380-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen’s heart was racing, but he still pretended to be surprised and asked, **“Beings beyond sacred-blood creatures?”**</p>
