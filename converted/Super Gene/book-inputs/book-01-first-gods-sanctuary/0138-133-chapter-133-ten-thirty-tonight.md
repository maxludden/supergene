# Chapter 133: Ten Thirty Tonight {.hidden-title}

<section id="chapter-133" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-133-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">133</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Ten Thirty Tonight</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-133-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">S</span>en, are you going for it?”** Shi looked at Han Sen with hidden excitement. He felt even Han Sen’s opponent was Li Yufeng, Han would still win. Although Shi had never seen Li Yufeng play, he believed so. Han Sen’s performance so far made him think that Han must be almost invincible in this game.</p>
...
**“Right! If you really have such a gorgeous girlfriend, the entire Room 304 would all feel honoured,”** said Shi excitedly.
