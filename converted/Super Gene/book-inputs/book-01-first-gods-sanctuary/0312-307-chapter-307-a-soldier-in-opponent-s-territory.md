# Chapter 307: A Soldier in Opponent's Territory {.hidden-title}

<section id="chapter-307" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-307-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">307</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">A Soldier in Opponent&#x27;s Territory</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-307-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen stepped back and dodged Xu Zhu’s following attacks. Regarding Xu Zhu calmly, Han Sen felt somewhat surprised.</p>
...
Panorama also included similar techniques, which Han Sen had practised in the recent half-year.
...
However, Diversion was very hard to practise. The key to practise Diversion was to do it in real combat. Currently, Han Sen still only understood Diversion from a theoretical perspective.

Luckily, Han Sen had practised Ghost-haunt before, so he was no stranger to such techniques. Even so, it would still take Han Sen quite a while to perform Diversion in the real combat.
...
Xu Zhu couldn’t help frowning. Han Sen was very skilled at it that he must be someone who had practised similar skills before.

However, Xu Zhu did not pay too much attention to that. Han Sen was so much worse in fitness than Xu Zhu that even if Han Sen had practised Diversion, he would not be able to compare to Xu Zhu.
...
Watching Han Sen, Desperado remained silent. He felt Han Sen’s behaviours were strange, but he could not tell how so.
...
Han Sen’s arms were dislocated by Xu Zhu a couple more times, but he survived each time using Ghost-haunt and the disordered footwork of the white jade skeleton. Although he was caught multiple times by Xu Zhu, he always managed to run away.

Although Ghost-haunt was not as advanced as Diversion, it was taught to Han Sen by a veteran who had survived many battles. Many of the techniques were extremely practical, and helped Han Sen in this extreme situation.
