# Chapter 230: Beheading in Sand Valley {.hidden-title}

<section id="chapter-230" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-230-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">230</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Beheading in Sand Valley</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-230-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter he arrived at Sand Valley, Han Sen came to understand why with a strong team Huangfu Pingqing was still not able to kill the sacred-blood creature.</p>
...
Although Han Sen had put on the phantom ant armour, the impact from a such heavy weapon would still kill him.
...
The three-blade harpoon was sharp enough to cut sacred-blood armour, and Han Sen’s strength was even greater than someone having maxed out on all geno points. With one strike, the creature’s rock hard neck was cut off, its head thrown into the air.
