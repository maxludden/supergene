# Chapter 175: Sparring with A Beauty {.hidden-title}

<section id="chapter-175" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-175-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">175</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Sparring with A Beauty</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-175-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>ut Han Sen misunderstood one thing. He thought there was an operator in each SKTS in the array, and was prepared to be thrown into a group fight. Hence, he thought he should get rid of the first war-frame coming at him as fast as possible, so that it would be easier for him to deal with the rest.</p>

Liu Changming and the director of the commercial Xu Wenchang were monitoring Han Sen’s practise through a monitor. Suddenly seeing a SKTS moving, they both paused.
...
Ready to ask someone to stop her, Liu Changming rose up but was stopped by Xu Wenchang, who smiled and said, **“Liu, it is okay. You said Han Sen is a war-frame genius, so wouldn’t it be brilliant if he could just beat her so that she would play her role willingly?”**

Liu Changming said a wry smile, **“Xu, you do not know Yu’s background. She comes from a war-frame family where generations of people have been dedicated to war-frame operation. She was sent to the special war-frame force when she turned 16 and have been practising with the best men ever since. Few at her age could be better than her at war-frame.”**

Having taken a deep breath, Liu Changming continued, **“Han Sen is very good, but I cannot guarantee that he will be able to beat her. Moreover, she has been practising on SKTS for days, while he is just getting started. The performance of SKTS is much worse than Silver Killer, so he must be still getting used to it.”**
...
Seeing Han Sen raising his sword to block her strike, she felt more disdained. With the same war-frame, hers had a higher speed than his, so it was predictable that his war-frame would suffer more. Once his war-frame fell to the ground, he would have no chance to adjust before she beat him.
...
In the blink of an eye, Han Sen controlled his SKTS to kick the other war-frame on the back. Accompanied by its inertia of going forward, Yu’s war-frame was brought to its knees.
...
Trying to taking it from other SKTS when Han Sen got rid of Yu Qianxun, he found the other war-frames remained still. It seemed that it was the only war-frame that he was supposed to spar with.
...
**“The real war-frames have too much constraint. We should fight again using the holographic simulation machine,”** Yu said aloud, walking toward Han Sen—

She was not convinced and thought her loss must be because she had underestimated her opponent.

However, at this time, she had to concede that Han Sen was a great war-frame operator and not someone she could beat easily.
