# Chapter 225: Training {.hidden-title}

<section id="chapter-225" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-225-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">225</p>
</section>
...
<section class="element chapter-text" id="chapter-225-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he semi-annual assessment began.</p>
...
In her room on campus, Situ Xiang watched the video of Han Sens assessment repeatedly. In the end, she dialled the number on her comlink, and it went through.
...
Situ Xiang had a lot of trust in her father. He used to be an archery coach in the military, and that was why she had been practising archery since she was a little girl.
