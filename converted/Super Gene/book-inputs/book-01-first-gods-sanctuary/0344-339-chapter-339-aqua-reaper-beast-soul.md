# Chapter 339: Aqua Reaper Beast soul {.hidden-title}

<section id="chapter-339" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-339-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">339</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Aqua Reaper Beast soul</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-339-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">R</span>ight now!”** A cold light flashed in Han Sen’s golden eyes. The spinning spear left the bow with a strong force, flying toward the screeching creature.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Larva of super creature aqua reaper killed. Beast soul of super creature aqua reaper gained. Life essence available. Consume its life essence to gain 0 to 10 super geno points randomly. Meat inedible.”</em></p></section>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Life essence of super creature aqua reaper consumed. No super geno point gained.”</em></p></section>
...
There was no need for him to stay in Glory Shelter any longer, so when Sun Minghua decided to go to Steel Armour Shelter, Han Sen followed them back.
...
Han Sen was in no hurry. He had Heresy Mantra, Overload, Panorama, and kiting skills to practise on the way.

When they finally reached Steel Armour Shelter, it was more than a month later.

After returning to his room in Steel Armour Shelter, Han Sen checked on the cloud beast he was feeding. Its body was becoming more and more transparent, and its progress was more or less what Han Sen estimated. The black crystal should be able to make a super creature in about a year.
...
After resting for two days in Black-hawk, Han Sen did not immediately go on Gladiator. He had read more news from different shelters, trying to find the traces of a super creature again.

Han Sen had found a lot of leads, but they were all too far from Steel Armour Shelter, and it would not be easy for him to travel to those places in time.
