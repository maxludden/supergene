# Chapter 276: Blown Away {.hidden-title}

<section id="chapter-276" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-276-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">276</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Blown Away</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-276-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter going into the jungle, Han Sen followed a trail and sneaked into the habitat of the ghost-eyed bears.</p>
...
In the mountains, Han Sen shape-shifted into the colour shifter silently.
...
**“No wonder they were not able to kill any Ghost-eyed bear. The terrain does not work in anyone’s favour.”** Han Sen looked around and saw cliffs everywhere. The ghost-eyed bears were able to run on the cliffs, which made them impossible to kill.
...
Xu Ruyan watched Han Sen with desire. Although she did not know how Han Sen achieved that, she believed his presence would work in her favour.
