# Chapter 355: Things Left behind by the Deceased {.hidden-title}

<section id="chapter-355" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-355-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">355</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Things Left behind by the Deceased</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-355-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen had only passed the easiest mode of Sprint. By adjusting and adding the metal walls, the difficulty could be further improved. In addition, gravity inside the device could also be increased.</p>

From level I to level X, Han Sen had only passed level I, which was the easiest among them all.

**“Sprint is much better than an ordinary gravity trainer. It must be great for me to practise Overload.”** Since Han Sen discovered this interesting device, he had come to the lab more and more often.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Super creature cloud beast killed. No beast soul gained. Life essence available. Meat inedible.”</em></p></section>
...
When Han Sen gathered what he needed to take with him, he went back home during the school recess. In another six months, he would be graduating from Black-hawk. At that time, he would directly go to the military and have little chance to return home.
