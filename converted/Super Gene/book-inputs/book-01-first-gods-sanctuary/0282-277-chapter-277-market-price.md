# Chapter 277: Market Price {.hidden-title}

<section id="chapter-277" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-277-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">277</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Market Price</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-277-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>t depends on how good your appetite is,”** Han Sen said, grinning.</p>
...
However, Xu Ruyan did not realise that Xu Ruyan was planning on the blackmail from the very beginning.
...
**“Fu Shan, this kind of behaviour would never come from someone in the special squad. We should control him and interrogate him,”** said Xu Ruyan.
