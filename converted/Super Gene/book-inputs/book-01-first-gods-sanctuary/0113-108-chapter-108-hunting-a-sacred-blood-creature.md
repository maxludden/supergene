# Chapter 108: Hunting A Sacred-blood Creature {.hidden-title}

<section id="chapter-108" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-108-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">108</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Hunting A Sacred-blood Creature</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-108-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen saw that at the bottom of the cave, a black pangolin-like creature more than six feet long with its whole body covered with in crystal scales was drinking water from a pool.</p>
...
**“I wonder if Ass Man could finish the task.”** Little Finger watched the quiet pool and the creature eating the vines with a worried look on his face
</section>
