# Chapter 363: The Plan {.hidden-title}

<section id="chapter-363" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-363-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">363</p>
</section>
...
<section class="element chapter-text" id="chapter-363-text" markdown="1">
<p class="first2"><span class="first-letter">Y</span>e Yufeng looked at Han Sen with complicated feelings and limped outside. As he ran, he kept looking back and saw the black metal wolf had thrown itself at Han Sen at the same high speed.</p>
...
**“Is the wolf coming out?”** Chen Nanxing suddenly panicked and quickly ran back, forgetting about Ye Yufeng’s offence.
