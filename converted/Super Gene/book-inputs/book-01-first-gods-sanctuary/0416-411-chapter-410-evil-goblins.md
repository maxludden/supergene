# Chapter 411: Evil Goblins {.hidden-title}

<section id="chapter-411" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-411-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">411</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Evil Goblins</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-411-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>lthough this mountain was also covered with snow on the top, but it was much higher and steeper than the one Han Sen remembered.</p>

Where the fire-bird was seemed to be a volcano, while this one was much rockier.
