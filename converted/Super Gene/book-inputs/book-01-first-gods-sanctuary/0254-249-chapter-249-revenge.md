# Chapter 249: Revenge {.hidden-title}

<section id="chapter-249" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-249-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">249</p>
</section>
...
<section class="element chapter-text" id="chapter-249-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">C</span>aptain, it is a sacred-blood creature we are going to hunt. I don’t think we could bring any irrelevant person,”** objected Yang Manli when hearing Qing was also coming.</p>
...
Yang Manli was even more sceptical of Qin Xuan’s decision to choose Han Sen— Such an unreasonable person! Could he really make a better head than her?
