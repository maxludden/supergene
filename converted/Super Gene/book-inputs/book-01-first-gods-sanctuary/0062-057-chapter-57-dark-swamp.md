# Chapter 57: Dark Swamp {.hidden-title}

<section id="chapter-57" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-57-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">57</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Dark Swamp</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-57-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen returned to his room and continued to read the article he had found on the Skynet.</p>

It was a post written by a Steel Armour Shelter member from a long time ago. He was once chased by a creature and had to run into Dark Swamp.

Han Sen knew about Dark Swamp. It was more than two hundred miles in the southwest of Steel Armour Shelter and had lots of poisonous creatures in it. Almost no one would choose to go there. Even the big gangs did not dare to set foot in Dark Swamp.
...
Although he didn’t dare to go into the forest but chose to walk around it, he saw from afar a hornet’s nest as big as a house hanging on an especially tall tree. The black stinger flying from that nest was in a red colour. He guessed that those red hornets should be mutant black stingers.
...
In case of any danger, he also had his armour and bloody slayer, so this trip shouldn’t be too risky.
...
**“I still don’t know where the forest is in the swamp. It would take too much time to search for it after I got in the swamp,”** thought Han Sen, who then put the trip on hold and dialled the blacksmith’s number and asked him to meet.
...
Through the warehouse, the blacksmith showed Han Sen into a room. This room looked like an armoury and Han Sen was dazzled.
