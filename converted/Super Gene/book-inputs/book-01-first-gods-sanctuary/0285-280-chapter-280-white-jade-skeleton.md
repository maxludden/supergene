# Chapter 280: White Jade Skeleton {.hidden-title}

<section id="chapter-280" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-280-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">280</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">White Jade Skeleton</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-280-text" markdown="1">
...
However, the moment the diamond sword was about to hit the daggers, the skeleton twisted in an impossible way and took back its dagger. With a swing, the skeleton’s other dagger almost came between Han Sen’s brows. Han Sen could almost feel the coldness of the blade through his armour.
</section>
