# Chapter 129: Sacred-blood Fox King {.hidden-title}

<section id="chapter-129" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-129-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">129</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Sacred-blood Fox King</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-129-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>f Han Sen was alone, he could simply summon the purple-winged dragon beast soul and fly up. However, he had Wang Mengmeng to protect and could not do that.</p>
...
**“Going out,”** said Han Sen in a cold tone. In a red shadow he shape-shifted into the fairy queen and his entire body was then covered in red armour except for his head.
