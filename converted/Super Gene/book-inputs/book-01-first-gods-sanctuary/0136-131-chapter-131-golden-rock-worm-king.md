# Chapter 131: Golden Rock Worm King {.hidden-title}

<section id="chapter-131" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-131-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">131</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Golden Rock Worm King</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-131-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hen the angry sacred-blood fox king limped back to the top of the dune, the team had dashed out of the skulk.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Mutant horned sand fox killed. Beast soul of mutant horned sand fox gained. Eat its meat to gain zero to ten mutant geno points randomly.”</em></p></section>
...
**“It’s full of sand and rocks here. I do not see any other colour.”** Wang Mengmeng looked around said disappointedly, **“Just dunes and stony hills.”**
