# Chapter 375: Han Sen\u2019s Guess {.hidden-title}

<section id="chapter-375" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-375-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">375</p>
</section>
...
<section class="element chapter-text" id="chapter-375-text" markdown="1">
<p class="first2"><span class="first-letter">N</span>ing Yue was quite a talker and always knew the right thing to say. He would never make people feel awkward or stressed.</p>
...
The day after Han Sen returned to Black-hawk, he received an invite from Ning Yue to join a hunting campaign organised by Starry Group.
