# Chapter 326: Sparring Partner {.hidden-title}

<section id="chapter-326" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-326-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">326</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Sparring Partner</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-326-text" markdown="1">
<p class="first2"><span class="first-letter">U</span>ntil the next day when Han Sen received the geno solution Overload, he closed the video of his combat against Queen.</p>
...
After drinking the geno solution, Han Sen started to practise Overload. Different from Heresy Mantra which emphasised on strengthening his inner organs, Overload focused on putting pressure on his body.

To put it in plain terms, when practising Overload, Han Sen needed to do continuous exercise to stimulate his body cells to make his body work under extreme conditions. After some thinking, Han Sen decided to practise Overload on Gladiator via combats.

In the holographic device, the simulated body was synchronised with his real body. Although he would not be injured, and his movements were otherwise real.

Han Sen entered the evolver section of Gladiator again and immediately received a friend request.

**“Why would someone add me?”** Han Sen was slightly surprised and checked the ID. It said **“QZH,”** which he did not recognise. Han Sen still clicked yes.
...
QZH was great in terms of strength and speed, and he used many hyper geno arts that Han Sen had never seen before. Having realised he was not QZH’s match in either fitness or hyper geno arts, Han Sen thought of one thing.
...
Although Han Sen performed terribly in the beginning, he was making slow progress. It was a skill that needed lots and lots of practise.

Qian Hezhen felt intrigued when fighting Han Sen— Qian Hezhen had always practised with the evolvers in Ares Martial Hall. Even though those evolvers had many skills, Qian Hezhen would gradually get to know their movement patterns.
...
Without any conversation, the two persons were immersed in their own practise and thought of each other as a sparring partner.
</section>
