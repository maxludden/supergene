# Chapter 410: Not Interested {.hidden-title}

<section id="chapter-410" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-410-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">410</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Not Interested</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-410-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>eing able to be instructed by Jia Sidao himself was the dream of many among the celebrities and aristocrats. However, Han Sen was not really interested in it.</p>
...
**“Look. It’s right there!”** After travelling for a day, Jia Yan suddenly exclaimed, pointing at a mountain far away.
