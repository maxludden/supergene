# Chapter 190: An Invite from Martial Arts Society {.hidden-title}

<section id="chapter-190" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-190-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">190</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">An Invite from Martial Arts Society</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-190-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">D</span>o not cry. I am fine. I hunted some other creatures on the way and it took some time. Sorry to make you worry.”** Han Sen patted Wang Mengmeng who were in tears his arms.</p>
...
**“I have confidence, but you were gone for so long, so I am a little worried,”** Wang Mengmeng said and gave the sacred-blood phantom ant armour back to Han Sen—
...
**“Mr. Han Shao, I’ve come to Steel Armour Shelter with some beat souls to sell, including two sacred-blood ones. If you are interested, you can have a look,”** Huangfu said.
...
Han Sen had ordered a total of ten butterfly boomerangs. He was only using these to practise, since he would have used his beast soul ones up before he could practise properly.

Han Sen had the foundation of Sleeve-blade and had looked up many atrial arts of hidden weapons, so he was able to learn how to use the boomerang on his own.
...
Seeing Han Sen was at loss, the students knew that Han Sen was unaware of the conflicts between Black-hawk and St. Germain and started to explain. Soon Han Sen learned that in terms of martial arts, the two academies were bitter rivals.

For three consecutive years, the obstruction to Black-hawk Military Academy getting into the eight-finals of the Alliance Tournament was St. Germain.
