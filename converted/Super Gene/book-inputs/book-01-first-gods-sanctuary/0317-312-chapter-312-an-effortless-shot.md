# Chapter 312: An Effortless Shot {.hidden-title}

<section id="chapter-312" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-312-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">312</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">An Effortless Shot</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-312-text" markdown="1">
<p class="first2"><span class="first-letter">M</span>any students were eavesdropping on the conversations between Han Sen’s friends, trying to pick up some insider perspectives.</p>
...
**“Coach Situ Xiang, would you do the honour and blow the whistle?”** Jing Jiya asked Situ Xiang with a smile.
