# Chapter 216: Gone {.hidden-title}

<section id="chapter-216" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-216-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">216</p>
</section>
...
<section class="element chapter-text" id="chapter-216-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter getting the three-blade harpoon, Han Sen had no time to play with it before he was brought to Son of Heaven by Huangfu Pingqing.</p>
