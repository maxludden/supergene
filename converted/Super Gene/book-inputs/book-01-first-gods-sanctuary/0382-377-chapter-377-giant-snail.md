# Chapter 377: Giant Snail {.hidden-title}

<section id="chapter-377" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-377-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">377</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Giant Snail</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-377-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen and Zhu Ting were hiding behind a boulder at the foot of the mountain, waiting for the rest of the group to draw the creature down.</p>
