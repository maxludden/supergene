# Chapter 369: SOS {.hidden-title}

<section id="chapter-369" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-369-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">369</p>
</section>
...
<section class="element chapter-text" id="chapter-369-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>lthough the disappearance of the egg gave Han Sen some thoughts, he could not confirm any of it.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Life essence of cursed wolf eaten. One super geno point gained.”</em></p></section>
