# Chapter 263: Through Hell {.hidden-title}

<section id="chapter-263" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-263-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">263</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Through Hell</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-263-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">Y</span>ou think you could dodge Jing Jiwu’s arrow unintentionally? Even at 900 feet, I’ll bet you could not,”** replied Qin Cheng quietly.</p>
