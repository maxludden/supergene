# Chapter 121: Wipeout {.hidden-title}

<section id="chapter-121" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-121-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">121</p>
</section>
...
<section class="element chapter-text" id="chapter-121-text" markdown="1">
<p class="first2"><span class="first-letter">A</span> few seconds later, Shi Zhikang’s face collapsed. Eyes wide and hands shaking, Shi exclaimed, **“Sen, you asshole, are you the reincarnation of Taka Kato?”**</p>
