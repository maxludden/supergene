# Chapter 41: Home Run {.hidden-title}

<section id="chapter-41" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-41-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">41</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Home Run</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-41-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>n the unevolved test hall of the physical test center, Zhao Boshan looked at **“A-level”** displayed on the virtual screen and was secretly feeling proud of himself.</p>
...
That’s why it took Han Sen so long. In fact, Han Sen had already been through the robot channel twice. This time, he summoned black beetle armour and bloody slayer at the same time and wanted to try the robot channel one last time under his best conditions.
...
The golden figure was like an armoured vehicle, brutally hitting his way through the combat robots. Even the robots’ biochemical alloy shells were smashed. Nothing could stop that figure.
...
**“Oh my God, who is this fierce fellow?”** Zhao Boshan saw the door of the test hall open and the person in the hall was gone.
