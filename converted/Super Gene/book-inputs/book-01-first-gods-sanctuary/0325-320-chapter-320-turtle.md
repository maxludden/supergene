# Chapter 320: Turtle {.hidden-title}

<section id="chapter-320" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-320-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">320</p>
</section>
...
<section class="element chapter-text" id="chapter-320-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>n Copper Mountains, Han Sen was chasing the turtle. Feeding on the roots or fruits of certain plants, the turtle continued its way in Copper Mountains.</p>
...
There was only one way into the valley. Han Sen took back the tornado wolf and put on the black beetle armour. He then drew the diamond sword and summoned devil sword to strengthen it.
...
Shape-shifting into the bloody slayer, Han Sen used heresy mantra and turned his heart into a strong engine, pumping blood fast and fierce.
...
Han Sen lost his colour and tried to draw the diamond sword back. However, he could not move the sword either way.
...
**“Super creature— It is definitely a super creature—”** Han Sen was dumbstruck and quickly turned to run. This creature fucking treated a sacred-blood gear like candy. How could Han Sen ever beat that?
...
Fortunately, the turtle bit the diamond sword instead of his body the first time, otherwise he would be broken in half even with his sacred-blood armour.
