# Chapter 271: Super Gene {.hidden-title}

<section id="chapter-271" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-271-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">271</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Super Gene</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-271-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he spear was from the beetle knight and could be compared to any sacred-blood beast soul weapon, yet it did not even break the fur of a baby lion. How could that be?</p>
...
Even if the entire Steel Armour Shelter came to attack the adult golden growler, Han Sen believed the result would still be the death of every human.
