# Chapter 388: Blood Snail Beast Soul {.hidden-title}

<section id="chapter-388" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-388-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">388</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Blood Snail Beast Soul</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-388-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">A</span>ny last word?”** Han Sen did not reply but asked.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Super creature blood snail killed. Beast soul of super creature blood snail gained. Life essence available. Meat inedible.”</em></p></section>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Life essence of super creature blood snail eaten. One super geno point gained.”</em></p></section>
