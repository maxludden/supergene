# Chapter 167: Looking for Trouble {.hidden-title}

<section id="chapter-167" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<div class="heading1" id="chapter-167-heading">
<div class="heading-contents1">
<div class="element">
<div class="element-number-block">
<div class="element-number">167</div>
</div>
<div class="element title-block">
<div class="title-subtitle-block">
<h1 class="title">Looking for Trouble</h1>
</div>
</div>
</div>
</div>
...
::: {.element .chapter-text #chapter-167-text}
<p class="first2"><span class="first-letter">H</span>an Sen hesitated, since he did not recognise this student.</p>
...
**“His war-frame game was so exciting.”**
...
Black-hawk students were polite and gave no more than applause. When Tang was introduced, Zhang Yang clapped so hard his hands were almost swollen.
...
As Tang Zhenrong let out a sigh of relief, Yu Mingzhi suddenly asked, **“Professor Yan, I heard that Black-hawk has a student named Ouyang Xiaosan who is in the top ten of the Military Academy League?”**
...
All eyes were on Han Sen— Although they had never seen him practising martial arts, they could tell from his skills of war-frame operation that his fitness was great.
...
He wanted to appoint Ouyang Xiaosan to show off, so that these students would realise the difference between a military student and the Chosen. However, Ouyang was not there, and beating a nobody would not help him achieve his objective.

**“Friend, your classmates have strongly recommended you, so please come up. It is just a practise, and the result does not matter,”** Yu Mingzhi smiled at Han Sen and said.
