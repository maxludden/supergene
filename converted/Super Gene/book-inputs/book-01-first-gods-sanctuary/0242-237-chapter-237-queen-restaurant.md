# Chapter 237: Queen Restaurant {.hidden-title}

<section id="chapter-237" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-237-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">237</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Queen Restaurant</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-237-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen’s roommates all widened their eyes, staring at Huangfu Pingqing who had walked up to Han Sen—</p>
...
There were both evolvers and it looked like they had already gained a lot of geno points. They both had practised great hyper geno arts. The man had both his arms looking like black metal, and the woman was wearing a pair of shorts, with her long legs gleaming like silver.
