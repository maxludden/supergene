# Chapter 7: Dollar {.hidden-title}

<section id="chapter-7" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-7-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">7</p>
</section>
...
<section class="element chapter-text" id="chapter-7-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">B</span>rother, you killed all these swift mantises?”** Su Xiaoqiao saw no one except for the guy in golden armour.</p>
...
**“Brother, my name is Su Xiaoqiao, and that’s my real name. My room number at Steel Armour Shelter is 1,046. How about you? What’s your name and where do you live?”** Su Xiaoqiao said.

**“Dollar. That’s the only thing I care about. Prepare some money, and I’ll go to room 1,046 once I have something.”** Han Sen put the money into his pocket, waved goodbye to Xiaoqiao and left Zephyr Valley.
