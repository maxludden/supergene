# Chapter 335: Follow the Turtle {.hidden-title}

<section id="chapter-335" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-335-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">335</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Follow the Turtle</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-335-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>rom the underground river emerged a head that was somewhat like an alligator’s. With its mouth wide open, it looked like the monster could easily swallow an entire cow, let alone a human.</p>
