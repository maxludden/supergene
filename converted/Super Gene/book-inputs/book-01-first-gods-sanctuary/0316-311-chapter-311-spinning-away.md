# Chapter 311: Spinning Away {.hidden-title}

<section id="chapter-311" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-311-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">311</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Spinning Away</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-311-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen waved at his friends and entered the archery range. At the same time, Jing Jiya also entered the range.</p>
...
Jing Jiya smiled and said nothing. He walked to the bow rack, took a 16.0 practise bow and a quiver full of arrows, and returned to Han Sen—
...
Everybody widened their mouth. Someone yelped and said, **“Spinning arrow! Isn’t that Han Sen’s spinning arrow? How come Jing Jiya can also do that?”**
...
He did appreciate what Jing Jiya could do. Although Jing Jiya had not practised Yin Yang Blast, he managed to achieve the effect of the spinning arrow by practising archery techniques alone.
...
The students were surprised by Han Sen’s choice of bow. He picked an 11.0 practise bow, which was too weak for any archery student. Anyone could easily use a bow like this.
