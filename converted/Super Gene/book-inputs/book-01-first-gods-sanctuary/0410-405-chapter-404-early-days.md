# Chapter 405: Early Days {.hidden-title}

<section id="chapter-405" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-405-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">405</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Early Days</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-405-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he Secret Service were the first men who ever used the teleport technology. The very first who came to God’s Sanctuary were not Han Jingzhi and the ancestor of the Nings, but ordinary crewmembers.</p>
