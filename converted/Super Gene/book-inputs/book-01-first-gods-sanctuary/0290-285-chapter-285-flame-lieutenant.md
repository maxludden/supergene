# Chapter 285: Flame Lieutenant {.hidden-title}

<section id="chapter-285" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-285-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">285</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Flame Lieutenant</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-285-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">B</span>east soul identified. Sacred-blood beast soul flame Lieutenant gained.”**</p>
...
Beast soul weapons would become sharper. Armour and shields would become tougher. And even shape-shifting beast souls would bring the users more power.
...
Unfortunately, aura beast souls were so rare that in the entire Steel Armour Shelter, only Son of Heaven had a mutant beast soul aura.
