# Chapter 362: Bloody Battle {.hidden-title}

<section id="chapter-362" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-362-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">362</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Bloody Battle</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-362-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he black metal wolf quickly flashed in front of Chen Nanxing, who was fast enough to summon a large copper shield more than 3 feet tall to block its claws.</p>
...
However, the behaviour of the wolf showed them some hope. The reason they could not kill the wolf before was that they could not even hit it. However, if the wolf chose to block their way, it had to bear their attacks. This way, maybe they would have a chance to kill it.
...
Seeing the claws almost at his chest, although Ye Yufeng was wearing sacred-blood armour, he did not think it could protect himself. This is the end of me. He thought.
