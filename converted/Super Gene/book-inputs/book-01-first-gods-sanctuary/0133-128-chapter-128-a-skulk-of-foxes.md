# Chapter 128: A Skulk of Foxes {.hidden-title}

<section id="chapter-128" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-128-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">128</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">A Skulk of Foxes</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-128-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen and Gambler exchanged a look and ran after her, in case of any accident.</p>
...
And then she saw many creatures that looked like this one though grey in colour walking out from behind the dune. They filled the place shortly and were at least hundreds in number.
...
The distance between the two sides was gradually shortened, and soon they have joined forces. When the team looked around, they were surprised to see thousands of grey creatures flooding toward them.
