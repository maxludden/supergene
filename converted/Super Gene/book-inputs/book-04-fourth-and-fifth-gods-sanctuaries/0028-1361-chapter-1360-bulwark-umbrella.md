# Chapter 1361: - Bulwark Umbrella {.hidden-title}

<section id="chapter-1361" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1361-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1361</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Bulwark Umbrella</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1361-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was taken aback when he saw what emerged from his Sea of Soul. It was an umbrella. It was thin-framed and elegant, like the sort you’d see fancy women use.</p>

Its colour was blacker than the filthiest coal, though. Even its handle was.
...
Beneath the protective canopy of the Bulwark Umbrella, no power was able to breach the defence and ravage them. Bao’er had returned to normal, and she seemed surprised by the sudden disappearance of the cold and sound. She examined the umbrella that now shielded her.
...
Looking closer, they realised it was a tree.
