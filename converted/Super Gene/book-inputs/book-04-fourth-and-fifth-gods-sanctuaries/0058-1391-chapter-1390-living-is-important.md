# Chapter 1391: - Living Is Important {.hidden-title}

<section id="chapter-1391" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1391-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1391</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Living Is Important</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1391-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen noticed it was a mini-me of the Death Demon Dragon; an exact, but smaller version of the creature. It was three meters long and purple in colour. It was still rather large, but that was just a testament to how big the papa mantis really was.</p>
...
**“Damn you!”** Han Sen lifted the egg up and pushed it to meet with the blades.
...
Han Sen thought the gemstone geno core was too much for him to deal with, in his current status. He had gotten in too deep, and the mantis’ recovery was far faster than expected. It was quicker than its owner, and ready to return to Han Sen in another bid to slay him.
