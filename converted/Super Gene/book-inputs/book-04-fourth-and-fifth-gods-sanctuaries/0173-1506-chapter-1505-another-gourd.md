# Chapter 1506: - Another Gourd {.hidden-title}

<section id="chapter-1506" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1506-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1506</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Another Gourd</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1506-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">L</span>ittle Uncle, why are you here?”** Han Sen asked the man who was only a minor distance away. It was the unluckiest man he had ever met: Wang Yuhang.</p>
