# Chapter 1577: - Clue {.hidden-title}

<section id="chapter-1577" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1577-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1577</p>
</section>
...
<section class="element chapter-text" id="chapter-1577-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">D</span>estroyer Wolf got away through a space crack. What clue do you think you can find here?”** Elysian Moon said, frowning.</p>
