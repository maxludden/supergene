# Chapter 1605: - Common Enemy {.hidden-title}

<section id="chapter-1605" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1605-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1605</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Common Enemy</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1605-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>lowing Sand Dune was three hundred square miles, and it was definitely a forbidden place in Wind Song Desert. Even the storm wouldn’t come to this place.</p>
...
Its giant body suddenly leapt into the sky, and it unleashed a wave of its dragon breath. The terrifying force lashed toward Han Sen, who was still running forward.
...
Han Sen looked around and realised that the desert around him now had some scattered trees. He was definitely leaving Wind Song Desert.
