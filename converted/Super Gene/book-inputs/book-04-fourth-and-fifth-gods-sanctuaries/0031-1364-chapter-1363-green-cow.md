# Chapter 1364: - Green Cow {.hidden-title}

<section id="chapter-1364" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1364-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1364</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Green Cow</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1364-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>ho is that? Hopefully it’s Old Man Ji,”** Han Sen thought to himself.</p>
...
The detection of humans there grew fainter for Han Sen, as his attention shifted to the shelter that was occupied by a ratio that favoured a mixture of spirits and creatures.
...
**“Does this demigod like to maintain a low profile? Does he like keeping things on the down-low?”** Han Sen curiously pondered.
