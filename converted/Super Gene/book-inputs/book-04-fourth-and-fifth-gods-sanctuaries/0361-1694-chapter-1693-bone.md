# Chapter 1694: - Bone {.hidden-title}

<section id="chapter-1694" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1694-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1694</p>
</section>
...
<section class="element chapter-text" id="chapter-1694-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen put the item in his hand. It was around ten centimeters long, and it looked like a bone. But it didn’t feel like a bone; it actually felt heavier than metal.</p>
