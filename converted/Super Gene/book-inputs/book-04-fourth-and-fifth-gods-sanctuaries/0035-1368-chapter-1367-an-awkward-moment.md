# Chapter 1368: - An Awkward Moment {.hidden-title}

<section id="chapter-1368" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1368-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1368</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- An Awkward Moment</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1368-text" markdown="1">
<p class="first2"><span class="first-letter">J</span>ia Shidao was extremely confident in the white-knuckle power his fists could deliver, so he didn’t summon a geno core. The Iron-Fist Martial Hall was made famous by his Iron-Fist Slash, a brutal move when coupled with his fitness level.</p>
...
This gold geno core he had summoned was a pair of giant scissors laden with fish teeth. They looked to have been forged of black-steel, and they were frighteningly sharp.
