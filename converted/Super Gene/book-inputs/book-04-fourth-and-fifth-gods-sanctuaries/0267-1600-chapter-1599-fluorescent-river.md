# Chapter 1600: - Fluorescent River {.hidden-title}

<section id="chapter-1600" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1600-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1600</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Fluorescent River</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1600-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he king of mice stopped in front of the holes in the sand, then it called to the group of mice behind it. The sand mice immediately ran into the holes.</p>
...
Lin Feng and Jing Jiwu had thought that Little Star had the power to dig holes, but instead, Little Star was travelling straight through the sandstone layers.
...
**“Han Sen, you’re just favoured by God. You have all the nice things in the world. How are we supposed to catch up?”** Asked Jing Jiwu, smiling.
