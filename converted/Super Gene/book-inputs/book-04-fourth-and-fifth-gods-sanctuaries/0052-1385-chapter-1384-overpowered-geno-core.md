# Chapter 1385: - Overpowered Geno Core {.hidden-title}

<section id="chapter-1385" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1385-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1385</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Overpowered Geno Core</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1385-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">B</span>lack Mountain God, why do you insist on bothering me? Would it not be better to challenge Real Demon, instead?”** Inside Geno Core Storage, an elegant spirit was speaking to a creature with black wings.</p>
