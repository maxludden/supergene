# Chapter 1500: - Kill {.hidden-title}

<section id="chapter-1500" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1500-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1500</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Kill</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1500-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen’s eyes were filled with murder, and he threw a punch towards Naga. His powerful fist did not look special, at all. But the power he had gathered up in that one thrown fist was enough to sunder an alloy battleship.</p>
