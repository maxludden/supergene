# Chapter 1341: - Sheep {.hidden-title}

<section id="chapter-1341" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1341-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1341</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Sheep</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1341-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen placed the Dust Bug on his finger. The geno core was so small, he needed the Dongxuan Aura just to see it.</p>
