# Chapter 1478: - Meeting Six Paths Again {.hidden-title}

<section id="chapter-1478" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1478-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1478</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Meeting Six Paths Again</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1478-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter listening to that sound, Han Sen’s face changed. It wasn’t music played by a piano; it was the sound of a sword that was reminiscent of one.</p>
