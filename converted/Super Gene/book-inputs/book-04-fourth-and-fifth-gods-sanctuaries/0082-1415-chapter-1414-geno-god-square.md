# Chapter 1415: - Geno God Square {.hidden-title}

<section id="chapter-1415" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1415-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1415</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Geno God Square</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1415-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>sn’t the pendant a geno core given by this God dude? Can its power really not be enough to open the coffin?”** Han Sen asked the creature. He wasn’t too surprised the Nine-Life Cat was able to talk, given its reputation.</p>
...
The Nine-Life Cat leapt back onto the lid of the coffin, to resume the position Han Sen had originally seen him. He explained, **“I promised to guard this shelter until an heir of God came to open it. My task has now been fulfilled. There is no use me staying here anymore.”**
