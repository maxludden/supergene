# Chapter 1507: - Human Emperor {.hidden-title}

<section id="chapter-1507" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1507-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1507</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Human Emperor</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1507-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen saw the green gourd, but he did not stare at it. He didn’t want the elder to get the wrong idea.</p>
...
**“Well, otherwise, why would I practise? If it isn’t for the girls, who else? You?”** Wang Yuhang smiled.
