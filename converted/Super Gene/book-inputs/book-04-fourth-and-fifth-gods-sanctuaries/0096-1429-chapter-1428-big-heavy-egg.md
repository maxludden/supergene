# Chapter 1429: - Big Heavy Egg {.hidden-title}

<section id="chapter-1429" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1429-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1429</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Big Heavy Egg</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1429-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter using his Dongxuan Aura to scan what he could of the pit, Han Sen was unable to detect the presence of any creature residing in the dark down there.</p>
...
It was black and white in colour, but the white parts were fluorescent. They were almost like neon bulbs. Acknowledging this, Han Sen quickly—and correctly—determined that they were the lights he had caught sight of briefly earlier.
...
Han Sen made sure to suppress his breathing and mask his life-force, so he could remain in hiding and spy on it for a while. Whatever it was looking for might have been a worthy treasure he could snatch for himself.
...
As Han Sen watched with waning curiosity, something suddenly appeared in the deepest reaches of where the creature had dug. It looked like a porcelain object, and it had a creamy, subdued white colour.

When the monster found it, it began digging with renewed vigour. It went faster. It went harder.

The porcelain object was like a pot or some-such, but it was difficult to make out in the flying earth. Initially, due to its shape, Han Sen believed it to be an item that was the handiwork of primitive humans, but as more of it became unearthed, he realised it was actually an egg.
...
**“Here goes nothing!”** Han Sen braced himself, then leapt over to the egg.
...
Finding an unsupervised super egg was incredibly rare, though, and the thought of abandoning it caused him heartburn. The entire situation was comparable to winning the lottery, but later realising you had already trashed the golden ticket.
