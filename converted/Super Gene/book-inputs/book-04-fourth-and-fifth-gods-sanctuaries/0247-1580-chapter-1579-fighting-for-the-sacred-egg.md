# Chapter 1580: - Fighting for the Sacred Egg {.hidden-title}

<section id="chapter-1580" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1580-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1580</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Fighting for the Sacred Egg</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1580-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>s there a creature here that not even the Destroyer Wolf and the Rolling Dragon know of? Perhaps they know about it, but they’re letting the creature hide here for some reason?”** Han Sen frowned.</p>
...
The creature was holding a bow, and the colour of the bow resembled the colour of the horns on his head.
...
**“You—”** The Rolling Dragon King was terrified as he realised that he had been tricked by the Destroyer Wolf.
