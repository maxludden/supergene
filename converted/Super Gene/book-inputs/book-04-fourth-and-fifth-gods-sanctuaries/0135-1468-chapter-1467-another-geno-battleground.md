# Chapter 1468: - Another Geno Battleground {.hidden-title}

<section id="chapter-1468" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1468-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1468</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Another Geno Battleground</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1468-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he minor issue mentioned by the green-clothed woman was a berserk super creature guarding the spirit statue.</p>
