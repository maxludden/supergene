# Chapter 1473: - Rushing Into Something {.hidden-title}

<section id="chapter-1473" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1473-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1473</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Rushing Into Something</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1473-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen retreated a bit, trying to get a better look at what it was. It wasn’t a big fish like he initially presumed it to be.</p>

Its body did look like that of a fish, but it had legs. It didn’t have any scales, and its body was made up of a keratinous shell. The colour of the beast was black like ink.

It was no wonder why the shadow in the water was so dark, with its colour.
