# Chapter 1651: - Killing Blood Dog {.hidden-title}

<section id="chapter-1651" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1651-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1651</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Killing Blood Dog</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1651-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>t happened in a millisecond. The Blood Dog’s body suddenly split up into multiple parts, and they all became smaller Blood Bats. They then flew towards Dragon Lady.</p>
...
The bats inside all gathered up together, becoming a Blood Dog once more. With canine strength, it leapt up and knocked the lid open. Then the beast leapt towards Dragon Lady once more.
