# Chapter 1440: - Collecting Taxes {.hidden-title}

<section id="chapter-1440" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1440-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1440</p>
</section>
...
<section class="element chapter-text" id="chapter-1440-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>hese maggots are not mine. If they were, they’d have my scent. My scent would be picked-up by Snake King, and the elder would surely find out it was me behind this,”** Spirit Twelve said coldly.</p>
...
Again, the maggot king did not dodge. The mask fell upon its face and moulded to its shape for a perfect fit.
