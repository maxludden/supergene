# Chapter 1495: - Fight Between a Fish and a Crab {.hidden-title}

<section id="chapter-1495" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1495-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1495</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Fight Between a Fish and a Crab</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1495-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>t wasn’t easy, suffering that first barrage of lightning. It had damaged the Bulwark Umbrella, covering it in cracks. The crab, seeing that Han Sen was not dead, swung its pincers to provoke the eel more.</p>
...
The Alien Beast’s body lent itself well to underwater manoeuvrability. Its speed in the water was far greater than Han Sen’s natural body. Unfortunately, it still wasn’t as fast as the crab.
...
**“Damn crab! Don’t let me find the opportunity to kill you.”** Han Sen watched them in the air, planning how he might execute a sneak-attack to kill the crab whenever the time was right.
...
Seeing the cruel crab’s face, Han Sen realised that even if the eel died, he wouldn’t be able to get anything. If Han Sen didn’t run, though, the crab would only return its attention to Han Sen once the battle with the eel was over.
...
The wounded eye’s defence wasn’t very strong. The red light pierced through it, and Taia sank almost entirely into the damaged left eye.
