# Chapter 1571: - Number 4 {.hidden-title}

<section id="chapter-1571" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1571-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1571</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Number 4</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1571-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen himself was surprised. Although he had seen Luo Haitang in God-slayer Shelter, he hadn’t agreed to any of the man’s requests or given him anything. So, why would the old man send a gift? It seemed as if he really wanted to re-establish a connection with Luolan.</p>
