# Chapter 1509: - A Man Like God {.hidden-title}

<section id="chapter-1509" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1509-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1509</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- A Man Like God</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1509-text" markdown="1">
<p class="first2"><span class="first-letter">J</span>i Yanran took Little-flower over to see the Ji family for a while. It was safer for them to be there, too, since they had a high number of demigods for protection, not to mention Old Man Ji himself.</p>
