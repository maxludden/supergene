# Chapter 1574: - Blow Blood {.hidden-title}

<section id="chapter-1574" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1574-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1574</p>
</section>
...
<section class="element chapter-text" id="chapter-1574-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">Y</span>ou and your secret can go to hell.”** Han Sen wasn’t having any of it. Wearing the Ghost Armour given to him by Ghost Eye, he dashed in front of the creature and attempted to punch its head in.</p>
