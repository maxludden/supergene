# Chapter 1549: - A Room {.hidden-title}

<section id="chapter-1549" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1549-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1549</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- A Room</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1549-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was standing in a room. He looked at it in strange awe, with his mouth hanging wide open.</p>
