# Chapter 1596: - Evil Goblin {.hidden-title}

<section id="chapter-1596" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1596-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1596</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Evil Goblin</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1596-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen and the others were all surprised. They had never heard of the singing voice in the storm calling someone’s name. However, there was no mistaking what the voice was saying now; it was clearly calling Han Sen—</p>
...
They were both very worried as they realised that Jing Jiwu might be in great danger. However, they couldn’t do anything more than keep walking, hoping that they could still save Jing Jiwu.
