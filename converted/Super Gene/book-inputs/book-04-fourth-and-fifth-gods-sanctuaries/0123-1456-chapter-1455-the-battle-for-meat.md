# Chapter 1456: - The Battle for Meat {.hidden-title}

<section id="chapter-1456" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1456-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1456</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Battle for Meat</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1456-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he skin was easy to heal, but bones and veins were not. Fortunately, the red Ganoderma was able to provide effective healing for all three.</p>
...
If Han Sen wasn’t going anywhere right now, he could only spend his time practising the Dongxuan Sutra and Jade-skin so he could regenerate the Bulwark Umbrella and the Crystal Core.

Getting them back was easier than generating them the first time had been. All it took, more than anything, was time.

Han Sen tried to absorb the two Super Geno Essences he had retrieved, but for some reason, he was unable to. Han Sen tried to simulate the creatures’ energy flows, but it was to no avail. He guessed he might have been too weak to do that, in his current form.

Han Sen tried researching and experimenting for a while, but he was unable to pinpoint why he couldn’t absorb the Super Geno Essences. He did notice that the energy inside them was strange, and somewhat different than what he had seen before.

It was like the two Super Geno Essences were not just power; there was a life inside.

**“The shell king and the red cricket are dead. How can their Super Geno Essences harbour a life-force? It’s almost as if these things are unborn eggs. Does this mean they can come back to life?”** Han Sen thought, but he was unsure whether or not that was true.
