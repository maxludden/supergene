# Chapter 1430: - Ling Mei’er {.hidden-title}

<section id="chapter-1430" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1430-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1430</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Ling Mei’er</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1430-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">S</span>nake King, this egg looks special. Does it belong to a super creature?”** The lady dismounted the snake and ventured towards the egg; she stroked the egg as she spoke.</p>
...
The creature was actually Han Sen— The issue with the egg, Han Sen had realised, was that it was actually empty and devoid of any yoke.
