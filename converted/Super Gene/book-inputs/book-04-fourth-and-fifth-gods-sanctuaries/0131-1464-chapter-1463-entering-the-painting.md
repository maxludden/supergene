# Chapter 1464: - Entering the Painting {.hidden-title}

<section id="chapter-1464" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1464-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1464</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Entering the Painting</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1464-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">A</span> new geno core has immediately reached first place again? Is this world truly changing?”** The woman frowned, and then asked the spirit, **“Which geno core reached the top?”**</p>
...
Han Sen did not want his Coin geno core up there, as it was recognisable to humans.
...
And just as Han Sen thought about this, it happened. Six Paths sent Han Sen a challenge request. He ignored it, however. If he levelled up to silver class in the time-frame he expected to, he didn’t need to accept any fights.
...
Han Sen went to the stone and spoke to it. Again, there was no reply, and so he just gave up and went back to practising with Taia.
...
But Han Sen was just shooting the breeze, and his practise might prompt the woman on the stone to speak.
