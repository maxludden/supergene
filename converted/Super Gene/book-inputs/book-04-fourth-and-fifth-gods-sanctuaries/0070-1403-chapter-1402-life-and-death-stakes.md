# Chapter 1403: - Life and Death Stakes {.hidden-title}

<section id="chapter-1403" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1403-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1403</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Life and Death Stakes</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1403-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen brought the fifty fruits he had been given by Yu Xuan inside the shelter with him, bringing them along as food to sustain him.</p>
...
Zhong Sanxiao then baulked, but asked, **“And how do we find out who the luckiest amongst us is? Toss a coin?”**
