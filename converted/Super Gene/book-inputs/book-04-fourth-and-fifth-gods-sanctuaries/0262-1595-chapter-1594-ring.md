# Chapter 1595: - Ring {.hidden-title}

<section id="chapter-1595" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1595-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1595</p>
</section>
...
<section class="element chapter-text" id="chapter-1595-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">L</span>in Feng?”** Han Sen asked when he heard the man’s voice. With much glee, he ran over to him.</p>
