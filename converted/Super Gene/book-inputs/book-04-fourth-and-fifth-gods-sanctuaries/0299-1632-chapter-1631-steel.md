# Chapter 1632: - Steel {.hidden-title}

<section id="chapter-1632" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1632-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1632</p>
</section>
...
<section class="element chapter-text" id="chapter-1632-text" markdown="1">
<p class="first2"><span class="first-letter">D</span>ollar’s name was very famous. Humans had also gotten used to referring to him as The Light of Hope.</p>
