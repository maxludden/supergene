# Chapter 1451: - Redhead Cricket {.hidden-title}

<section id="chapter-1451" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1451-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1451</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Redhead Cricket</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1451-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>zi Tzi Tzi Tzi!</p>
...
Han Sen heard the sound of something banging around up ahead, and it was then that he realised the cave narrowed to allow only one person to pass through at a time. Snake King was outside, slamming into the stone to widen the way.
...
But the smile on his face was quickly lost, as the cricket emerged alive, staggering out of the dust. The mushroom had not damaged it. There was no blood, and its life-force showed no sign of being any weaker than it was before.
