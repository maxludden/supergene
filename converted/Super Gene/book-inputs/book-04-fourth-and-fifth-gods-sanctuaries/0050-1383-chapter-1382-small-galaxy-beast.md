# Chapter 1383: - Small Galaxy Beast {.hidden-title}

<section id="chapter-1383" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1383-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1383</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Small Galaxy Beast</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1383-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>— have to be cruel here. I need power to kill that mangy mutt, but this thing must have the ability to soften the will of an enemy.”**</p>
...
Then, all of a sudden, Galaxy Beast spat out another Star-sea Orb. It hovered for a while, but then dropped into a cubicle of water that enveloped Han Sen—
...
**“It looks like that woman is rather high-tier. Typical. Picking bones with the big guns already. Whatever the case may be, it looks like I might need more than just mutant geno points to settle this feud.”** Han Sen spent much time deliberating how he might serve his favourite cold dish.
...
Levelling up was the number one task on his agenda, to begin with. And he started by maxing out his primitive geno points.

When the woman and the dog saw Han Sen, he was in super king spirit mode. The next time they met, his attackers wouldn’t recognise him as the person they assaulted in the wilds.
