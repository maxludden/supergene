# Chapter 1404: - The Man That Opened the Wall of Destiny {.hidden-title}

<section id="chapter-1404" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1404-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1404</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Man That Opened the Wall of Destiny</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1404-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>f you can promise me one thing, I can go,”** Han Sen said.</p>
...
His hand was brimming with the power of Jade-skin, and when it came into contact with the wall, electricity suddenly surged through him.
