# Chapter 1366: - No Fluctuations in Power {.hidden-title}

<section id="chapter-1366" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1366-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1366</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- No Fluctuations in Power</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1366-text" markdown="1">
<p class="first2"><span class="first-letter">Z</span>hu Donglai regretted giving up on taking Han Sen as a disciple before. He had found someone else to practise the Purple Manor Sutra with, following Han Sen’s injury in the Third God’s Sanctuary. He hadn’t expected that a person whose body was believed to be destroyed, even by the likes of Luo Haitang, could recover and go on to achieve such greatness.</p>
...
**“It will be difficult to tell, indeed. And I don’t think Han Sen practised the technique of the Luo family, either,”** Zhu Donglai said.
...
Five thousand was the bare minimum required for a person to join the Demigod Association. Very few demigods were capable of doing what Han Sen had just displayed.
...
Green was amazed at Han Sen’s ability to dictate the power output. It was like he had dialled himself to deliver a power of five thousand and leave it like that, without the slightest wavering.
