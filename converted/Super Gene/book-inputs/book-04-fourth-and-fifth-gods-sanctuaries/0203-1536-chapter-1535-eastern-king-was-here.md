# Chapter 1536: - Eastern King Was Here {.hidden-title}

<section id="chapter-1536" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1536-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1536</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Eastern King Was Here</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1536-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he text Han Sen saw across the tower was in a human language, but he was too lazy to think about that. The content spoke about the Blood-Pulse Sutra. This surprised him, though.</p>
...
Han Sen was frozen. Eastern King had been there before them, but the words he wrote sucked. It was like something the average traveller would write when leaving their name someplace.
