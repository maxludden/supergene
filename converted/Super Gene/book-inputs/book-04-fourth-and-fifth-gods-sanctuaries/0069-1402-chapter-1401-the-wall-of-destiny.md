# Chapter 1402: - The Wall of Destiny {.hidden-title}

<section id="chapter-1402" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1402-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1402</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Wall of Destiny</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1402-text" markdown="1">
<p class="first2"><span class="first-letter">O</span>n the final side of that construct, there were no diagrams or depictions. Instead, there was only text and a lot of it.</p>

Han Sen believed this might have been the second half of Life Door at first, but he soon realised it wasn’t. It was a simple, poignant text that concerned itself with destiny.
...
As they walked, they soon realised they were lost. They were struggling to get back to the way they had come in, and the map offered no sound guidance.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Nine-Sky Fruit consumed; Sacred Geno Point +1.”</em></p></section>
</section>
