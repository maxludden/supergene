# Chapter 1608: - Getting into Outer Sky {.hidden-title}

<section id="chapter-1608" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1608-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1608</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Getting into Outer Sky</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1608-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he Yu family spirits were going to ask the approaching army what was going on. But before Han Sen was even close enough to open a dialogue, a punch was being thrown their way.</p>
