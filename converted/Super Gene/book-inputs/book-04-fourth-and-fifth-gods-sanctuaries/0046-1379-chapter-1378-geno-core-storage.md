# Chapter 1379: - Geno Core Storage {.hidden-title}

<section id="chapter-1379" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1379-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1379</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Geno Core Storage</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1379-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>ho do you think the new master will be?”**</p>
...
Everyone went deathly silent when they saw. If the next master wasn’t up to par and was not very favourable, there was every chance of them leaving.
...
**“It’s a human!”** A number of them baulked, in unison. This came as a grand surprise for each and every one of them.
...
**“Don’t expect much change. The rules you knew before are still in place. No oath or contract is put upon you to remain here. Your freedom is intact, and you can all continue living here. So, rock on, I guess.”** Han Sen finally spoke, with a casual tone of voice that sought to comfort any fears they were harbouring.
