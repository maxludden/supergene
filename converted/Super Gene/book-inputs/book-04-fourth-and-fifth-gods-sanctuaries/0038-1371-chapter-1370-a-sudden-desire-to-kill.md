# Chapter 1371: - A Sudden Desire to Kill {.hidden-title}

<section id="chapter-1371" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1371-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1371</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- A Sudden Desire to Kill</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1371-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was curious to see who Nan Litian really was. Thus far, the man had been a complete enigma. After walking outside the gate, Han Sen looked ahead to see a human riding atop a black unicorn.</p>
...
Its speed was nothing short of frightening, though, and even with his Jade-skin activated, the spear managed to graze him in his evasion. And even that was enough to draw blood.

Han Sen realised the gulf in fitness between the two was far too great. This called for diplomacy.
...
**“Wait a minute; I’m on the path that leads to Hidden Valley,”** Han Sen suddenly realised.
</section>
