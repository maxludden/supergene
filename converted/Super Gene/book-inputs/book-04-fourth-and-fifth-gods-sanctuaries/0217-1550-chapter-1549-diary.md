# Chapter 1550: - Diary {.hidden-title}

<section id="chapter-1550" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1550-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1550</p>
</section>
...
<section class="element chapter-text" id="chapter-1550-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was very eager to read the contents of the diary.</p>
