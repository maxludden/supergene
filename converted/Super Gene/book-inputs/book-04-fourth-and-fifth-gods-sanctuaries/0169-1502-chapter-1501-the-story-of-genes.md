# Chapter 1502: - The Story of Genes {.hidden-title}

<section id="chapter-1502" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1502-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1502</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Story of Genes</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1502-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">C</span>rystallizers wrote in a human language?”** Han Sen was very surprised.</p>

This seemed to be an impossible scenario. When the first Crystalliser ruins were discovered, humans found that the Crystallisers used strange symbols for text. Human text associated with a Crystalliser ruin had never been witnessed before. Han Sen could read the human text of this book, and he could immediately see that it was titled The Story of Genes.
...
Han Sen flipped the book open and his face looked strange as he peered into it. He said, **“This seems like a method to practise a Qi Gong, but at the same time, it’s not. Hmm, this is weird.”**

**“Is it a way for the Crystallisers themselves to practise?”** Ji Yanran asked, exhibiting shock.

**“It could be a method of practise for the Crystallisers, but considering how it describes the body, it seems to be referring to the human body,”** Han Sen said.
...
Han Sen shook his head. **“Although it may appear like a human Qi Gong, and I can read the contents, it’s strange enough to also not be a Qi Gong. I don’t think humans can practise this way.”**

**“What does that mean?”** Ji Yanran looked confused, unsure of what Han Sen meant.

Han Sen composed his thoughts before returning to speak. **“I don’t really get it. It’s like humans are unable to breathe in water, but practising the Qi Gong assumes they can do just that. So, being able to breathe underwater is a fundamental skill for practising this. There are many methods in the book that are like this; ones that humans cannot do. Even I, as a demigod, could not do all this. I suspect only gods can.”**
...
Han Sen took a few more Crystalliser items from the lounge, and then he brought Little-flower and Bao’er back on board the beetle. They pushed forward to explore other areas.

The Crystallisers possessed many things that humans did not understand. Han Sen and Ji Yanran were only able to understand whatever the beetle told them. It was very shocking that a planet like this had been artificially created.
...
**“What race were the Crystallisers most similar to? This is weird.”** Ji Yanran looked at where the Main Control Room had disappeared to.
...
Han Sen could not even figure out the enigmatic business concerning his own family. He wasn’t in the mood to work on the mysteries of this civilisation.

Han Sen was interested in The Story of Genes, though. He didn’t know if the book belonged to a human or a Crystalliser.

The methods of practising were really strange, and they seemed impossible to learn.
...
Ji Yanran held Little-flower. She looked confused as she examined the interior of the cargo bay. And then she asked, **“Sieg, your ship looks like a Gold Bull from the Starry Group. But it doesn’t look quite right. Is this the latest model, by any chance?”**
