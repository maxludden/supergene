# Chapter 1401: - My Life Is My Life {.hidden-title}

<section id="chapter-1401" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-1401-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">1401</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- My Life Is My Life</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-1401-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen followed Mister Li closely, as they all entered and ventured between the narrow pathways of the shelter. They said that as long as they did not approach that one construct, their passage would mostly be fine.</p>
...
It was then that everyone realised Yu Zhiyou was the only one who had read the words written in the text. It couldn’t have been a coincidence he was the first to kick the bucket.
