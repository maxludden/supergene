# Chapter 586: Red Mushrooms {.hidden-title}

<section id="chapter-586" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-586-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">586</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Red Mushrooms</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-586-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was amazed. Seeing a creature bring its children to eat was an incredibly rare sight, one that few people would ever be given the honour of seeing.</p>
