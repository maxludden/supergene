# Chapter 585: Red-Scale Dragon {.hidden-title}

<section id="chapter-585" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-585-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">585</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Red-Scale Dragon</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-585-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>atching Dollar battle is so boring. I want to watch Han Sen battle Yi Dongmu; two assassins fighting each other would be pretty fun!”** Tang Zhenliu sat on his sofa rewatching the video of Yi Dongmu and Dollar’s final battle.</p>
...
But Yi Dongmu was really powerful, and if it wasn’t for Han Sen’s constant practise of wind strike with him, he most likely would not have been able to block the skill. The win didn’t feel entirely clean, and it made Han Sen feel a little ashamed.
...
**“Holy smokes, it’s turning Berserk! Run!”** Han Sen yelled, and then started running away.
