# Chapter 749: Cheater of the Second-Generation {.hidden-title}

<section id="chapter-749" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-749-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">749</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Cheater of the Second-Generation</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-749-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>ithout a choice in the matter, Han Sen quickly brought Zhou Yumei back to the shelter.</p>
...
But this only added to Han Sen’s confusion. **“If that person was not Qin Huaizhen, who was he? Why would he possess Qin Huaizhen’s working licence?”**

**“Hm, I must have been fooled then. I apologise.”** Han Sen coughed afterwards.
...
But after his time reading, Han Sen began to pick up on the fact that Blood-Pulse had a greater depth to it than Jade-skin.

While Han Sen had only unlocked one, Jade-skin had nine tiers he could unlock in total.
...
Practising Blood-Pulse could extend your powers with it. The powers you earned could also be genetic, and their traits and benefits could be passed down to your children when they were born.

To put it more scientifically, after practising Blood-Pulse, it would be written down in your genetic code. The generation that followed the learner would be granted the powers when they were born.
