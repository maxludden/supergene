# Chapter 496: Royal Shelter {.hidden-title}

<section id="chapter-496" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-496-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">496</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Royal Shelter</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-496-text" markdown="1">
<p class="first2"><span class="first-letter">U</span>nfortunately, Han Sen did not have a mutant beast soul from Second God’s Sanctuary, so he could not test the upgrade time of a mutant beast soul.</p>
...
Seeing the sacred-blood creatures among the groups, Han Sen immediately decided against a sneak attack. Last time, there was Star-wheel Shelter as his backup, which he now did not have. If he went there alone, he would most definitely get himself killed.
