# Chapter 432: One More Time {.hidden-title}

<section id="chapter-432" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-432-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">432</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">One More Time</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-432-text" markdown="1">
<p class="first2"><span class="first-letter">G</span>radually, Han Sen felt that it was not because Lu Bin did not have the intention to kill, but because Lu Bin’s intention to kill was too strong.</p>
...
Lu Bin’s leg skills were practical, which meant the skills not that unusual. Having learned Panorama which was an encyclopaedia of all kinds of commonly seen skills, Han Sen felt it was easy to mimic Lu Bin’s Killer Kicks. In fact, many people could easily imitate the skills, but the true difficulty was how to use it well.

Depending on one’s capability and mentality, the same leg skills were different when used by different people. It was especially true when it came to these kicks that were designed for life-and-death battles. Small difference could realise in completely different result.
...
**“Killer Kicks— He is also using Killer Kicks—”** Wang Daqing finally realised that and could not help exclaiming.

Others suddenly realised Wang Daqing was right. A Soldier On Warship was also using Killer Kicks. He was able to use Killer Kicks in front of Lu Bin and did not seem to fall short.
...
**“As you wish.”** Lu Bin could no longer resist the murderous urge. He dashed and jumped up with no hesitation, kicking at Han Sen as if his leg was the battle axe that split heaven and earth.
