# Chapter 470: Image on the Crystal Card {.hidden-title}

<section id="chapter-470" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-470-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">470</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Image on the Crystal Card</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-470-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">Y</span>ou are all official researchers in the Alliance. Haven’t you thought about the consequences?”** Ji Yanran frowned at the researchers and said.</p>
...
**“For something inside the Crystalliser ruin, you are willing to give up everything in the Alliance without knowing what it is?”** Ji Yanran asked.
...
**“Just some crystals, right? What else could be in a Crystalliser ruin?”** Ji Yanran asked, seemingly puzzled.
...
However, each of the researchers carried such a card. Although they were of different colour and design, Han Sen still could tell it was the same access card.
...
**“Did you practise Micro Crystal?”** Han Sen looked at Ji Yanran, surprised. He was lucky to have succeeded in practising Micro Crystal and become immune to the wandering light. At such a young age, if Ji Yanran also succeeded in practising Micro Crystal, then it would be truly impressive.

**“I have not practised Micro Crystal. However, Bone Energy of my family makes me immune to the wandering light as well.”** Ji Yanran was quite proud.
