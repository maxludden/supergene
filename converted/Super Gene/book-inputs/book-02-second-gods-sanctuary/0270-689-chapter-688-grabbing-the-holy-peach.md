# Chapter 689: Grabbing the Holy Peach {.hidden-title}

<section id="chapter-689" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-689-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">689</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Grabbing the Holy Peach</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-689-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he lower peach was different than the upper peach. The lower peach was mostly green and pale and only a little bit red. It looked like it would still take some time for it to mature.</p>
...
The blue beast, resting on the branch of a tree, jumped down. It walked forward and stared at the upper regions of the tree, where the peach hung. Its eyes shone a blue colour, but again, even this creature did not dare to approach the tree fully.
...
The black bugs were flushed into the tornado and carried far away. The tornado was discoloured, and it looked black. The number of bugs present in there was sickening to imagine.
