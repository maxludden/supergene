# Chapter 563: Snake-King Slaying Party {.hidden-title}

<section id="chapter-563" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-563-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">563</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Snake-King Slaying Party</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-563-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>eeing Han Sen draw nearer to the valley’s exit, Wang Liang hurried the group into battle formation. They were ready to fight against the snake-king.</p>
...
As he cursed Han Sen, Wang Liang caught a glimpse of a certain flame. A red fire-bird that looked like a phoenix appeared, drawn from Han Sen’s body. The flames were scorching hot, and they rose high into the air. In just a moment, the flames had encircled the entire area.
...
But no weak point could be found. The silver scales could endure ten strikes from the evolvers, and with such defence, there was no need for it to move around and protect certain parts of its body. It could bear the brunt of any attack.
...
He wanted to wait a while longer, so that the poison of the ghost-pawed claws might take effect. But there was no change in the snake-king’s behaviour, and it didn’t seem to work. It was as powerful as ever.
...
The formation they were in was the result of much practise and perfect synchronicity between the elite evolvers. Never had they been issued a command that altered this formation, and no matter how smart they thought Han Sen was, they didn’t think he could randomly come up with a brand-new and better formation; and nor did they want him to.

Because these changes could result in an accident, it was now down to an individual’s talent; the daily training and practise of blocking, dodging and striking were more important than ever. No immediate command such as this could put them in a better position than they already were.
