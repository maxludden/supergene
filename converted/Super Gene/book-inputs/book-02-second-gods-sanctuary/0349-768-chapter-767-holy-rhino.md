# Chapter 768: Holy Rhino {.hidden-title}

<section id="chapter-768" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-768-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">768</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Holy Rhino</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-768-text" markdown="1">
<p class="first2"><span class="first-letter">E</span>ven the black-flame phoenix and dark cloud refused to draw closer at this time. It was the same for Han Sen, who chose to only watch the gallons of blood stain the black sand.</p>
...
The white rhino’s flesh peeled away, ceaselessly unravelling. Beyond the blinding lights, he could make out the shape of its disintegrating skeleton. More and more streams of blood began to appear, like the birth of mountain waterfalls. And all the while, the motionless rhino cried out in agony.
...
A hooved chimerical creature emerged from the clouds, and its skin was green. It was a frightening thing, and it looked like a cross between a dragon and a unicorn; like a Qilin.
...
A tear left the white rhino’s lifeless eyes. The blood-scourged eyes made the tear look so pure. It was like jewellery, glistening brightly.
