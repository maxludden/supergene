# Chapter 538: Qi Gong {.hidden-title}

<section id="chapter-538" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-538-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">538</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Qi Gong</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-538-text" markdown="1">
<p class="first2"><span class="first-letter">J</span>i Yanran patiently explained what it was all about, but Han Sen quickly understood what she really meant. In his heart, he felt shocked.</p>
...
This knowledge was frightening enough. A human evolver with excellent genes only averages around 30. Those with excellent genes from the Second Shelter are said to have a fitness level of around 130 to 150.
