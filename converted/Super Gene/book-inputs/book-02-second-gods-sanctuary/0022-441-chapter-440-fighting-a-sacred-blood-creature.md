# Chapter 441: Fighting A Sacred-Blood Creature {.hidden-title}

<section id="chapter-441" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-441-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">441</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Fighting A Sacred-Blood Creature</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-441-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen almost jumped on the back of golden rock worm king without thinking, rising in the air on the back of his pet.</p>
...
Han Sen was standing on the back of the golden rock worm king and quickly shape-shifted into the fairy queen. Using Heresy Mantra and Overload at the same time, his entire body was filled with incredible strength all of a sudden, his muscles shaking and heart pounding.
...
Han Sen decided not to escape. After shape-shifting into the fairy queen, his golden pupils started to sparkle, taking in every move of the giant snow spider and black bird.
