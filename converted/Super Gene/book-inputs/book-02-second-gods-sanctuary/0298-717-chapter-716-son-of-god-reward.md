# Chapter 717: Son of God Reward {.hidden-title}

<section id="chapter-717" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-717-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">717</p>
</section>
...
<section class="element chapter-text" id="chapter-717-text" markdown="1">
<p class="first2"><span class="first-letter">D</span>ollar did not show up for the final few fights, which established the Son of God rankings. People expected as much, so they weren’t too disappointed.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“You have obtained title of *‘Tenth Son of God.’* Your randomised reward is opening.”</em></p></section>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“You have obtained a super beast soul: Devil Unicorn.”</em></p></section>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Super beast soul: Devil Unicorn. Possession beast soul.”</em></p></section>
...
**“I wonder what the damage threshold of the black smoke is? If it’s powerful enough, then maybe I can indeed go up against the blue seahorse.”** Han Sen called out to the silver fox, telling him to unleash as much lightning as he could. He wanted to stress-test the limits of his elemental defence.

Han Sen was overjoyed with the results, and he was pleasantly surprised by the black smoke’s sturdy defence properties. The silver fox’s strongest attacks could not penetrate his shield anymore.

If there was one issue, however: the speed of recovery. When the silver fox unleashed lightning, it would evaporate some of the black smoke. If it attacked repeatedly, the black smoke would be used up at a quicker rate than it could regenerate. This opened up a hole in his defence.

Han Sen guessed that the black smoke could block an adult super creature’s elemental attack, but only about two or three times at the most. After that, it would take a while for his defence to return.

If it was an Area of Effect attack, and the attack was not focused on him entirely, the black smoke would manage to hold on for longer. Its regeneration would most likely be able to catch back up, too.
...
When it evolved into a berserk super beast soul, its elemental defence was sure to be stronger.
