# Chapter 604: White Tiger {.hidden-title}

<section id="chapter-604" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-604-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">604</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">White Tiger</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-604-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">H</span>ow about we allow this temporary friend of ours to join us?”** Sky Jealousy suggested, her presence breathing out an aura of elegance.</p>
...
Tyrant shouted and raised his shield, his body clad in golden armour. His shield presented a phalanx of steel, blocking the arrows of wind that came towards him.
