# Chapter 480: Moving Stuff with My Mind {.hidden-title}

<section id="chapter-480" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-480-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">480</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Moving Stuff with My Mind</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-480-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>ecause of the huge accident during the exploration of this Crystalliser ruin, Daphne was asked to go back immediately. It was yet to be determined whether they would be punished.</p>
...
Han Sen had more and more notes as he read. However, it was a bit boring for him to practise alone. Han Sen decided to fight someone else to test whether what he was thinking was correct.
