# Chapter 469: Core Area {.hidden-title}

<section id="chapter-469" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-469-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">469</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Core Area</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-469-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>ang Hou, you are also a soldier of the Alliance. Aren’t you afraid of the sanction by military laws?”** Ji Yanran exclaimed at Wang Hou.</p>
...
He did not realise that Wang Hou was so cruel that he did not even care about life and death of one of his own, so Han Sen was a bit slow.
...
**“You’re a good fighter. However, you are too naïve.”** Han Sen summoned the spirit stone. Shortly, an elegant beauty in ice armour appeared next to Ji Yanran, wielding her ice spear and fending off the researchers, saving Ji Yanran from the crisis.
...
**“Dammit. That bastard had practised Micro Crystal.”** Seeing Han Sen was not hurt by the light, when the expression changed.

**“Doesn’t matter. There is only one way going into the core area. He could not go away,”** Li Mingtang did not mind it, looked at Ji Yanran, and asked other researchers to lock her up. **“Zhang and Liu, you two have been rather successful in practising Micro Crystal, so you should not fear the wandering light. Follow Wang Hou and me inside. The rest shall wait here.”**
