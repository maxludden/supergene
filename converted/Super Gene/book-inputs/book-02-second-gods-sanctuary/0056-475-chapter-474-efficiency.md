# Chapter 475: Efficiency {.hidden-title}

<section id="chapter-475" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-475-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">475</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Efficiency</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-475-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>imulating crystals were an impressive creation, which many human scholars called a miracle.</p>
...
**“Han Sen, you surprise me. I have only seen three people at your age who could use their own strength so effectively.”** Li Mingtang looked at Han Sen with approval and continued to say, **“However, this is in a Crystalliser royalty ruin. So, from now on, you have to follow my lead.”**
