# Chapter 841: Pet Pill {.hidden-title}

<section id="chapter-841" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-841-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">841</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Pet Pill</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-841-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen’s communicator did not stop ringing, and the number of calls were overwhelming. They mostly came from good friends.</p>
...
Raising a pangolin was a good choice for their display, as well. Pangolins naturally had a high defence, and their shells could certainly block a few early strikes from a super creature.
...
If it withstood a few of the little angel’s attacks, the audience go wild, and the medicine would be perceived much more favourably. Not many humans had the means to block the attack of a super creature.
...
After witnessing the little angel’s behaviour, everyone looked strange. There were many important figures there, and they knew the Qi family had been unable to make peace with Han Sen and were not planning to pay him.
