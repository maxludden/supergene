# Chapter 830: Little Silver's Hunt for Treasure {.hidden-title}

<section id="chapter-830" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-830-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">830</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Little Silver&#x27;s Hunt for Treasure</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-830-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen ventured back into the mountains in the hopes of tracking more super creatures. Although there were many super creatures, he couldn’t just go for any. Furthermore, he had to find second-generation ones, which greatly narrowed those he could deem to be appropriate targets.</p>
...
Seeing its life-force, he realised that it was a sacred-blood creature.
...
Their life-forces were mostly ordinary, and the strongest amongst them were mutant. Queerly, none of the creatures seemed to flee the silver fox’s presence.
...
But Han Sen understood this behaviour was abnormal for the silver fox. It only behaved like this if it had found something. Therefore, he gave it the time it needed.
...
Han Sen didn’t realise this at first, but when the silver fox stopped to observe the pool, he noticed something was amiss.
</section>
