# Chapter 460: Abnormal Shelter {.hidden-title}

<section id="chapter-460" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-460-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">460</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Abnormal Shelter</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-460-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>ith someone being the first, many more stood out to break off their contract and leave the Goddess Gang.</p>
