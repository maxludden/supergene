# Chapter 463: Snow Charmer {.hidden-title}

<section id="chapter-463" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-463-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">463</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Snow Charmer</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-463-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>n Han Sen’s mind, a spirit stone that looked like a piece of ice decorated with lots of mysterious patterns was floating. In the middle, two strange words **“Snow Charmer”** were imprinted. Although Han Sen did not know the language, he somehow knew what it meant.</p>
...
Although there were many limitations, the intelligence, skills, and ability to make judgement of spirits made them much better than ordinary beast souls. Especially, spirits had the ability to use beast souls, which meant they could be used like human partners, while beast souls were more like tools.
...
Zhu Ting did not want to let it go and insisted, **“How about I give up the S-Class Saint Hall licence and you trade her for Treading Cloud?”**

**“No.”** Han Sen turn him down without even thinking. He had lots of S-Class Saint Hall licences, while needed a spirit like Snow Charmer terribly.
