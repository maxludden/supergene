# Chapter 785: Mafia Bug {.hidden-title}

<section id="chapter-785" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-785-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">785</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Mafia Bug</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-785-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he silkworm baby proudly mounted the hill and wriggled around the flower in circles. It wasn’t long before it took notice of the five bee crystals, and believing no one to be watching it, began nibbling them.</p>
...
But now, all the bees must have been cowering inside their hive, afraid of the bug outside munching on all the fruits of their labour.
...
If the silkworm did indeed have friends, then he figured he could waste those one-by-one until only the elder remained. If it had the same energy flow, Han Sen figured he could absorb the Super Geno essences of an entire family of creatures.
