# Chapter 454: Killing a Mutant Creature {.hidden-title}

<section id="chapter-454" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-454-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">454</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Killing a Mutant Creature</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-454-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen saw most people were running and only Yang Manli, Uncle Qing, and a few gang members stayed next to him, summoning beast souls and ready to fight.</p>
