# Chapter 665: The Shocking Fight {.hidden-title}

<section id="chapter-665" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-665-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">665</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">The Shocking Fight</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-665-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he pegasi king’s clouds began to spread, falling down on the massive creature below like bombs. They clung to the tentacles, restraining them like glue.</p>
