# Chapter 656: Berserk Super Creature {.hidden-title}

<section id="chapter-656" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-656-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">656</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Berserk Super Creature</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-656-text" markdown="1">
<p class="first2"><span class="first-letter">L</span>u Hui was quickly realising that the bone elephant was indestructible. He called for his archers to fire arrows at it from another direction, in an attempt to at least draw its attention away from its current course, so it could be led away from the Devil’s Shelter it currently was galloping towards. If it reached the shelter, the shelter would be destroyed.</p>
...
What Han Sen had in mind was finding a powerful archer to join his ranks. Although Han Sen himself could be an archer, it’d be a waste of the berserk Flaming Rex Spike he had just created. From now on, Han Sen would have to specialise in close-quarter combat, so he’d need someone to fill in the ranged-battler position.

**“Oh golly! The elephant looks as if it’s about to throw a tantrum!”** Wang Yuhang screamed in fear.

Han Sen took a closer look and saw the bone elephant’s eyes turning red. That colour of red became a physical haze that swirled itself around the bones which, in turn, changed their colour, too.
...
At this point, the skull and trunk of the elephant had become bright red. It wasn’t blood, it was the red colour that seeped from behind its eyes.
