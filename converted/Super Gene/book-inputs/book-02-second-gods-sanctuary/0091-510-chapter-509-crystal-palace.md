# Chapter 510: Crystal Palace {.hidden-title}

<section id="chapter-510" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-510-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">510</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Crystal Palace</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-510-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>eeing nothing dangerous had happened, Han Sen quickly walked up to the crystal treasure box and had a look.</p>
