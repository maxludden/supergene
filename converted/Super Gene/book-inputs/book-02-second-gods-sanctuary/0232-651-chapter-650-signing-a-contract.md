# Chapter 651: Signing a Contract {.hidden-title}

<section id="chapter-651" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-651-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">651</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Signing a Contract</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-651-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen looked behind Wang Yuhang and saw the Red-Scale Dragon turning the corner of the peak, apparently giving chase. It was running as fast as a rabbit, but it wasn’t an ordinary pursuit. Something wasn’t quite right.</p>
...
Although Wang Yuhang was an unlucky person, Han Sen thought his uncanny ability to attract super creatures would be a valuable trait for such a team. Han Sen would just need really strong armour to keep Wang Yuhang alive, so he could kite and tank super creatures effectively in battle.
...
Wang Yuhang, all excitement, asked, **“Boss-man, how many other elites do we have amongst our ranks?”**
...
Wang Yuhang did not mind this at all. In fact, he was already thinking of a way in which he could aid Han Sen’s cause. He then told Han Sen, **“Boss-man, I know someone who is really powerful. He is a friend of mine; perhaps we can invite him to join the team?”**
