# Chapter 645: Killing the T-Rex {.hidden-title}

<section id="chapter-645" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-645-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">645</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Killing the T-Rex</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-645-text" markdown="1">
...
Some bolts were dodged outright by the T-rex, deflected off its scales. Trying to penetrate anywhere else on its body was a futile endeavour, for all the bolts would do was leave a little white scratch mark before pinging off to the ground.
