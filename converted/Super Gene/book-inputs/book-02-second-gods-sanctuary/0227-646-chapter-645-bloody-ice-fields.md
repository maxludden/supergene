# Chapter 646: Bloody Ice Fields {.hidden-title}

<section id="chapter-646" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-646-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">646</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Bloody Ice Fields</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-646-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>lthough the T-rex had been blinded, it seemed as if it could still distinguish things well. It was able to fly north, towards the ice sea that lay beyond the ice fields.</p>
...
But with the gene lock open, he didn’t let it affect him. He maintained his composure and without even thinking, he summoned his golden armour, gargoyle glyph, and peacock crossbow to block the blow.
...
But after the strike, the T-rex appeared to be even more injured than it had been. It spewed more and more blood down into the sea, colouring it in an inky, dark red haze.
