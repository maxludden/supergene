# Chapter 492: Moon Blade {.hidden-title}

<section id="chapter-492" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-492-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">492</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Moon Blade</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-492-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he evolver matched with Han Sen was completely dazed after he entered the battlefield, seeing how packed the stands were. Wang Xun had no idea what had happened.</p>
...
The broadswords were shaped like crescents, and his broadsword skills had a strong spinning force. It turned out to be the famous Moon Blade, an evolver broadswords skill that was very hard to practise.

Moon Blade required the person who practised the skills to have a special talent called ambidexterity, which sounded a bit odd.
...
Very few people had no preference as a baby, maybe 1 out of 10,000. Therefore, the rudimentary requirement to practise Moon Blade was very high, and only a few people could practise it.

However, moon Blade was very powerful. One person using two blades would be as powerful as two persons using blades at the same time. One could even fight to persons at the same time. In one-on-one fights, the person who practised Moon Blade would have the absolute advantage.

With the same fitness and martial arts skills, almost no one could beat someone who had practised Moon Blade. Even the opponent was also using double blades, Moon Blade would still be much better.

Those who came to see Dollar did not expect Dollar to be randomly matched with someone who had practised Moon Blade.
