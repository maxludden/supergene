# Chapter 753: How About a Baby? {.hidden-title}

<section id="chapter-753" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-753-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">753</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">How About a Baby?</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-753-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen never expected things to turn out so well; it was quite the surprise.</p>
...
**“Missus Han, our Ji family have many rules. I hope you do not take offence at them,”** Missus Ji explained politely, but her tone was stuffy and oozed arrogance.
