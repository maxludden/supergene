# Chapter 654: I'll Buy It {.hidden-title}

<section id="chapter-654" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-654-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">654</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">I&#x27;ll Buy It</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-654-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>t was a black T-rex beast soul. Its name was **“Rex Spike.”** It was a heavy metal weapon that was about two meters long.</p>
...
It was just a virtual image, coming from the Sea of Soul. It did not spit out real fire, because if it did, the entire house would have been little more than smouldering cinders by that point.
...
Han Sen almost jumped up in happiness. He quickly summoned the Flaming Rex Spike and immediately saw that it had increased in length. It was now certainly longer than two meters. It was coloured a dark red and encircled in an aura of flame. The weapon now looked even more wretched and cruel, like some violent beast.
...
The silver fox was lying on Han Sen’s shoulder while Zero cuddled the pet Mew. The contrast of black and white pets side-by-side was a charming sight.
