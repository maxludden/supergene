# Chapter 760: Defenceless Woman {.hidden-title}

<section id="chapter-760" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-760-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">760</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Defenceless Woman</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-760-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was taken aback at the sight of the black-flame phoenix soaring across the horizon. Its speed was incredible, and it disappeared from sight within the blink of an eye.</p>
...
Zhou Yumei was a little upset after this, so she retreated into her own sleeping bag. Then she began to think about how dark life truly was. But then another image flashed in her mind, and it was the image of Han Sen’s stunning upper-body, sexy clavicles and tantalising abs. Zhou Yumei couldn’t help but swallow the saliva that was building up inside her mouth. She tried to shake the image and tighten her eyelids, but the picture remained. She couldn’t be free of Han Sen’s amazing body.
