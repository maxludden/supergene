# Chapter 722: Blue Mountain {.hidden-title}

<section id="chapter-722" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-722-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">722</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Blue Mountain</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-722-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen successfully drew away the flying centipede, and it went back to chasing him through the forest.</p>
...
This monster was incredibly powerful, and it was something the Archangel would surely struggle to beat. The Archangel wasn’t weak, but the size between the two was not comparable. The blood centipede had a unique power that made it far stronger than the Archangel, too.

The Archangel could protect herself, but she couldn’t stop the blood centipede; that was why Han Sen could only try to escape.
