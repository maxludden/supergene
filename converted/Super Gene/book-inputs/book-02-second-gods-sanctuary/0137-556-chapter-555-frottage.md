# Chapter 556: Frottage {.hidden-title}

<section id="chapter-556" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-556-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">556</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Frottage</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-556-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">Z</span>hu Ting, I’m not done with you!”** Yelling continued to erupt from inside the room.</p>
...
The words were the same, and so was their colour. But seeing the genuine thing, there really was a feeling you couldn’t quite put your finger on. Any real hyper geno arts always permeated its nearby atmosphere with a mystic hue, after all.
