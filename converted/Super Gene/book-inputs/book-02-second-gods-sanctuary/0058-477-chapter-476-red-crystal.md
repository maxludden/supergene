# Chapter 477: Red Crystal {.hidden-title}

<section id="chapter-477" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-477-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">477</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Red Crystal</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-477-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter seeing those green crystals, Ji Yanran started to whisper.</p>
...
After sticking to his body, the green mini crystals quickly turned into a red colour. Obviously, they sucked out a large amount of blood from Li Mingtang’s body.
