# Chapter 497: Strength Test {.hidden-title}

<section id="chapter-497" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-497-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">497</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Strength Test</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-497-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">B</span>rother, which department are you from?”** In the warm-up area of the military contest, a young soldier asked Han Sen who was sitting next to him will stop</p>
...
A loud sound made people’s ears hurt. The number on the screen of the drum changed quickly and ended up on the number 113.7,584.
...
It seemed that Tie Yi is even stronger than I thought. I hope that I could break his defence effectively, otherwise it would be trouble. Han Sen thought to himself.
...
The screen showed the number 114.2,584, giving rise to loud applause from the audience. This number was even better than Tie Yi’s, which boosted the morale of the soldiers in Southwest Galaxy.
</section>
