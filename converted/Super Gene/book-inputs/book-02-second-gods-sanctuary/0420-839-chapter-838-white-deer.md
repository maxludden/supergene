# Chapter 839: White Deer {.hidden-title}

<section id="chapter-839" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-839-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">839</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">White Deer</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-839-text" markdown="1">
<p class="first2"><span class="first-letter">J</span>i Qing returned from Yi Dongmu’s place with an altered perception of Han Sen—</p>

**“Brother-in-law, if you ever find the time, please teach me something.”** Ji Qing believed Han Sen must have been a very powerful person to have Yi Dongmu request his assistance in training, and then to point out every mistake he was able to notice. One could learn many things from practising with Han Sen—
