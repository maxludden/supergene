# Chapter 662: Grey-Wolf King {.hidden-title}

<section id="chapter-662" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-662-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">662</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Grey-Wolf King</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-662-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>ecause the wolf king had several hundred thousand lesser wolves, finding the pack’s location was not too difficult.</p>
...
Han Sen was again shocked, recognising that he had underestimated the wolf king. It was, after all, the king of a pack and a super creature to boot. How could he have expected things to be so simple?
