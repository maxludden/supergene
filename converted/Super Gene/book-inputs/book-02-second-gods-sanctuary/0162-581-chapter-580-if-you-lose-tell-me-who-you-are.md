# Chapter 581: If You Lose, Tell Me Who You Are {.hidden-title}

<section id="chapter-581" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-581-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">581</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">If You Lose, Tell Me Who You Are</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-581-text" markdown="1">
<p class="first2"><span class="first-letter">Y</span>i Dongmu did not use the face blur function, and his cold and proud face was on display for all to see.</p>
...
His identity was something everyone wanted to know. During the peak of Dollar’s popularity, experts analysed every aspect of the enigmatic character to try and determine his real identity. But again, no one had been able to find out.
...
**“Ah, that is why. Dollar is quite manipulative, then.”** Tang Zhenliu had only just realised this. As they spoke, the fight began.
</section>
