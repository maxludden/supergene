# Chapter 608: Mystic Plant {.hidden-title}

<section id="chapter-608" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-608-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">608</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Mystic Plant</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-608-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>here was a giant creature swimming across the sea, which almost resembled a moving island.</p>
