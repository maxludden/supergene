# Chapter 681: Power of One Hit {.hidden-title}

<section id="chapter-681" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-681-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">681</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Power of One Hit</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-681-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he mountains shook and the ground was torn asunder. A few scary creatures were battling to the death, and in their midst was Han Sen— He was like a pawn, only doing minor things. He did not dare to use Elephant-Rex Strike, no matter how much he wanted to. He was too weak to fight the bone elephant, and he knew he was little more than a distraction in the grander scale of this fight.</p>
