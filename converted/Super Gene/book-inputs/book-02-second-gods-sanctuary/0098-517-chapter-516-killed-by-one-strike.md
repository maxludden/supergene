# Chapter 517: Killed by One Strike {.hidden-title}

<section id="chapter-517" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-517-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">517</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Killed by One Strike</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-517-text" markdown="1">
<p class="first2"><span class="first-letter">M</span>eowth that was eating suddenly bristled. It bared its teeth toward the direction of the noise and growled fiercely.</p>
...
Han Sen took Mew and ran back. He did not need to move a finger anyway. With 20% of the meat, he could feed Archangel happily.
...
Han Sen found a remote spot and sat down, caressing the head of Mew and enjoying his barbecue as well as the performance of Yi Dongmu.
