# Chapter 723: Blue Shelter {.hidden-title}

<section id="chapter-723" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-723-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">723</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Blue Shelter</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-723-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen’s pupils shrunk. He saw a mysterious, blue shelter residing atop the peak. Its presence there was like a castle, perched in the heavens.</p>
...
The blue metal shelter had many toppled buildings, and many structures only had one or two dishevelled walls remaining. Some had been cut in half or even had their rooves shaved off.
...
**“Was this a human shelter that got attacked by some fearsome creature?”** Han Sen came down from the bell tower and tread the shelter with a little more care this time.

Han Sen summoned his super armour, in case something unfortunate was about to happen. Since there weren’t any other humans around, no one would see or recognise him.
