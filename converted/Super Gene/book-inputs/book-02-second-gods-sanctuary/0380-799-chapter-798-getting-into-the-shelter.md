# Chapter 799: Getting into the Shelter {.hidden-title}

<section id="chapter-799" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-799-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">799</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Getting into the Shelter</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-799-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he fog lay heavy, and Han Sen made sure to summon his most useful beast souls before entering the mist. He pierced into the clouds without hindrance, but as he entered, a frightful feeling crept along his spine and chilled him to the bone.</p>
...
While Han Sen commanded her to deflect the shadow’s incoming attack, Han Sen took advantage of the window of opportunity and flew faster through the fog towards the shelter. He knew that the shelter’s walls were only a hundred meters away, but it now felt as if he had travelled several hundred meters. And still, he had yet to see the ground.

**“Oh, no!”** The wretched realisation that this was no ordinary fog dawned on Han Sen— He wanted to leave its stuffy-clutch, but it was too late. Despite flying back a few hundred meters again, in the direction he had come, he was unable to exit. He wasn’t going anywhere.
...
The evil-eye mask could only enable Han Sen to watch the shadow of the creature. It was a life-force, one that seemed to have been wrapped in flames. He couldn’t quite see what sort of super creature it was.
...
When he was outside, he had managed to catch the presence of other super creatures by spotting their life-forces. But now, inside the mist, this singular life-force was the only anomaly he could make out.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Super Creature Mirage-Gas Freak killed. No beast soul gained. The flesh of this creature is inedible, but you may harvest its Super Geno essence. Consume its Super Geno essence to gain zero to ten super geno points randomly.”</em></p></section>
...
A Super Geno essence, one that looked like an orb of solid mist, fell to the ground. Han Sen made sure to pick it up, and after doing so, flew to the back of the gate that had previously barred their passage. Then, he lifted and removed the bolt that prevented its opening. After doing so, he made sure to make a quick escape backwards.
