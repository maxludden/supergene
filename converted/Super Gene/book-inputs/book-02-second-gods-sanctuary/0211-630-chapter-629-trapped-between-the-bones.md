# Chapter 630: Trapped Between the Bones {.hidden-title}

<section id="chapter-630" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-630-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">630</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Trapped Between the Bones</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-630-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen and Queen continued on their current trajectory, silently praying the raven wouldn’t show up.</p>
