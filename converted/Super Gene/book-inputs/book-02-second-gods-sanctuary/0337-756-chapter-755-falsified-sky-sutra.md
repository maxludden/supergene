# Chapter 756: Falsified-Sky Sutra {.hidden-title}

<section id="chapter-756" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-756-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">756</p>
</section>
...
<section class="element chapter-text" id="chapter-756-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen couldn’t think of a solution to the predicament he was in, so he thought about sending his mother a message. He had hoped to maybe receive some help from his mother, and perhaps get a glimpse of the true extent of her power.</p>
