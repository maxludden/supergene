# Chapter 491: The King Is Back {.hidden-title}

<section id="chapter-491" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-491-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">491</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">The King Is Back</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-491-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter Wang Dongyun had thought of it, he could no longer hold it back. Wang Dongyun then recorded all the following fights by Kill Dollar.</p>
