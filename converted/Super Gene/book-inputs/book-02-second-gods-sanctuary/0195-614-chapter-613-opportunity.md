# Chapter 614: Opportunity {.hidden-title}

<section id="chapter-614" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-614-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">614</p>
</section>
...
<section class="element chapter-text" id="chapter-614-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen recognised the sound as belonging to the peacock they encountered earlier, which had received a nasty sting on its face. It flew far away after that, and they didn’t think they’d run into it again so soon.</p>
...
**“It can still scream a good deal. It is most likely still quite energised. Perhaps we should wait here for a few days and see how it goes?”** Han Sen suggested.
