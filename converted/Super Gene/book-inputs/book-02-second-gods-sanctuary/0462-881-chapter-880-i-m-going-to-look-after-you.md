# Chapter 881: I'm Going to Look After You {.hidden-title}

<section id="chapter-881" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-881-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">881</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">I&#x27;m Going to Look After You</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-881-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>rom inside the silver fox’s charred body, a gold light burst forth. The strength of the light gradually increased, and the brighter it got, the darker its body became.</p>

Soon after, the silver fox’s body was like smouldering charcoal, with veins of red running along its black body.
