# Chapter 461: Spirit Stone {.hidden-title}

<section id="chapter-461" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-461-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">461</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Spirit Stone</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-461-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>ait a second.”** Han Sen commanded the group to stop, summoned the golden rock worm king, and commanded it to fly into the gates of the shelter.</p>
...
The spirit looked at the group of people, smiled coldly, and raised the staff in her hand. Light suddenly covered her body, turning her into an aristocrat fighter in ice armour with red patterns. The staff turned into an ice spear.

**“Roar!”**

Almost immediately, all sorts of creatures came to the empty castle. Hundreds and thousands of ice-armoured beasts and other creatures besieged the hall, throwing themselves at the intruders.
...
After that sentence, the ice-armoured beasts flooded into the hall and threw themselves at the group of people with no fear for death.
...
However, Han Sen had already gone toward the statue of deity. Other people had to block the door to the hall first, fighting the endless ice-armoured beasts.
...
**“You should not let me come this far. Your favourite trap is your biggest mistake.”** Han Sen quickly rushed to the huge statue of deity with the spirit stone like a tornado.
