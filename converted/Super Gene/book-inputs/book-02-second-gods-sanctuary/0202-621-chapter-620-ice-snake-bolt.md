# Chapter 621: Ice Snake Bolt {.hidden-title}

<section id="chapter-621" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-621-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">621</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Ice Snake Bolt</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-621-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>n the Whitesand Shelter’s market, Huangfu Pingqing walked alongside Han Sen, often turning to observe him.</p>

**“I know I am handsome. If you like my appearance that much, why don’t we book a room together, so you can inspect me in all my splendour?”** Han Sen asked her. He felt awkward, getting stared at by her.
...
It was a black bolt, formally referred to as an Ice Snake Bolt, and its tip was coated with a paralysing substance.
