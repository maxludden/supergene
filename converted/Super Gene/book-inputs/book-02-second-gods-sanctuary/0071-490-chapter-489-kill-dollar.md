# Chapter 490: Kill Dollar {.hidden-title}

<section id="chapter-490" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-490-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">490</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Kill Dollar</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-490-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen tried a couple of times, but even **“Dollar”** was registered as well.</p>
...
The moment **“I Am Sword Master”** moved, Wang Dongyun knew he was right. This person’s sword skills were fierce and fast. Judging by his moves, Wang Dongyun could tell that this person had put a lot of effort into practising his sword skills.
...
**“Maybe I Am Sword Master is too weak? Yes, it is definitely so.”** Wang Dongyun thought it must be the sword man’s problem that he could not utilise any of the flaws. Although his sword skills were impressive, he must not be that intelligent.
...
However, Han Sen did not agree to fight him again. He was practising the techniques in Dongxuan Sutra, so it would make little sense for him to fight someone he had defeated already. What he needed was endless new challenges against opponents using various skills.
...
What Han Sen was practising currently was to use calculation to match his strength with his opponent’s weakness. Even if his opponent was stronger than him over all, he could be partially stronger and consume his opponent’s strength in order to win in the end.
