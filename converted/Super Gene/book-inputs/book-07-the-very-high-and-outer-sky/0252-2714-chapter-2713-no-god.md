# Chapter 2714: - No God {.hidden-title}

<section id="chapter-2714" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2714-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2714</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- No God</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2714-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter using the Four Sheep Cube to go back to the mysterious realm, Han Sen immediately headed toward that big mountain.</p>
