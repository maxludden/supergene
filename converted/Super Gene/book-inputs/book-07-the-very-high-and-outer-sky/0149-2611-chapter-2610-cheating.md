# Chapter 2611: - Cheating {.hidden-title}

<section id="chapter-2611" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2611-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2611</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Cheating</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2611-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen’s knife skills kept changing, and thus far, he had used seventy different attacks. Not a single one managed to hit Exquisite. Her floating water knife was able to block every single strike.</p>
...
The Sky Palace skill called Under the Sky made every slash Han Sen had performed thus far into a water silk. They all appeared at once, and Han Sen was on the verge of breaking the enemy’s defence.
