# Chapter 2582: - Tentacle Monster {.hidden-title}

<section id="chapter-2582" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2582-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2582</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Tentacle Monster</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2582-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>hat monster was breathtakingly ugly. It was like a giant worm, but countless hair-like tentacles writhed from the sides of its body. The beast crawled out of the black water, its body still dripping the corrosive liquid of the sea.</p>
...
After the hit that the little red bird had taken, its fires seemed to be weaker. It screamed in rage. And when it screamed, the strength and vigour of its flames returned. It hurled itself back into the fight with the monster.
