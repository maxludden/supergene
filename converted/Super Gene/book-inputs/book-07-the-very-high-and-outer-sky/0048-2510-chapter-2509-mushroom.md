# Chapter 2510: - Mushroom {.hidden-title}

<section id="chapter-2510" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2510-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2510</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Mushroom</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2510-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he white whale came down into the mushroom forest, and its crash landing sent many mushrooms flying. It finally slid to a stop when it came up against a line of mushrooms that were a few dozen meters tall.</p>

But the mushrooms they did break, releasing a rainbow-coloured mist. When Han Sen and the others looked closer, they could see a nearly infinite abundance of rainbow-coloured spores forming the foggy veil.
...
**“Brother Bird is so powerful— Brother Bird is like the best bird ever. That crappy tiger passed itself when Brother Bird went out to greet it.”** The pirates said, trying to ingratiate themselves with the little bird.
...
**“You— your head has a mushroom, too— and you, as well— argh!”** Everyone’s head now had their own mushroom. The sizes and colours of each were all different.
