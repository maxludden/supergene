# Chapter 2490: - Weird Hordes of Cloud Beasts {.hidden-title}

<section id="chapter-2490" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2490-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2490</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Weird Hordes of Cloud Beasts</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2490-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>rustration filled Han Sen— Since leaving Lando and Meng Lie, he had changed directions many times and even crossed back over his own path. He could barely believe that Meng Lie had still managed to find him.</p>
...
Han Sen might be able to convince himself that the low-level cloud beasts were too stupid to detect the deified presence of Meng Lie, but there was no way that the more powerful cloud beasts were that dumb. They were Kings, and they led other cloud beasts toward Han Sen and Meng Lie. This was very abnormal behaviour.
