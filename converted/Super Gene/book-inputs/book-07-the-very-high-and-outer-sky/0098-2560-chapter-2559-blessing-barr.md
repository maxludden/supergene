# Chapter 2560: - Blessing Barr {.hidden-title}

<section id="chapter-2560" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2560-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2560</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Blessing Barr</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2560-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">C</span>an we start the blessing process now?”** Barr was standing atop the big pile of King class xenogeneic genes as he spoke.</p>
...
Han Sen felt his eyes bulge upon hearing that. After half a day of waiting, it was revealed that he himself was the unlucky guy Barr harboured so much antipathy for.
