# Chapter 2648: - Fishing {.hidden-title}

<section id="chapter-2648" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2648-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2648</p>
</section>
...
<section class="element chapter-text" id="chapter-2648-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was a little bit curious. He sat down near where the Underworld Silk disappeared into the clouds, and he decided to wait and see what happened.</p>
...
**“An extreme body works as a blade. Once I learn this geno art, I should be able to fight others of the same level, even if they’re making use of a xenogeneic weapon. That is pretty cool.”** After Han Sen read through it once, he began to practise Very Real Body.

But it would take a very long time for Han Sen to practise and become talented with this geno art. This wasn’t a task that he could accomplish in a day, and so Han Sen wasn’t in a crazy rush. He trained slowly, and he also practised Heart Connection in the meantime.

Han Sen set the small jade figure into a fishing mode. Even if Exquisite turned her attention back to him, she would only sense him fishing. She wouldn’t realise that it was Bao’er doing the fishing for him.
