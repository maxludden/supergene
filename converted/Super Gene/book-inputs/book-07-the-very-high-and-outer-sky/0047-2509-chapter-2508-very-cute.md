# Chapter 2509: - Very Cute {.hidden-title}

<section id="chapter-2509" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2509-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2509</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Very Cute</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2509-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>or more than one hundred hours, Han Sen flew the white whale forward across an endless sea cloaked in mist. Still, he couldn’t find an escape route.</p>
...
The big mushrooms were like Ferris Wheels. Others were the size of a room. A few were as small as beans. The place was colourful, and they all looked very lovely.
...
The land of mushrooms was very pretty, and the mushrooms covered it in rainbows and splashes of colour. But aside from the mushrooms, there was nothing else around.
