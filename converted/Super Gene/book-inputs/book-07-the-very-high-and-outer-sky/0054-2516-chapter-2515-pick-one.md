# Chapter 2516: - Pick One {.hidden-title}

<section id="chapter-2516" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2516-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2516</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Pick One</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2516-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">F</span>ortune teller, where will you run this time?”** A woman was gripping a knife in a rock-steady hand. She was holding the knife to an old man’s neck.</p>
...
**“My lady, are Dragon One and Dia Robber really going to kill the Gold Armour General?”** In the core area, a maid-looking woman of the Kate was curiously looking at a woman in a yellow shirt. They were on a ship.
...
Many of the higher races knew Dragon One and Dia Robber were preparing to defeat the Gold Armour General. And so, their every move was watched.

When the time for respite was up, Han Sen followed Dia Robber and Dragon One to the system with the Gold Armour General.
