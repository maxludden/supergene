# Chapter 2484: - The Name Heard Across the Universe {.hidden-title}

<section id="chapter-2484" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2484-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2484</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Name Heard Across the Universe</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2484-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>hat fight was destined to become a legend in the geno universe. Before the day was out, the battle was being discussed across the universe.</p>
...
But that title was only used in secret. If any deified heard it, they probably would have found it annoying. No one wanted to jeopardise their own life by irritating a deified.
