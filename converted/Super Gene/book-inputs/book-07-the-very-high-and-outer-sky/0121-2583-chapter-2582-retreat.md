# Chapter 2583: - Retreat {.hidden-title}

<section id="chapter-2583" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2583-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2583</p>
</section>
...
<section class="element chapter-text" id="chapter-2583-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he monster was like a fighting machine. It could rotate 360 degrees in a moment, and it could release tentacles from any part of its body. The tentacles could weave themselves together to create whatever weapon or defence best suited the needs of its fight.</p>
...
**“The Six Core Snake Bow gives space power to the arrows it shoots!”** Han Sen realised with pleasure.
