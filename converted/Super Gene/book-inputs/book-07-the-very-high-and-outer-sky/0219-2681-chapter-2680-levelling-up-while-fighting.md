# Chapter 2681: - Levelling Up While Fighting {.hidden-title}

<section id="chapter-2681" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2681-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2681</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Levelling Up While Fighting</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2681-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he two of them continued fighting, but they were unable to deal damage to each other.</p>
...
**“Does that mean the eleven armour talent test was legit?”** Open Sky Elder wondered with a frown.
...
**“A ten armour talent is very rare. A real eleven armour talent would make a man the greatest of his generation. Do you think Han Sen is this kind of great man?”** Open Sky Elder asked, looking a little worried.
