# Chapter 2692: - Xuan Yellow Sutra {.hidden-title}

<section id="chapter-2692" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2692-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2692</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Xuan Yellow Sutra</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2692-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">O</span>f course you can. If you are confident enough, you can try as many times as you want. But this doppelgänger has already been here for a month. If you cannot kill it in the next couple of months, we will have to send in a deified elite that is strong enough to kill it. So, remember: you have a limited amount of time,”** Exquisite said.</p>
...
Now that he thought about it some more, he realised he had been completely suppressed. He had lost in the most embarrassing way possible.

**“It was just a doppelgänger, and yet, it had such a scary amount of power. I wonder how strong its true self is, then?”** Han Sen wondered to himself.
...
**“It looks like taking down that xenogeneic won’t be easy. Hey wait, it’s almost time to meet up with Mister White! I need to go to the core area.”** Han Sen thought about the Xuan Yellow Sutra, and he realised it was time for him to take a break from fighting.
...
Han Sen memorised everything that was written in the notebook, but he didn’t want to destroy it. After all, Mister White put in the time and effort to write it all out by hand.
...
After Gu Qingcheng left, Han Sen tried to digest the content of the notebook. The more he thought about it, the more shaken he felt. Based on what Mister White had described, if Han Sen finished practising the Xuan Yellow Sutra, it would become a very scary power.
