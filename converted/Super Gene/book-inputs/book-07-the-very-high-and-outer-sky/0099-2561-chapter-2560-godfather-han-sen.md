# Chapter 2561: - Godfather Han Sen {.hidden-title}

<section id="chapter-2561" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2561-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2561</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Godfather Han Sen</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2561-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>s the white light shone brighter and brighter in the dark, it became impossible to miss. Many deified elites noticed its presence, and their faces were all drawn in shock.</p>
...
**“Get lost! What is this about two thousand King xenogeneic genes? You are being that cheap before the Godfather? I have 2,500 King class xenogeneic genes. I should be blessed first.”**
