# Chapter 2610: - Exquisite\u2019s Third Eye Pang! {.hidden-title}

<section id="chapter-2610" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2610-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2610</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Exquisite\u2019s Third Eye Pang!</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2610-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>wo water knives collided and exploded, becoming like a rainy squall scattering over the surface of the pond.</p>
...
An ordinary person that practised a lot of knife skills would be limited by their personality and body. They had to follow one course.
...
**“It looks like the God Spirit Touch was accurate. Maybe he really does have an eleven armour talent.”** Upon seeing Han Sen’s knife skills, Exquisite felt deeply moved. She wanted to fetch another God Spirit Touch to test Han Sen again.
