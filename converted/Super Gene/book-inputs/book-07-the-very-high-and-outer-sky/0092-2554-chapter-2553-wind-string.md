# Chapter 2554: - Wind String {.hidden-title}

<section id="chapter-2554" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2554-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2554</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Wind String</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2554-text" markdown="1">
<p class="first2"><span class="first-letter">B</span>ecause of the videos that Kings in the core area made and distributed, many elites across the universe were able to watch what was going on there. After hearing what Elysian Moon said, many angry eyes focused on Han Sen— Countless young men wanted to beat up Han Sen to save those two pretty girls.</p>
...
When he saw how comfortable Han Sen seemed to be when he handled the bow, Autumn Wind realised that Han Sen must be very good at archery. An elite like that shouldn’t have been clueless about Wind String, though. So, it begged the question why Han Sen would request to borrow it.
