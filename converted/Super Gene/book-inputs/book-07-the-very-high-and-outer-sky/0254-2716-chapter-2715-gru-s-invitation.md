# Chapter 2716: - Gru’s Invitation {.hidden-title}

<section id="chapter-2716" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2716-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2716</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Gru’s Invitation</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2716-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>t’s a shame I can’t go back to the sanctuaries right now. Otherwise, I could grab a creature and feed this crystal to it. Then, I could confirm that this is really the same black crystal I found a long time ago,”** Han Sen said after a think.</p>
...
Han Sen jerked his head up as he noticed a presence approaching the Star Tree. When the distant figure drew closer, he recognised that it was Gru from the Extreme King.
