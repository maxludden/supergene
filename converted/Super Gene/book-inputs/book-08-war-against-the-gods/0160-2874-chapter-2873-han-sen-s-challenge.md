# Chapter 2874: - Han Sen’s Challenge {.hidden-title}

<section id="chapter-2874" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2874-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2874</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Han Sen’s Challenge</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2874-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">F</span>inally moved.”** Han Sen quickly looked at the other name. He noticed Zhang Xuandao was challenging Ancient Sacrifice God, who was ranked sixth.</p>
