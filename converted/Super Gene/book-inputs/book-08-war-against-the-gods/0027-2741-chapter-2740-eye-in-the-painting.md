# Chapter 2741: - Eye in the Painting {.hidden-title}

<section id="chapter-2741" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2741-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2741</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Eye in the Painting</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2741-text" markdown="1">
<p class="first2"><span class="first-letter">U</span>nless someone possessed a very stable will, they would lose themselves without even noticing what had happened.</p>
...
Even Exquisite was nearly emotionless, and this man had practised the Very High Sense that was far beyond Exquisite’s abilities. It was hard for Han Sen to imagine what kind of emotions such a man would have been capable of feeling. He might have been completely emotionless.
...
Han Sen assumed that this man hadn’t practised the Very High Sense, but even if that were true, the Very High had many elites like that. After all, the Very High could practise any geno art to a higher level of skill than the other races of the universe. They would approach each new geno art with no less aptitude than they applied to the Very High Sense.
