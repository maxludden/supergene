# Chapter 2738: - Ancient Wall {.hidden-title}

<section id="chapter-2738" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2738-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2738</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Ancient Wall</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2738-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>f no one can understand the meaning behind that drawing, what benefit can be gained from staring at it?”** Han Sen asked, not understanding.</p>
...
But the Ancient Wall was a leftover from the Very High ancestors. Ordinary outsiders weren’t allowed to get close. Han Sen and the silkworms could go there for a whole month after levelling up to become deified, but the rules still forbade Bao’er—despite being a family member—from going there.
...
Tang Ming’er had only just entered Star Moon Shelter when someone recognised her.

**“Tang Ming’er. Are you Tang Ming’er?”** A pretty boy wearing armour approached. He was riding a tiger beast soul mount. He was leading a group of knights, but he looked surprised as he stopped in front of Tang Ming’er.
