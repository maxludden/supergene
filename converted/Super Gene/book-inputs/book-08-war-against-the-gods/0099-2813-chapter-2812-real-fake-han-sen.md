# Chapter 2813: Real Fake Han Sen {.hidden-title}

<section id="chapter-2813" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2813-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2813</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Real Fake Han Sen</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2813-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he ground was destroyed ground. Broken metal and stone buildings were seen everywhere. The broken, metal pieces of machinery were sort of like products from a steampunk era. The buildings seemed even older than them.</p>
...
After walking 100 miles, they still only saw ruins. They did not see any xenogeneics, however, which made the travellers feel moderately better. Even so, no one dared to lose their vigilance.
...
Meng Lie grabbed the tail of the black-scaled, nine-headed, big snake. His body shone with a gold god light. He dyed the giant black-scaled, nine-headed, big snake in gold colour.
