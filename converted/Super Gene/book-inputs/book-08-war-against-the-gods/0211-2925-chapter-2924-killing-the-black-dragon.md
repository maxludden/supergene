# Chapter 2925: - Killing the Black Dragon {.hidden-title}

<section id="chapter-2925" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2925-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2925</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Killing the Black Dragon</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2925-text" markdown="1">
<p class="first2"><span class="first-letter">P</span>ang! Pang! Pang! Han Sen’s body kept shaking in space. The dragon presence, dragon eye lights, dragon scales, and many other dragon different powers were hitting him. Although Han Sen tried his best to block them, because of the difference in power levels, he was getting more wounded with every second.</p>
...
When the dragon realised what was going on, it was too late. At that moment, the knife light came down. It struck the black dragon’s forehead.
