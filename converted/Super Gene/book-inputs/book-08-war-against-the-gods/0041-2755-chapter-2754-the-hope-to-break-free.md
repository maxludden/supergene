# Chapter 2755: - The Hope to Break Free {.hidden-title}

<section id="chapter-2755" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2755-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2755</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Hope to Break Free</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2755-text" markdown="1">
<p class="first2"><span class="first-letter">U</span>ncle Nine sent Han Sen to a palace, and the Very High Leader began gathering an army of Very High elites to go to the Buried Dragon Sea. They planned to suppress the blood coral and uncover what was buried beneath it.</p>
...
Everything aside from the palace was just a blur. There were no life forces to examine, and the place seemed to be disconnected from the rest of the universe, too. In fact, Han Sen couldn’t even continue practising.
...
The palace contained food and fresh spring water, but it only satiated his hunger and kept him alive. It didn’t allow him to practise more, and it did nothing to reinforce his genes.
...
Han Sen was afraid of exposing the scales on his skin, so he immediately put on his Dongxuan Armour. Even if a creature knew about Dongxuan Armour, they would just assume he was Dollar. No one would know he had escaped from the Very High true god item.
