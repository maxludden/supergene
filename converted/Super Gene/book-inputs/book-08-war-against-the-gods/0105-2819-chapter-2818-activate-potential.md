# Chapter 2819: Activate Potential {.hidden-title}

<section id="chapter-2819" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2819-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2819</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">Activate Potential</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2819-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen was holding the skull head. The eye sockets fired out two beams of green light. It was a shame that when they touched the Cold Light Charm’s pink beams of light, the green light was destroyed. It was not on the same level of power.</p>
