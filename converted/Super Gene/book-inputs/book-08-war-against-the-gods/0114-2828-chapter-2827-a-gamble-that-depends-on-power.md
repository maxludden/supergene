# Chapter 2828: A Gamble That Depends on Power {.hidden-title}

<section id="chapter-2828" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2828-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2828</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">A Gamble That Depends on Power</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2828-text" markdown="1">
<p class="first2"><span class="first-letter">I</span> wonder if the method to kill a god is useful with God’s Knife. Han Sen’s heart jumped. He summoned Sky Vine Radish and threw a punch toward God’s Knife.</p>
...
Han Sen suddenly realised something, but he did not know what it was.
...
Inside the Sea of Soul, the black crystal armour reduced its presence. It pretended it did not exist. There was no reaction.
</section>
