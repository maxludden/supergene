# Chapter 2753: - No Dragon {.hidden-title}

<section id="chapter-2753" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2753-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2753</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- No Dragon</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2753-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen thought about the matter for a while before he noticed that he had overlooked a very key concern.</p>
...
For now, the scales weren’t having any negative influence on him. They actually increased the defences of his body.

The scales also boosted his elemental resistances dramatically. When an attack landed on his scales, they would take away 80% of the damage incurred. If the scales expanded to cover his entire body, Han Sen’s physical defence would be very scary.
