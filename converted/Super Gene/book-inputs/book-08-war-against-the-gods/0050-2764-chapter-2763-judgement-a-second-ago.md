# Chapter 2764: - Judgement a Second Ago {.hidden-title}

<section id="chapter-2764" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2764-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2764</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Judgement a Second Ago</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2764-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen had seen the Flush Real Sutra before, but that time, the geno art had been written on a tablet. Han Sen hadn’t understood it.</p>
...
Many Buddha geno arts had been developed from the Flush Real Sutra. Even the shape-shifting skill that Burning Lamp Alpha once used to turn Han Sen into an ant had originated in the Flush Real Sutra.
...
People weren’t locked into the universes that they were born in. Throughout their lives, they flowed seamlessly from one universe into another, and most of the time, they didn’t even realise that anything had changed.
