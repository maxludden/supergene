# Chapter 2918: - Tester 304 {.hidden-title}

<section id="chapter-2918" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2918-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2918</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Tester 304</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2918-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen watched as the big goldfish outside the bubble stared at them. He gathered up the Xuan Yellow Sutra’s power in his hand. He wanted to attack the fiend and see if he could downgrade its level. Before Han Sen struck, the big goldfish opened its mouth. There was a sudden **“pop”** sound. Han Sen, Bao’er, and the bubble were sucked inside the big goldfish.</p>
