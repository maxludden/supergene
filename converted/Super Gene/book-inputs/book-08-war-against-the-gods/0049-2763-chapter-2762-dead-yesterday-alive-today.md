# Chapter 2763: - Dead Yesterday, Alive Today {.hidden-title}

<section id="chapter-2763" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2763-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2763</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Dead Yesterday, Alive Today</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2763-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">A</span>re you serious?”** Han Sen thought Ancient Devil was playing with him. He couldn’t imagine how killing himself would solve anything.</p>
...
After the Very High elder left, no one came to see him for a few days. Han Sen spent the entire time practising the Sit and Forget Sutra. Time passed rather easily.

**“It has been a while since I saw Yanran and Ling’er. I wonder if Ling’er has grown up yet. And I wonder what is going on with Little-flower. Mom and Dad said they wanted to spend some time travelling. I wonder if they have come back yet—”** Sometimes, Han Sen would get distracted as he thought about how much he missed his family.

**“The Sit and Forget Sutra is completely different from Under the Sky. One of them is about entering the world, and the other is about exiting the world. Combining them will be hard. And I have never practised Very High Sense before, so I have to use Under the Sky as a base. If I start from the beginning with my practise, I don’t know how long it will take for me to learn the Sit and Forget Sutra.”** Han Sen had no way of accurately predicting when he would elevate the new skill to a usable level.
...
Han Sen browsed quickly through the titles, and he realised that ebooks really were the only things that the computer contained. Most of the books were about philosophy and theology. There wasn’t anything about geno arts, at all.

Han Sen hadn’t really expected to find a geno art, anyway. He flicked through the books. With how much his brain had evolved, it was an easy task for him to memorise the exact contents of a book with a million words. He could recall the content perfectly, without forgetting a single word. Understanding it, however, was something else entirely.
