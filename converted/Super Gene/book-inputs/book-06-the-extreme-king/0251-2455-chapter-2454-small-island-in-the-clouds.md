# Chapter 2455: - Small Island in the Clouds {.hidden-title}

<section id="chapter-2455" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2455-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2455</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Small Island in the Clouds</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2455-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">Y</span>ou’re saying that I should use the Wanjie Rubix Cube to leak my location?”** Han Sen immediately understood what the Treasure Identifier Elder was implying.</p>
...
When the demon spirit reached the mountain’s peak, Han Sen realised that the mountaintop was flat. It was about the size of a basketball court, and there was a building standing at its center. The building had two floors, and it appeared to have been constructed out of a beautiful variety of wood.
...
In a one-on-one death-match, the leaders of the three highest races of the universe couldn’t defeat him.
