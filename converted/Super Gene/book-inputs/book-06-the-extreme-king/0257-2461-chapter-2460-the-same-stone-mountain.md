# Chapter 2461: - The Same Stone Mountain {.hidden-title}

<section id="chapter-2461" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2461-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2461</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Same Stone Mountain</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2461-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen looked at the woman, his expression carefully veiled. He wanted to know, but the woman obviously wanted something in return. He would need to know what she wanted before he agreed to some sort of bargain.</p>
...
They were the best geno arts of all the races. Even if Han Sen didn’t practise them, it would be useful for him to be able to remember them all.
...
**“Damn.”** Still holding the stone book, Han Sen gnashed his teeth and asked, **“In the legends, Sacred had a xenogeneic space called the sanctuaries. Do you know that place?”**
