# Chapter 2347: - Identity Exposed {.hidden-title}

<section id="chapter-2347" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2347-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2347</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Identity Exposed</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2347-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen didn’t believe what Miss Mirror told him. He had inspected that ring many times, and he had never seen any semblance of a soul inside it.</p>
...
Seeing that ring, Han Sen’s heart leapt. That ring looked exactly the same as his, aside from the fact that it was a little bit smaller.
...
Miss Mirror didn’t respond. She just looked at Han Sen with interest as the car travelled onward.

Han Sen quickly realised that the car wasn’t headed for the palace. They went to the biggest starport that could be found in King’s Kingdom.
...
Instead, they were leaving King’s Kingdom. She hadn’t decided to incarcerate him, either. She just had him and the blood Qilin taken to an ordinary room. The blood Qilin wasn’t locked up, either.

**“What does this Miss Mirror want?”** Han Sen wondered, but try as he might, he couldn’t guess what the woman was planning.

Han Sen touched the Mirror Spirit Eye. He wanted to take it off, but ever since the ring had been activated by Miss Mirror, it was as if the piece of jewellery had melded into his hand. He was now unable to remove it.
...
Han Sen didn’t receive the same lovely treatment. He just stood next to the blood Qilin, trying to see what Miss Mirror was inspecting. The only thing in front of them was a large sea. It was very quiet, and no creatures were visible within its depths. There was nothing special to see.
</section>
