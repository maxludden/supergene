# Chapter 2428: - Six Pictures {.hidden-title}

<section id="chapter-2428" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2428-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2428</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Six Pictures</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2428-text" markdown="1">
<!-- source: tbody.calibre9 --><!-- source: tr.calibre10 -->|<!-- source: td.calibre11 -->  |<!-- source: td.calibre11 -->  |<!-- source: td.calibre11 -->  |
| --- | --- | --- |

<p class="first2"><span class="first-letter">T</span>here were pictures of the wall, and to Han Sen’s surprise, they all looked humanoid.</p>
