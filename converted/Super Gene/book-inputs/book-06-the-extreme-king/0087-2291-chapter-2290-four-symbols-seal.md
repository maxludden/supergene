# Chapter 2291: - Four Symbols Seal {.hidden-title}

<section id="chapter-2291" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2291-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2291</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Four Symbols Seal</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2291-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>he light symbol hummed on Han Sen’s hand like an energy converter. When Han Sen sent power into the light symbol, his energy was transformed into sealing power.</p>
...
Mister White stepped in front of one xenogeneic clone and directed Han Sen, Crime, and the blood Qilin to stand on either side of and behind the creature.
...
Mister White nodded. **“Okay, then let us try. It will be a useful practise run.”**

Following Mister White’s command, Han Sen and the others cast the Four Symbols Seal. The symbol of the red bird shivered on Han Sen’s hand. He felt a connection form between the bird and Mister White’s white tiger, Crime’s black turtle, and the green dragon that hovered around the blood Qilin’s claws.
...
Mister White and the blood Qilin were half-deified, so they had an easier time. Crime was a top dog of the Kings, so he was holding up well, too.
...
In a quiet voice, Mister White gave a straightforward explanation of the geno art. Crime and the blood Qilin focused on his words as well.
