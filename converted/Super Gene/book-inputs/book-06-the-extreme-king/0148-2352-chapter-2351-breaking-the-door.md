# Chapter 2352: - Breaking the Door {.hidden-title}

<section id="chapter-2352" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2352-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2352</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Breaking the Door</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2352-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hile Han Sen was staring at the geno hall, the black crystal armour inside his Sea of Soul suddenly released a mysterious substance. It wrapped around Han Sen, covering him completely. After that, Han Sen couldn’t even detect his own presence. It was as if he didn’t exist.</p>

Han Sen quickly thought back to the time with Kong Fei. **“When the geno hall appeared previously, the black crystal armour did something similar to this. Is the black crystal armour connected to the geno hall? Or is it simply afraid of the geno hall?”**
