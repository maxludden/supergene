# Chapter 2404: - Vampire {.hidden-title}

<section id="chapter-2404" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2404-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2404</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Vampire</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2404-text" markdown="1">
<p class="first2"><span class="first-letter">J</span>ust as Han Sen predicted, if God was a creature that had Causal powers, then he could reverse Causal relationships.</p>
