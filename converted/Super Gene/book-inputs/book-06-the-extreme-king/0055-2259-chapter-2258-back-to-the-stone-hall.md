# Chapter 2259: - Back to the Stone Hall {.hidden-title}

<section id="chapter-2259" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2259-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2259</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Back to the Stone Hall</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2259-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">S</span>hit! Why are they here?”** Han Sen reacted immediately, directing Little Star to dive back into the dark river.</p>

Before Little Star escaped beneath the dark waters, Han Sen felt a frightening wash of power come for him. Within one second, the river was vaporised into nothing.
...
Edward began destroying all the stone that he could still break, and they quickly realised that it was an underground stone palace. Even their combined powers couldn’t harm it.
