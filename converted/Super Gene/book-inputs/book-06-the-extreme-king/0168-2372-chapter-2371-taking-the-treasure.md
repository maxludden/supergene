# Chapter 2372: - Taking the Treasure {.hidden-title}

<section id="chapter-2372" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2372-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2372</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Taking the Treasure</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2372-text" markdown="1">
<p class="first2"><span class="first-letter">L</span>an Haixin turned around and looked at the old Siren woman. Clearly, she had never seen the relic before either.</p>
...
**“Let’s just have a look around first.”** Han Sen commanded his blood Qilin to advance forward. The blood Qilin roared and headed toward one of the hall’s side doors.

The old Siren woman was half-deified, but attempting to stop the blood Qilin and Han Sen was more than she dared. So, she retreated.
...
**“If the conches levelled up because of the Siren Bottle—”** Han Sen thought about it, and his heart started to race. The bottle had made a xenogeneic deified. Every deified elite would want something like this.
...
Han Sen looked into the bottle and saw the familiar, blurry rainbow colour. He couldn’t see anything else. After Lan Haixin’s droplet of blood fell in, the liquid disappeared into the rainbow as if nothing had happened.
