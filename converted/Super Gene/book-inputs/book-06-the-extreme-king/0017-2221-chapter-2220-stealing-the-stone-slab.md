# Chapter 2221: - Stealing the Stone Slab {.hidden-title}

<section id="chapter-2221" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2221-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2221</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Stealing the Stone Slab</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2221-text" markdown="1">
<p class="first2"><span class="first-letter">T</span>hat stone tile was lying amidst the rubble, and in order to pull it out, Han Sen would have to remove the cluster of rocks that buried it. Unfortunately, the two Dukes were still present. It’d be impossible to retrieve the stone without disturbing them.</p>
...
After thinking for a while, Han Sen abandoned the stone hall. He looked around the city and realised that he was currently in a desert with no creatures. There were no xenogeneics for Han Sen to lure their way.
...
Han Sen used the Purple-Eye Butterfly lens to examine it, but he couldn’t analyse its composition. He was unable to find out how it had been created.
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Xenogeneic Viscount Finger Fire Crow killed. Xenogeneic gene found. Obtained Finger Fire Crow beast soul.”</em></p></section>
