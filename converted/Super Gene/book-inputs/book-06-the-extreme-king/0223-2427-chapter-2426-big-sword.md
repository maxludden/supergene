# Chapter 2427: - Big Sword {.hidden-title}

<section id="chapter-2427" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2427-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2427</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Big Sword</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2427-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen and Miss Mirror carefully followed Night Wind’s gaze. Nearby, there was a big sword sticking partially out of the rubble.</p>
...
Night Wind had to force himself to take every step. This entire place was just too weird, and there was something ominous about the way the sword was plunged into the ground. It was entirely possible that the sword harboured some mysterious, frightening power, like the two statues they had encountered.
