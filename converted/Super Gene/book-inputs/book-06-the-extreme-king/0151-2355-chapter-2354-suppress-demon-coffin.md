# Chapter 2355: - Suppress Demon Coffin {.hidden-title}

<section id="chapter-2355" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2355-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2355</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Suppress Demon Coffin</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2355-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen walked toward the Nine-Headed Bird. Darkness flowed from the creature, consuming all that could be seen in every direction. Han Sen knew that the darkness was coming for him, that it would trap his body in less than a second.</p>
...
When Nine-Headed Bird heard Han Sen use King Bai’s name to make the promise, he believed him. He still harboured some suspicion, though. **“I’m willing to make this gamble. But I will have to hit you first. If you move or use your Kingese, then you lose.”**
...
**“Haha, that is it, then.”** Nine-Headed Bird snickered. The Suppress Demon Coffin then opened and Han Sen emerged.
