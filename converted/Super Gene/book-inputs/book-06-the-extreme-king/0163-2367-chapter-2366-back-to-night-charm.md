# Chapter 2367: - Back to Night Charm {.hidden-title}

<section id="chapter-2367" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2367-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2367</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Back to Night Charm</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2367-text" markdown="1">
...
The blood Qilin also absorbed a lot of king air, and over the month of training, he healed fully. Over the same period of time, Han Sen managed to get five hundred Duke genes.

But The Story of Genes could only open three gene locks before it stopped. As for the rest of the Duke genes Han Sen collected, he used them to open the gene locks of Jade-skin and the Blood-Pulse Sutra.

Jade-skin seemed to have the same limit of three gene locks.
