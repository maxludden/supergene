# Chapter 2227: - Undying Bird Nes {.hidden-title}

<section id="chapter-2227" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2227-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2227</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Undying Bird Nes</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2227-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>hat is the level of this Undying Bird?”** Han Sen asked with a frown. The name of the beast didn’t sound like one that would bode well.</p>
...
**“Even if you are this intent on going, you should at least explain what this endeavour is all about.”** Han Sen, as he followed Bai Wei, resumed conversation.
