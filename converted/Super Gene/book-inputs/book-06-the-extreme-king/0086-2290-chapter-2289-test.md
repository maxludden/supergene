# Chapter 2290: - Test {.hidden-title}

<section id="chapter-2290" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2290-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2290</p>
</section>
...
<section class="element chapter-text" id="chapter-2290-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen wondered if Sacred Leader had played a joke on them. They were surrounded by so many deified xenogeneics, and Han Sen had just recently become a Duke. Not even the deified elites that Han Sen knew would have stood a chance against all the powerful xenogeneics that had gathered.</p>
