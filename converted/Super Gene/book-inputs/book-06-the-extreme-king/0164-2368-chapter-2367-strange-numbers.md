# Chapter 2368: - Strange Numbers {.hidden-title}

<section id="chapter-2368" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2368-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2368</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Strange Numbers</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2368-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>s he left Night Charm Town, Han Sen got to thinking about the exam.</p>
