# Chapter 2423: - Scarlet Eye {.hidden-title}

<section id="chapter-2423" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2423-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2423</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Scarlet Eye</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2423-text" markdown="1">
<p class="first2"><span class="first-letter">N</span>ight Wind’s face was tight and worried, and he had also brought a video back with him.</p>
