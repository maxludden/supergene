# Chapter 2308: - King Dragon {.hidden-title}

<section id="chapter-2308" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2308-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2308</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- King Dragon</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2308-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen couldn’t believe that the dragons soaring across the landscape were actually tree roots. They had the heads of dragons, the horns of dragons, the teeth of dragons, and the scales of dragons. They looked so alive, and they didn’t look like plants at all.</p>
...
After a while, the yellow leaves on the tree started to light up. The King’s characters were shone gold as the King Tree lit with a holy light. It was like a godly tree that gave life to everything in its domain.
...
The closer to the King Tree they got, the scarier the king dragons became. Most king dragons were a dirty yellow colour. It wasn’t long before they encountered a king dragon that had gold scales. It was just resting on the ground.
