# Chapter 2216: - Under Overbearing {.hidden-title}

<section id="chapter-2216" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2216-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2216</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Under Overbearing</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2216-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hen Han Sen reached the control room, Mister White and Crime were already there.</p>
...
Even with his tri-colour Demon Bug Bai Sema, he wouldn’t be able to block an attack unleashed by that enemy.
