# Chapter 2339: - Ai Qing Xia’s Words {.hidden-title}

<section id="chapter-2339" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2339-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2339</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Ai Qing Xia’s Words</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2339-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">A</span>h, so opening the king body can attract the Kingese. I thought this was something special,”** Han Sen thought to himself.</p>
