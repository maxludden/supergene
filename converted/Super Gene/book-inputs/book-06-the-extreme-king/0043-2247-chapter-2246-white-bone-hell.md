# Chapter 2247: - White Bone Hell {.hidden-title}

<section id="chapter-2247" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2247-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2247</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- White Bone Hell</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2247-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hen Han Sen’s vision returned to him, a very disturbing sight greeted his eyes.</p>
