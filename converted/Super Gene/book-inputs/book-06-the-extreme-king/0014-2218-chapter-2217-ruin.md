# Chapter 2218: - Ruin {.hidden-title}

<section id="chapter-2218" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2218-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2218</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Ruin</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2218-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter watching so many insects flee the valley, Han Sen and the others were drawn by curiosity to look back at the crevice. As they watched, a hand emerged.</p>
