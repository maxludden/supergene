# Chapter 2253: - I Really Am San Mu {.hidden-title}

<section id="chapter-2253" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2253-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2253</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- I Really Am San Mu</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2253-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen quickly retreated, and he summoned his gold Demon Bug King Bai Sema to shield his exterior.</p>
