# Chapter 2306: - Choosing a Weapon {.hidden-title}

<section id="chapter-2306" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2306-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2306</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Choosing a Weapon</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2306-text" markdown="1">
<p class="first2"><span class="first-letter">E</span>ach grave had a special kind of spellwork laid across it. The veil of energy made it impossible to see what sort of treasure might lie within.</p>
...
**“I trust your judgement, but please, find another grave for me. I would like a King class weapon, if possible,”** Bai Wei said seriously.
