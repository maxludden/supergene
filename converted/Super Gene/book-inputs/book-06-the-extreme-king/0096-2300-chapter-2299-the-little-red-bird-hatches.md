# Chapter 2300: - The Little Red Bird Hatches {.hidden-title}

<section id="chapter-2300" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2300-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2300</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- The Little Red Bird Hatches</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2300-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>s the little red bird about to hatch?”** Han Sen thought in surprise.</p>

But as he watched, the colour gradually drained from Han Sen’s face. The substance chains connected to the bird’s nest started to pull back into the egg, and the nest began to fall apart piece by piece.
...
**“I have to take the blood Qilin, though. Its power can surely help. But should I bring the little red bird?”** Han Sen was hesitating.
