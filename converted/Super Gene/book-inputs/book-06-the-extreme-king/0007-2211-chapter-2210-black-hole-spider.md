# Chapter 2211: - Black Hole Spider {.hidden-title}

<section id="chapter-2211" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2211-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2211</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Black Hole Spider</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2211-text" markdown="1">
<p class="first2"><span class="first-letter">I</span>nside a ship that was bound for the systems of chaos, Han Sen and Han Yan were engaged in a card game. They had been flying for a long time, and boredom had set in.</p>
...
His black armour had gold markings, and a gold lion sword was belted to his waist. It looked like a sturdy weapon.
