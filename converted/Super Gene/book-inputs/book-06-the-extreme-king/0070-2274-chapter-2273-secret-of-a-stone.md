# Chapter 2274: - Secret of a Stone {.hidden-title}

<section id="chapter-2274" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-2274-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">2274</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Secret of a Stone</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-2274-text" markdown="1">
<p class="first2"><span class="first-letter">C</span>rime approached the statue from the side, but it gave no reaction. So, Crime walked in front of the main hall’s gate. Nothing weird happened there, either.</p>
...
Han Sen was shocked. He expanded the bird’s nest to shield himself and the blood Qilin, in case Crime was preparing to attack them.
...
No matter how much the demon struggled, it was unable to get out. The demon and that liquid were dumped into a mould. The liquid hardened over time until it became the stone in front of them.
