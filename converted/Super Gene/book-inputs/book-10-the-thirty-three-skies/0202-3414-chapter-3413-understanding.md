# Chapter 3414: - Understanding {.hidden-title}

<section id="chapter-3414" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3414-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3414</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Understanding</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3414-text" markdown="1">
<p class="first2"><span class="first-letter">D</span>ragon Lady was shocked. That kind of cooking skill was not rare, but to think of someone being able to cook like that, they must have had a great understanding of cooking and food. He would have to be well-versed and perhaps even be better than her.</p>
