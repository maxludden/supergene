# Chapter 3431: - Crape Myrtle {.hidden-title}

<section id="chapter-3431" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3431-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3431</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Crape Myrtle</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3431-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>here are only four people who can walk this path and take this step. Even if I am not encountering Qin Xiu in this round, I am bound to meet him eventually. The next round I will probably encounter Qin Xiu.”** Han Sen did not care which opponent he was going to encounter.</p>
