# Chapter 3389: - Suppress {.hidden-title}

<section id="chapter-3389" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3389-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3389</p>
</section>
...
<section class="element chapter-text" id="chapter-3389-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>s Floating Kill watched what was happening, he noticed that Han Sen’s movement abilities were very magical. He also realised that the distances he crossed were never all that far. Every time he dodged the attack of a Break World beast, it was as if he already knew what to expect.</p>
...
Outside the tower, Floating Kill looked very happy. He took away the now-minimised sky treasure tower by placing it in his hands. He looked at the shining tower of golden light and said to himself, **“This sky floating kill can truly melt everything. Even the undying can block the power of the sky floating kill. Han Sen will only live one or two days inside here before becoming blood water. If that happens, I will have accomplished a great deed for my master. Mister Leader can flip the geno hall and rebuild the god palace. I will be regarded as a high-level member then.”**
