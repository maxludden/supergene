# Chapter 3422: - Fighting Demon Alpha {.hidden-title}

<section id="chapter-3422" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3422-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3422</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Fighting Demon Alpha</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3422-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen and Demon Alpha looked at each other. Nobody struck first.</p>
...
Han Sen and Demon Alpha stood a thousand feet apart. Demon Alpha was waving her hands, but no visible power materialised. Han Sen was not damaged either. It was like they were just rehearsing an act.
