# Chapter 3360: - Bao’er’s Destiny {.hidden-title}

<section id="chapter-3360" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3360-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3360</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Bao’er’s Destiny</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3360-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">I</span>f the old leader of the God Chaos Party was the fairy White King spoke about, it means that a long, long time ago, the old leader had already managed to break through the main and the reverse universes. She had managed to gain access to the geno universe— Wait—”** Han Sen’s brain suddenly lit up as a scary thought crossed his mind.</p>
