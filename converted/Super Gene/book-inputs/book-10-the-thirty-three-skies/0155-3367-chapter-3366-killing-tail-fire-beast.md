# Chapter 3367: - Killing Tail Fire Beast {.hidden-title}

<section id="chapter-3367" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3367-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3367</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Killing Tail Fire Beast</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3367-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hile everyone’s emotions were in the realm of weirdness, something strange happened. A vortex appeared in the sea of fire. A lot of fire went into the vortex.</p>
...
<section class="world-voice-card" role="note"><p class="world-voice"><em>“Break World beast hunted: Ultimate Tail Fire Beast. Found Break World gene.”</em></p></section>
