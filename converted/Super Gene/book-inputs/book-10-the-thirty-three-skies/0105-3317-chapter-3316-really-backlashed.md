# Chapter 3317: - Really Backlashed {.hidden-title}

<section id="chapter-3317" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3317-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3317</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Really Backlashed</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3317-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen noticed that big sky demon stopped talking, so he asked the obvious, **“But what.”**</p>

**“This password is something only three people in the entire universe know. The other two are long gone. Do you really think you are going to get this precious password from me all for free?”** Big sky demon smiled and looked at Han Sen—**“If you really don’t want to tell me, that’s fine. I do not know if your password is true or not. Even if it is true, I drew one geno spell and lost all my power because of it. I cannot complete the gene password. Even if I knew it, it would be useless.”** Han Sen put his arms out and shrugged as he spoke.
...
It was just 24 symbols, so Han Sen was able to recognise them all with ease. The order in which he remembered them would not be wrong either. Even so, Han Sen did not dare risk believing big sky demon. Who knew if the geno password, those 24 words, would be as useful as she was claiming them to be?
...
Still, it was always a good thing to harbour doubt. Plus, Han Sen did not think he required the password just yet.
