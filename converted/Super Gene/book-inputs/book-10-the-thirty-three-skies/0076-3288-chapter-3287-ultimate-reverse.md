# Chapter 3288: - Ultimate Reverse {.hidden-title}

<section id="chapter-3288" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3288-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3288</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Ultimate Reverse</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3288-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">U</span>se your power to help me put out the flames that wreathe me or break the half-burned candle,”** Han Sen said to Zhao Ning’er.</p>
