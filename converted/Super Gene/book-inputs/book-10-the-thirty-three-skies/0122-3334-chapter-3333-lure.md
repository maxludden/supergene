# Chapter 3334: - Lure {.hidden-title}

<section id="chapter-3334" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3334-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3334</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Lure</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3334-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen ignored the purple copper sword. He used the Dongxuan Aura, wanting to find the native creatures the purple copper sword mentioned.</p>
