# Chapter 3327: - Holy {.hidden-title}

<section id="chapter-3327" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3327-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3327</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Holy</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3327-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter the Break World beast was killed, the mist on the floating islands receded and disappeared. Han Sen put away the Break World gene. He was getting ready to fly to the next floating island when he saw one of the 12 jade buildings of the White Jade Jing start to glow. A shadow emerged from the jade building.</p>
