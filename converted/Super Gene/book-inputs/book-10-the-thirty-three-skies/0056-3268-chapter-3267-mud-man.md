# Chapter 3268: - Mud Man {.hidden-title}

<section id="chapter-3268" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3268-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3268</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Mud Man</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3268-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen and the old man, in their mud-man shape, were on the table. They looked like two inanimate objects. One would never have thought that they were two grand elites who were once very scary and famous.</p>
...
Han Sen wanted to investigate the Ultimate Egg further, but he heard a voice come from behind a door. It made Han Sen’s heart jump. He cancelled his combination and used the Dongxuan Sutra to simulate Zhao Ning’er’s power. He became a mud man once more and returned to the table. He did not move an inch.
