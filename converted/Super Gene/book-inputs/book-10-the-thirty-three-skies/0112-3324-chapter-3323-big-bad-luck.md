# Chapter 3324: - Big Bad Luck {.hidden-title}

<section id="chapter-3324" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3324-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3324</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Big Bad Luck</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3324-text" markdown="1">
<p class="first2"><span class="first-letter">S</span>pace Garden was saved, but they had only managed to keep the area around the base. It was unknown how many Break World beasts were out there hiding in the forest. They were combining with the life souls. The longer time went by, the more their Break World rate increased.</p>
...
The light god dragon beast soul was the stream light dragon spear. The black king beast soul was an armour beast soul. It created a black jade set of armour. Its Break World rate was 59%. It only needed one more percent to reach 60%.

One was also able to improve the element. The stream god light spear did not have an element. Han Sen did not know how to increase the black king armour.
