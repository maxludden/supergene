# Chapter 3383: - Little Uncle Returns {.hidden-title}

<section id="chapter-3383" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3383-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3383</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Little Uncle Returns</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3383-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">L</span>et me do it.”** Huangfu Jing sounded calm. When she walked to the battleground, she suddenly teleported and appeared behind Han Sen— She tried to strike his shoulders with her legs.</p>
...
**“There is no point in me being here, but now I do not have any geno arts. I cannot go back to the sanctuaries. I will have to ask Little-flower to take me there.”** Han Sen went looking for Little-flower. The sky suddenly flashed. Something changed on the geno tablet.
