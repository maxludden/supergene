# Chapter 3322: - Item Nobody Owns {.hidden-title}

<section id="chapter-3322" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3322-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3322</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Item Nobody Owns</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3322-text" markdown="1">
<p class="first2"><span class="first-letter">W</span>hile Han Sen was thinking, he saw a scary shadow in the air. In the shining god light, it was headed for the 33 skies, which looked like a headstone. It was a powerful Break World beast.</p>
