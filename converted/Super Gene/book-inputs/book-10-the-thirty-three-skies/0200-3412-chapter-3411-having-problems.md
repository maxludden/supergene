# Chapter 3412: - Having Problems {.hidden-title}

<section id="chapter-3412" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3412-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3412</p>
</section>
...
<section class="element chapter-text" id="chapter-3412-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">H</span>ow am I supposed to completely understand and control my body?”** After Mister White left, Han Sen got to thinking about all the things Mister White told him.</p>
