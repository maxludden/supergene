# Chapter 3390: - A Fist Kills Floating Kill {.hidden-title}

<section id="chapter-3390" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3390-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3390</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- A Fist Kills Floating Kill</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3390-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>loating Kill looked at the sky floating kill’s area. Time was going by incredibly quickly. Twenty minutes of ordinary time had already passed. Converting it into the time clock’s passing of time, two to three months had gone by.</p>
...
**“Blergh!”** When the sky floating kill shattered, Floating Kill coughed up a bevvy of blood to coincide with it. His eyes opened wide. He looked at Han Sen’s unharmed figure in complete disbelief.
...
Since he knew he would not be able to beat Han Sen, Floating Kill did not dare stay there and fight the man. The stone clock was still spinning, so he could not escape. Floating Kill kept travelling between the stone clock areas in a desperate bid to escape.
