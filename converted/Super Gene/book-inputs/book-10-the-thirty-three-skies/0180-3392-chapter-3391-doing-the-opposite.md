# Chapter 3392: - Doing the Opposite {.hidden-title}

<section id="chapter-3392" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3392-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3392</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Doing the Opposite</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3392-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen did not recognise that person. He looked like a human from the universe of kingdoms.</p>
