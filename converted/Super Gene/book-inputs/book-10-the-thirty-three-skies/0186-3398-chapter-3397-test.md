# Chapter 3398: - Test {.hidden-title}

<section id="chapter-3398" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3398-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3398</p>
</section>
...
<section class="element chapter-text" id="chapter-3398-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">T</span>here is no need to. Your genes have awful flaws, and they are not stable. Whatever the case may be, it won’t reach the standards I require.”** The geno tablet rejected Han Sen—</p>
