# Chapter 3363: - Who is Human Alpha? {.hidden-title}

<section id="chapter-3363" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3363-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3363</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Who is Human Alpha?</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3363-text" markdown="1">
**<!-- source: span.dropcap -->
<p class="first2">“<span class="first-letter">W</span>hy must he kill Bao’er?”** Han Sen wanted to figure out why this was the case.</p>
...
Although reincarnation likely erased the memories a spirit possessed, people who were as strong as Human Alpha would carry with them a strong gene message even if they reincarnated. He could not have reincarnated into garbage that could not practise.

If it was not for Qin Wan’er giving her blood to Qin Xiu, Qin Xiu would not have even been able to practise. Could a person like that really be who Human Alpha reincarnated as?
