# Chapter 3293: - Day {.hidden-title}

<section id="chapter-3293" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3293-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3293</p>
</section>
...
<section class="element chapter-text" id="chapter-3293-text" markdown="1">
<p class="first2"><span class="first-letter">A</span>fter leaving the geno hall, Han Sen thought about the various ways he might be able to gain a human body again.</p>
