# Chapter 3237: - Elder {.hidden-title}

<section id="chapter-3237" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3237-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3237</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Elder</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3237-text" markdown="1">
<p class="first2"><span class="first-letter">F</span>or it to be related to the powers that governed reincarnation was something rather spooky.</p>
