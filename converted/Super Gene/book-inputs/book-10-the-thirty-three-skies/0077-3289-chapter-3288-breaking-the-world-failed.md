# Chapter 3289: - Breaking the World Failed {.hidden-title}

<section id="chapter-3289" class="chapter element" role="doc-chapter" epub:type="bodymatter chapter">
<section class="heading1" id="chapter-3289-heading">
<section class="heading-contents1">
<section class="element">
<section class="element-number-block">
<p class="element-number">3289</p>
</section>
<section class="element title-block">
<section class="title-subtitle-block">
<h1 class="title">- Breaking the World Failed</h1>
</section>
</section>
</section>
</section>
...
<section class="element chapter-text" id="chapter-3289-text" markdown="1">
<p class="first2"><span class="first-letter">H</span>an Sen knew he did not have much time left. If his power was consumed too much, even if he had a way to break the world with his Super God Spirit mode, he would not have the power needed to break the world.</p>
